...
``bob3.skill_library.registry`` that is importable directly from the workspace
...
See also:
    ...
    src/bob3/skill_library/registry.py — low-level storage implementation.
