...
`bob91` (this tree) is the **recursive bob3 generation chain** and the primary working
...
directly** into the bob3 chain — but their ideas are worth keeping. Each branch
remains on the remote; this doc distills the reusable insight so it can be re-specified
as bob3 PEAS features.
...
- **Flagship harness-hypothesis experiment spec** — six falsifiable hypotheses (H1–H6),
  ...
  threats-to-validity.
- **bob99 feature backlog** — F-101…F-157 (paper-track namespace, disjoint from bob3's
...
## How to use these
Re-express a chosen insight as acceptance criteria in `control/peas.md` so the next bob3
