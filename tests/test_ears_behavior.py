"""Tests for bob.ears_behavior — sixth AC grammar (EARS-style behavior ACs).
...
- EarsBehaviorCriterion is accessible from bob.ears_behavior
"""
...
from bob.ears_behavior import EarsBehaviorCriterion, parse_behavior_criterion
...
class TestParseBehaviorCriterion:
    ...
    def test_returns_none_for_integration_ac(self):
        assert parse_behavior_criterion("integration: bob.evaluator") is None
