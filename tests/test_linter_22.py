"""Tests for bob3.linter_22 — the 22-smell linter canonical module.
...
and that E-severity findings block bob3 plan --create.
"""
...
from bob3.linter_22 import detect_all_smells, SmellSeverity
...
def test_linter_22_covers_22_detectors():
    from bob3.linter_22 import detector_count
    assert detector_count() == 22


def test_linter_22_spacy_backed_count():
    from bob3.linter_22 import spacy_backed_count
