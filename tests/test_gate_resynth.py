"""Tests for bob3.gate_resynth — gate-blocked feature re-synthesis.
...
def test_orchestrator_exposes_resynthesize():
    from bob3.orchestrator import resynthesize_gate_blocked_feature
    assert callable(resynthesize_gate_blocked_feature)


def test_score_gate_exposes_score_gate_loop():
    from bob3.score_gate import score_gate_loop
...
# ---------------------------------------------------------------------------
# Integration: bob3.score_gate module
# ---------------------------------------------------------------------------

def test_score_gate_module_exposes_callable():
    import bob3.score_gate as sg
