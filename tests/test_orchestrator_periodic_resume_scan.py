"""Tests for bob.orchestrator.periodic_resume_scan — feature 740b4eb3.
...
class TestRunPeriodicResumeScanImport:
    def test_function_is_importable(self):
        from bob.orchestrator.periodic_resume_scan import run_periodic_resume_scan
...
class TestRunLoopIntegration:
    ...
    def test_periodic_resume_scan_importable_from_run_loop_module(self):
        ...
        import importlib
        import sys
        rl_module = sys.modules.get("bob.orchestrator.run_loop")
        if rl_module is None:
            import bob.orchestrator.run_loop as rl_module
