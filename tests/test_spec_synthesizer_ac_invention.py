...
from bob3.spec_synthesizer import should_emit_function_defined_ac, emit_function_defined_ac
from bob3.enhanced_verification import concept_token_match, check_function_name_equivalence
...
class TestEmitFunctionDefinedAc:
    ...
    def test_symbol_in_prose_emits_ac_string(self):
        ...
        result = emit_function_defined_ac("bob3.reaper", "should_refuse_redispatch", desc)
        assert result == "Function defined: bob3.reaper.should_refuse_redispatch"
    ...
    def test_symbol_not_in_prose_returns_none(self):
        ...
        result = emit_function_defined_ac("bob3.reaper", "apply_exponential_backoff", desc)
    ...
    def test_empty_symbol_raises_value_error(self):
        with pytest.raises(ValueError):
            emit_function_defined_ac("bob3.reaper", "", "some description")
