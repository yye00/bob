...
Acceptance criteria (feature 5957b0ad-3de8-4fed-a8c1-e54cab634910):
  - File exists: src/bob3/run_loop_must_reap_claude_subagent_process_feature_terminal.py
  - Function defined: bob3.run_loop_must_reap_claude_subagent_process_feature_terminal
...
def test_run_loop_must_reap_claude_subagent_process_feature_terminal():
    ...
    import bob3.run_loop_must_reap_claude_subagent_process_feature_terminal as mod
    from bob3.run_loop_must_reap_claude_subagent_process_feature_terminal import (
        run_loop_must_reap_claude_subagent_process_feature_terminal,
    )
    ...
    with patch(
        "bob3.run_loop_must_reap_claude_subagent_process_feature_terminal"
...
class TestReapingBehaviour:
    ...
    def test_delegates_to_reap_subagent_for_feature(self):
        """Delegates to bob3.orchestrator.subagent_reaper.reap_subagent_for_feature."""
        with patch(
            "bob3.run_loop_must_reap_claude_subagent_process_feature_terminal"
            ".reap_subagent_for_feature"
        ) as mock_reap:
...
class TestOrphanSweep:
    ...
    def test_sweep_delegates_to_subagent_reaper(self):
        """sweep_orphan_subagents delegates to bob3.orchestrator.subagent_reaper."""
        from bob3.run_loop_must_reap_claude_subagent_process_feature_terminal import (
            sweep_orphan_subagents,
        )
        with patch(
...
class TestRunLoopIntegration:
    """Verify the reaper is wired into bob3.orchestrator.run_loop."""

    def test_reap_subagent_for_feature_in_run_loop(self):
        """bob3.orchestrator.run_loop imports reap_subagent_for_feature."""
        import bob3.orchestrator.run_loop as rl
    ...
    def test_run_loop_module_has_noqa_import_or_direct_usage(self):
        ...
        run_loop_src = inspect.getsource(
            importlib.import_module("bob3.orchestrator.run_loop")
        )
