...
Acceptance criteria tested:
  - Function defined: bob.bf_5_resurrection_gate_tier_1_partial_work_detector
...
from bob.bf_5_resurrection_gate_tier_1_partial_work_detector import (
...
def test_resurrection_module_exists():
    """File exists: src/bob/brownfield/resurrection.py."""
    path = Path("src/bob/brownfield/resurrection.py")
