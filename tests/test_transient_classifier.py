"""Tests for bob.transient_classifier — canonical transient-error module.

Verifies:
- classify_exit and spawn_with_retry are importable from bob.transient_classifier
...
import bob.transient_classifier as mod
from bob.transient_classifier import classify_exit, spawn_with_retry
...
def test_module_exports_classify_exit():
    """classify_exit must be importable from bob.transient_classifier."""
    assert callable(classify_exit)


def test_module_exports_spawn_with_retry():
    """spawn_with_retry must be importable from bob.transient_classifier."""
