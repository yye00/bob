"""Tests for bob.orchestrator.periodic_resume (feature 5b9da564).
...
def test_resume_interrupted_rows_importable():
    ...
    from bob.orchestrator.periodic_resume import resume_interrupted_rows
    assert callable(resume_interrupted_rows)


def test_resume_scan_importable():
    """resume_scan must still be importable (existing API)."""
    from bob.orchestrator.periodic_resume import resume_scan
...
def test_resume_interrupted_rows_same_result_as_resume_scan():
    ...
    from bob.orchestrator.periodic_resume import resume_interrupted_rows, resume_scan
...
def test_resume_interrupted_rows_in_module_all():
    ...
    import bob.orchestrator.periodic_resume as m
