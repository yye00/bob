...
FUNC_AC = "Function defined: bob.run_loop.disk_reconciler_verify_fail_promotion"
...
class TestPromotionCheck:
    ...
    def test_no_structural_ac_returns_false(self) -> None:
        acs = _acs("integration: bob.run_loop")
        result = disk_reconciler_promotion_check(
            project_id="proj-5",
            feature_id="feat-31",
...
# ---------------------------------------------------------------------------
# Integration: bob.run_loop imports are accessible
# ---------------------------------------------------------------------------


def test_integration_bob_run_loop_importable() -> None:
    """Verify the functions are importable from bob.run_loop (integration AC)."""
    from bob import run_loop as rl
...
def test_integration_disk_reconciler_reconcile_from_disk_importable() -> None:
    """AC: Function defined: bob.disk_reconciler.reconcile_from_disk."""
