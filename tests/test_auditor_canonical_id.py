...
class TestIntegrationWithBobEvaluator:
    """Verify that bob.evaluator is wired into bob72.auditor."""

    def test_bob_evaluator_is_importable_via_auditor_module(self):
        import bob72.auditor as auditor_mod
        import bob.evaluator as evaluator_mod
