"""Tests for bob3.regression_detection — ownership-evidenced regression detection.
...
- Integration via bob3.orchestrator import path works
"""
...
from bob3.regression_detection import (
    check_causal_link,
...
# ---------------------------------------------------------------------------
# Integration: importable from bob3.orchestrator
# ---------------------------------------------------------------------------
...
class TestOrchestratorIntegration:
    def test_detect_regression_with_evidence_importable_from_orchestrator(self):
        from bob3.orchestrator import detect_regression_with_evidence as fn
        assert callable(fn)

    def test_has_causal_link_importable_from_orchestrator(self):
        from bob3.orchestrator import has_causal_link as fn
        assert callable(fn)

    def test_has_causal_evidence_importable_from_orchestrator(self):
        from bob3.orchestrator import has_causal_evidence as fn
        assert callable(fn)

    def test_has_causal_evidence_same_as_has_causal_link_via_orchestrator(self):
        from bob3.orchestrator import has_causal_evidence, has_causal_link
        assert has_causal_evidence is has_causal_link
...
class TestValidateRegressionOwnership:
    ...
    def test_db_detect_regression_importable(self):
        from bob3.db.detect_regression import detect_regression
...
class TestValidateFeatureInvolvement:
    ...
    def test_importable_from_regression_detection(self):
        from bob3.regression_detection import validate_feature_involvement
        assert callable(validate_feature_involvement)


# ---------------------------------------------------------------------------
# is_regression_ownership_evidenced  (AC: bob3.regression_detection)
# ---------------------------------------------------------------------------
...
class TestIsRegressionOwnershipEvidenced:
    ...
    def test_importable_from_regression_detection(self):
        from bob3.regression_detection import is_regression_ownership_evidenced as fn
        assert callable(fn)


# ---------------------------------------------------------------------------
# check_causal_link  (AC: bob3.regression_detection)
# ---------------------------------------------------------------------------
...
class TestCheckCausalLink:
    ...
    def test_importable_from_regression_detection(self):
        from bob3.regression_detection import check_causal_link as fn
        assert callable(fn)
