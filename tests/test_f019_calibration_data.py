...
class TestGetCalibration:
    ...
    def test_get_calibration_returns_model(self, project):
        from bob.db import create_or_update_calibration, get_calibration
        from bob.models import CalibrationData
...
class TestCalculateDrift:
    ...
    def test_drift_overconfident(self, project):
        from bob.db import create_or_update_calibration, calculate_drift
    ...
    def test_drift_not_found_returns_none(self, db_path):
        from bob.db import calculate_drift
    ...
    def test_drift_persisted_to_database(self, db_path, project):
        from bob.db import create_or_update_calibration, calculate_drift, get_calibration
