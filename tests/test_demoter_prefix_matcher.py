"""Tests for bob.demoter_prefix_matcher — F-b617e500.
...
from bob.demoter_prefix_matcher import is_structural_prefix_match, get_prose_connectors
...
class TestIsStructuralPrefixMatchStartOfString:
    ...
    def test_file_exists_criterion_is_structural(self):
        ...
        assert is_structural_prefix_match("file exists: src/bob/demoter_prefix_matcher.py") is True

    def test_function_defined_criterion_is_structural(self):
        """A 'function defined:' criterion must match as structural."""
        assert is_structural_prefix_match("function defined: bob.demoter_prefix_matcher.is_structural_prefix_match") is True

    def test_integration_criterion_is_structural(self):
        """An 'integration:' criterion must match as structural."""
        assert is_structural_prefix_match("integration: bob.criterion_demoter") is True
