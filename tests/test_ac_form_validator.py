"""Tests for bob.validators.ac_form.validate_acceptance_criteria.
...
class TestValidAcceptanceCriteria:
    ...
    def test_file_exists_canonical_passes(self):
        result = validate_acceptance_criteria(["File exists: src/bob/validators/ac_form.py"])
        assert result == []

    def test_function_defined_canonical_passes(self):
        result = validate_acceptance_criteria(["Function defined: bob.validators.ac_form.validate_acceptance_criteria"])
        assert result == []
    ...
    def test_class_defined_canonical_passes(self):
        result = validate_acceptance_criteria(["Class defined: bob.validators.ac_form.ValidationError"])
        assert result == []
    ...
    def test_multiple_valid_acs_pass(self):
        acs = [
            "File exists: src/bob/validators/ac_form.py",
            "Function defined: bob.validators.ac_form.validate_acceptance_criteria",
            "pytest: tests/test_ac_form_validator.py",
            "integration: bob.spawn",
        ]
...
class TestMalformedAcceptanceCriteria:
    ...
    def test_v13_function_defined_with_parenthetical_raises(self):
        ...
        bad_ac = "Function defined: bob.module.fn (validates input)"
        with pytest.raises(ValueError):
            validate_acceptance_criteria([bad_ac])
