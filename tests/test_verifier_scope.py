"""Tests for bob.verifier.scope_pytest_to_feature — feature-scoped pytest invocation.
...
class TestOrchestratorIntegration:
    """Integration: orchestrator imports scope_pytest_to_feature from bob.verifier."""

    def test_orchestrator_imports_scope_pytest_to_feature(self):
        """bob.orchestrator exposes scope_pytest_to_feature."""
    ...
    def test_orchestrator_imports_sibling_error(self):
        """bob.orchestrator exposes SiblingTestCollectionError."""
        import bob.orchestrator as orch
