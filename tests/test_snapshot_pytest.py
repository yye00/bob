"""Tests for bob3.snapshot_pytest.enforce_maxfail_zero."""

from __future__ import annotations

import pytest
from bob3.snapshot_pytest import enforce_maxfail_zero, MAXFAIL_ZERO
...
class TestOrchestratorIntegration:
    """bob3.orchestrator imports and uses enforce_maxfail_zero."""

    def test_orchestrator_run_loop_imports_snapshot_pytest(self):
        from bob3.snapshot_pytest import enforce_maxfail_zero as fn
        assert callable(fn)
    ...
    def test_run_loop_references_snapshot_pytest(self):
        ...
        assert "bob3.snapshot_pytest" in source

    def test_enforce_maxfail_zero_importable_from_bob3(self):
        from bob3.snapshot_pytest import enforce_maxfail_zero
        result = enforce_maxfail_zero(["pytest", "tests/"])
        assert "--maxfail=0" in result
