"""Boundary tests for bob.zombie_reaper.reap_zombie_runs.
...
from bob.zombie_reaper import reap_zombie_runs
...
class TestBoundaryMinimumInput:
    ...
    def test_reap_zombie_runs_function_defined_and_callable(self):
        """AC: Function defined: bob.zombie_reaper.reap_zombie_runs."""
        from bob.zombie_reaper import reap_zombie_runs as fn
