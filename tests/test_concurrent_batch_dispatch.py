"""Tests for concurrent_batch_dispatch in bob3.run_loop.

Feature ee5b8637-a52c-47af-87ce-3dc857fa0040

Verifies that concurrent_batch_dispatch:
1. Is importable from bob3.run_loop (integration AC).
...
from bob3.run_loop import concurrent_batch_dispatch
...
# ---------------------------------------------------------------------------
# AC: Function defined and importable from bob3.run_loop (integration)
# ---------------------------------------------------------------------------


def test_concurrent_batch_dispatch_importable():
    """concurrent_batch_dispatch is importable from bob3.run_loop."""
    assert callable(concurrent_batch_dispatch)


def test_concurrent_batch_dispatch_in_run_loop_module():
    """concurrent_batch_dispatch is a member of the bob3.run_loop module."""
