"""Tests for per-worker settings re-declaration (bob.dispatch.write_feature_settings).

Verifies that write_feature_settings writes a valid settings.json under
.bob/features/<id>/settings.json with the correct permission structure.
"""
...
from bob.dispatch import write_feature_settings
...
class TestWriteFeatureSettings:
    ...
    def test_parent_dirs_created(self, tmp_path):
        ...
        bob_dir = tmp_path / "nonexistent" / ".bob"
