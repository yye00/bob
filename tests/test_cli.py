"""Tests for bob.cli focusing on the QUEUE_DRAINED rename and CLI message.
...
def test_cli_loop_termination_all_blocked_exit_code():
    ...
    from bob.cli import _build_exit_codes  # type: ignore[attr-defined]
