"""Tests for bob3.sticky_completed_gate.should_accept_status_flip.
...
from bob3.sticky_completed_gate import should_accept_status_flip
...
class TestGateDoesNotFire:
    ...
    def test_allows_when_no_file_existence_acs(self, tmp_path):
        acs = json.dumps(["pytest: tests/test_foo.py", "integration: bob3.evaluator"])
        result = should_accept_status_flip(
            parent_completed=True,
            target_status="failed",
            acceptance_criteria=acs,
