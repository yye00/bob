"""Tests for bob.spec_synthesizer.score_gate_loop.
...
_HIGH_QUALITY_ACS = [
    "File exists: src/bob/score_gate.py",
    "Function defined: bob.score_gate.run",
...
def test_threshold_default_reads_from_env(monkeypatch):
    ...
    monkeypatch.setenv("BOB_SPEC_QUALITY_THRESHOLD", "0.7")
