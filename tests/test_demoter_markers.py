"""Tests for bob3.demoter_markers — canonical marker registry (feature 277f1294).
...
from bob3.demoter_markers import is_structural_prefix_match, get_connector_registry
...
class TestIsStructuralPrefixMatch:
    ...
    def test_file_exists_criterion_returns_true(self):
        assert is_structural_prefix_match("file exists: src/bob3/demoter_markers.py") is True

    def test_function_defined_criterion_returns_true(self):
        assert is_structural_prefix_match("function defined: bob3.demoter_markers.is_structural_prefix_match") is True

    def test_integration_criterion_returns_true(self):
        assert is_structural_prefix_match("integration: bob3.spec_loader") is True
