"""Tests for bob3.demoter.get_prose_connector_registry (F-0234e7b3).

Verifies the public API exposed via bob3.demoter returns the canonical
frozenset of prose-connector tokens that covers all required policy phrases.
"""
import pytest

from bob3.demoter import get_prose_connector_registry
