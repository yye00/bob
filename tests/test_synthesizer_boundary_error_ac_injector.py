"""Tests for bob3.synthesizer_boundary_error_ac_injector.
...
class TestExtractCriterionTextFromObjectFormat:
    ...
    def test_text_key(self):
        obj = {"text": "integration: bob3.synthesizer"}
        assert extract_criterion_text_from_object_format(obj) == "integration: bob3.synthesizer"
...
class TestIntegrationWithBob3Synthesizer:
    def test_importable_from_bob3_synthesizer(self):
        from bob3.synthesizer import inject_boundary_and_error_acs as fn
        assert callable(fn)

    def test_extract_importable_from_bob3_synthesizer(self):
        from bob3.synthesizer import extract_criterion_text_from_object_format as fn
        assert callable(fn)
    ...
    def test_extract_from_synthesizer_handles_object(self):
        from bob3.synthesizer import extract_criterion_text_from_object_format
