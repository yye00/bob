"""Tests for bob.reaper.handle_exponential_backoff (feature c5859f93).

Verifies the top-level API in bob.reaper:
...
class TestHandleExponentialBackoffEscalation:
    @patch("bob.reaper.escalate_after_n_reaps", return_value=True)
