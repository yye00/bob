"""Tests for bob.verifier_extension.reject_behavior_ac.

Verifies that reject_behavior_ac correctly enforces AC discipline for
verifier-extension features by integrating with bob.spec_extractor.
"""
...
def test_function_is_importable():
    """reject_behavior_ac is importable from bob.verifier_extension."""
    assert callable(reject_behavior_ac)


def test_verifier_extension_modules_exported():
    """VERIFIER_EXTENSION_MODULES is exported from bob.verifier_extension."""
