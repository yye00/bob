"""Tests for bob3.ac_repair_linter — semantic-equivalence check and auto-apply repair."""
...
from bob3.ac_repair_linter import semantic_equivalence_check, auto_apply_repair
...
class TestSemanticEquivalenceCheck:
    def test_equivalent_returns_true(self):
        ...
        with patch("bob3.ac_repair_linter._call_llm_judge", return_value=mock_response):
    ...
    def test_llm_error_returns_false(self):
        with patch("bob3.ac_repair_linter._call_llm_judge", side_effect=Exception("network error")):
