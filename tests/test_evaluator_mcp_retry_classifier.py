"""Tests for bob3.evaluator_mcp_retry_classifier (F-R7-597).
...
from bob3.evaluator_mcp_retry_classifier import classify_evaluator_failure, is_mcp_transient_error
