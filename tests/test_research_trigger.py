...
Verifies:
- fire_research_for_round is importable from bob.orchestrator.research_trigger
- It returns a well-formed summary dict
- It writes YAML files to docs/recursion/round<N>/research/
- It integrates with bob.research.harness
- CLI integration point exists in bob.cli
"""
...
class TestImport:
    def test_module_importable(self):
        import bob.orchestrator.research_trigger  # noqa: F401
...
# ===================================================================
# Integration: bob.research.harness
# ===================================================================
