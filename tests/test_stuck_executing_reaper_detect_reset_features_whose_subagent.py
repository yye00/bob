"""Tests for bob.stuck_executing_reaper_detect_reset_features_whose_subagent.

Acceptance criteria:
- File exists: src/bob/stuck_executing_reaper_detect_reset_features_whose_subagent.py
...
- Function defined: bob.stuck_executing_reaper_detect_reset_features_whose_subagent.stuck_executing_reaper_detect_reset_features_whose_subagent
"""
...
def test_stuck_executing_reaper_detect_reset_features_whose_subagent():
    ...
    import bob.stuck_executing_reaper_detect_reset_features_whose_subagent as mod
...
def test_module_importable():
    import bob.stuck_executing_reaper_detect_reset_features_whose_subagent  # noqa: F401


def test_function_defined():
    from bob.stuck_executing_reaper_detect_reset_features_whose_subagent import (
