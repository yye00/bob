...
import bob3.verifier.snapshot as verifier_snapshot
from bob3.verifier.snapshot import MAXFAIL_FLAG, capture as snapshot_capture
...
# ---------------------------------------------------------------------------
# bob3.verifier.snapshot wrapper
# ---------------------------------------------------------------------------

class TestVerifierSnapshotModule:
    """bob3.verifier.snapshot.capture delegates with --maxfail=0 guaranteed."""
