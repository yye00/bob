"""Tests for bob_init_re_run_after_spawn_fixes_stale_project_metadata.
...
from bob.bob_init_re_run_after_spawn_fixes_stale_project_metadata import (
    bob_init_re_run_after_spawn_fixes_stale_project_metadata,
)


def _create_db(path: pathlib.Path, name: str, spec_path: str = "") -> None:
    """Helper to create a minimal bob.db with a projects row."""
...
def test_bob_init_re_run_after_spawn_fixes_stale_project_metadata(tmp_path):
    ...
    result = bob_init_re_run_after_spawn_fixes_stale_project_metadata(
        workspace=workspace,
        db_path=db,
    )
