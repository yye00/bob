"""Tests for bob.demoters.is_structural_prefix_match (F-b3790872).
...
from bob.demoters import is_structural_prefix_match
...
class TestIsStructuralPrefixMatchStartOfString:
    ...
    def test_file_exists_prefix_returns_true(self):
        assert is_structural_prefix_match("file exists: src/bob/demoters.py") is True

    def test_function_defined_prefix_returns_true(self):
        assert is_structural_prefix_match("function defined: bob.demoters.is_structural_prefix_match") is True

    def test_integration_prefix_returns_true(self):
        assert is_structural_prefix_match("integration: bob.spec_extractor") is True
    ...
    def test_python_prefix_returns_true(self):
        assert is_structural_prefix_match("python: src/bob/demoters.py") is True

    def test_class_defined_prefix_returns_true(self):
        assert is_structural_prefix_match("class defined: bob.demoters.Demoter") is True
