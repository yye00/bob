"""Tests for schema_constrained_spec_emission_eliminate_parse_failure.
...
from bob.schema_constrained_spec_emission_eliminate_parse_failure import (
    SpecSchemaError,
    ...
    "acceptance_criteria": [
        {
            ...
            "when": "schema_constrained_spec_emission_eliminate_parse_failure is called",
            "then": "A schema-valid spec dict is returned without retries",
            "verifier": "pytest: tests/test_schema_constrained_spec_emission_eliminate_parse_failure.py",
        }
    ],
...
def test_schema_constrained_spec_emission_eliminate_parse_failure() -> None:
...
def test_use_outlines_dispatches_to_emit_via_outlines() -> None:
    ...
    with patch(
        "bob.schema_constrained_spec_emission_eliminate_parse_failure.emit_via_outlines",
