...
AC verification:
  - File exists: src/bob3/bf_7_codet_patch_mode_reviewable_diff_plan_artifact.py
  - Function defined: bob3.bf_7_codet_patch_mode_reviewable_diff_plan_artifact
  ...
  - File exists: src/bob3/brownfield/patch_planner.py
...
_MODULE = "bob3.bf_7_codet_patch_mode_reviewable_diff_plan_artifact"
...
def test_bf_7_codet_patch_mode_reviewable_diff_plan_artifact():
    ...
    from bob3.bf_7_codet_patch_mode_reviewable_diff_plan_artifact import (
        bf_7_codet_patch_mode_reviewable_diff_plan_artifact,
    )
...
class TestBoundaryBehavior:
    ...
    def test_empty_touches_raises_value_error(self):
        ...
        from bob3.brownfield.patch_planner import emit_diff_plan
...
class TestPatchPlannerIntegration:
    ...
    def test_apply_diff_plan_replace(self, tmp_path):
        from bob3.brownfield.patch_planner import apply_diff_plan, emit_diff_plan
    ...
    def test_apply_diff_plan_creates_backup(self, tmp_path):
        ...
        orig = ws / ".bob3" / "features" / "feat-backup-001" / "orig" / "src" / "foo.py"
        assert orig.exists()
    ...
    def test_rollback_no_backup_raises(self, tmp_path):
        from bob3.brownfield.patch_planner import rollback_changes
