"""Tests for bob3.triton_kernel_synthesis (feature 6cc31a74).
...
from bob3.triton_kernel_synthesis import synthesize_and_autotune, verify_numerical_correctness
from bob3.implementers.triton_kernel import NumericalGateError
