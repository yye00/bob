"""Tests for src/bob3/distributed_sweep_coordination.py
...
from bob3.distributed_sweep_coordination import (
...
from bob3.sweep_orchestrator import SweepPlan, SweepRun, SweepResult
