...
def test_env_override_allowlist(monkeypatch):
    """BOB3_ALLOWLIST_PATTERNS env var must extend the allowlist."""
    monkeypatch.setenv("BOB3_ALLOWLIST_PATTERNS", "CUSTOM-001,CUSTOM-002")
    feature = _make_feature(
...
def test_empty_env_allowlist_falls_back_to_defaults(monkeypatch):
    """Empty BOB3_ALLOWLIST_PATTERNS must fall back to hardcoded defaults."""
    monkeypatch.setenv("BOB3_ALLOWLIST_PATTERNS", "")
    feature = _make_feature(
