"""Tests for bob.property_ac: register_property_assertion and generate_hypothesis_tests."""

from __future__ import annotations

import pytest

from bob.property_ac import generate_hypothesis_tests, register_property_assertion
