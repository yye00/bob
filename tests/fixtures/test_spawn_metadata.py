...
def make_db_with_project(
    ...
    *,
    ...
    Args:
        ...
        db_name: Filename for the database (default: "bob3.db").
...
def make_empty_db(tmp_path: Path, *, db_name: str = "bob3.db") -> Path:
    """Create a bob3.db with an empty projects table.
