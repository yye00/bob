"""Tests for bob.spec_ambiguity_linter_reject_vague_acceptance_criteria.
...
from bob.spec_ambiguity_linter_reject_vague_acceptance_criteria import (
    ...
    clean_features = [
        {
            "name": "Clean Feature",
            "acceptance_criteria": [
                "File exists: src/bob/clean.py",
                "pytest: tests/test_clean.py",
                "Function defined: bob.clean.my_func",
            ],
        },
        {
