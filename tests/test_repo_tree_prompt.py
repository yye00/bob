"""Tests for src/bob3/repo_tree_prompt.py (F-R7-609 component A).

AC: File exists: src/bob3/repo_tree_prompt.py
    Function defined: bob3.dispatch.inject_repo_tree_to_worker
...
from bob3.repo_tree_prompt import (
    build_repo_tree,
    inject_repo_tree_into_prompt,
    inject_repo_tree_to_worker,
)
from bob3.dispatch import inject_repo_tree_to_worker as dispatch_inject
