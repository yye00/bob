"""Tests for bob.run_loop.reap_subagent (feature dcb4ffe6).
...
Verifies that reap_subagent is importable from bob.run_loop and correctly
...
class TestReapSubagentImport(unittest.TestCase):
    """Verifies reap_subagent is importable and callable from bob.run_loop."""
...
class TestRunLoopIntegration(unittest.TestCase):
    """Integration-level tests: bob.run_loop wires reap_subagent correctly."""
