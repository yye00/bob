...
Acceptance criteria:
- File exists: src/bob3/a_b_comparison_cli.py
...
def test_run_telemetry_importable():
    from bob3.a_b_comparison_cli import load_run_telemetry
    assert callable(load_run_telemetry)


def test_format_comparison_importable():
    from bob3.a_b_comparison_cli import format_comparison
...
def test_compute_run_stats_success_rate(tmp_path):
    from bob3.a_b_comparison_cli import compute_run_stats
...
def test_compare_runs_missing_run_a(tmp_path):
    from bob3.a_b_comparison_cli import compare_runs, RunNotFoundError
