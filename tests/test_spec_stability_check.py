"""Tests for bob3.spec_stability_check — N-sample stability check pre-critic.

AC: pytest: tests/test_spec_stability_check.py
Integration: bob3.spec_extractor
"""
...
from bob3.spec_stability_check import (
...
class TestRunStabilityCheck:
    ...
    def test_integration_with_spec_extractor(self, tmp_path):
        """Verify integration with bob3.spec_extractor.extract_with_temperature."""
        result = run_stability_check(
            feature_id="integration-001",
            name="Integration Test",
            description="Verifies spec_extractor is called per seed",
            acceptance_criteria=[
                "File exists: src/bob3/spec_stability_check.py",
                "Function defined: bob3.spec_stability_check.run_stability_check",
            ],
            n=3,
            variants_dir=tmp_path,
        )
    ...
    def test_multiple_stable_acs_high_score(self, tmp_path):
        ...
        result = run_stability_check(
            ...
            acceptance_criteria=[
                "File exists: src/bob3/stable.py",
                "Function defined: bob3.stable.run",
            ],
            n=3,
            variants_dir=tmp_path,
        )
