...
- Integration: functions are callable from bob3.dispatch context
"""
...
from bob3.exponential_backoff_reaper import calculate_backoff_delay, should_refuse_redispatch
...
class TestDispatchIntegration:
    """Integration tests: verify functions can be used from bob3.dispatch context."""

    def test_import_from_module(self):
        from bob3.exponential_backoff_reaper import (
