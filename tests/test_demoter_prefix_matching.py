"""Tests for bob3.demoter.is_structural_prefix_match (F-0234e7b3).

Verifies the public API exposed via bob3.demoter wraps the correct
prefix-position matching logic from bob3.verification.structural_prefix_match.
"""
import pytest
...
class TestIsStructuralPrefixMatch:
    ...
    def test_integration_at_start_returns_true(self):
        assert is_structural_prefix_match("integration: bob3.x.y routes through z") is True
