...
Verifies bob.patterns.pattern_9_shell_handler.demote_shell_script_ac:
...
from bob.patterns.pattern_9_shell_handler import demote_shell_script_ac
...
def test_shell_script_ac_pass_warning_logged(
    ...
    with caplog.at_level(logging.WARNING, logger="bob.patterns.pattern_9_shell_handler"):
...
def test_non_shell_body_returns_none(tmp_path: pathlib.Path) -> None:
    ...
    criterion = "integration: bob.verifier"
    result = demote_shell_script_ac(criterion, tmp_path)
