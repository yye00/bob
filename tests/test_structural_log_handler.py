"""Tests for bob3.structural_log_handler.match_log_line_ac.
...
from bob3.structural_log_handler import match_log_line_ac
...
class TestExactMatch:
    ...
    def test_exact_match_with_subdirectory_path(self, tmp_path):
        ...
        result = match_log_line_ac(
            "src/bob3/orchestrator/run_loop.py emits a 'Queue drained' log line",
            tmp_path,
        )
        assert result is True
...
# ---------------------------------------------------------------------------
# Integration: import from bob3.structural_log_handler
# ---------------------------------------------------------------------------

class TestModuleImport:
    def test_module_importable(self):
        import bob3.structural_log_handler  # noqa: F401

    def test_match_log_line_ac_in_all(self):
        from bob3 import structural_log_handler
