"""Tests for bob.provenance_tracker — sub-translation provenance tracker.
...
- Integration with bob.synthesizer works via synthesize_for_feature
"""
...
from bob.provenance_tracker import add_ac_provenance, extract_source_spans
