"""Tests for bob.dispatch.check_reap_backoff (feature df830312).

Covers:
  - Function defined: bob.dispatch.check_reap_backoff
...
from bob.dispatch import check_reap_backoff
from bob.stuck_executing_reaper import record_reap
...
class TestCheckReapBackoffExists:
    def test_importable_from_dispatch(self):
        """Function defined: bob.dispatch.check_reap_backoff"""
        from bob.dispatch import check_reap_backoff as fn
        assert callable(fn)
...
# ---------------------------------------------------------------------------
# integration: bob.dispatch — module exports check_reap_backoff
# ---------------------------------------------------------------------------

class TestDispatchIntegration:
    def test_check_reap_backoff_in_dispatch_all(self):
        """integration: bob.dispatch exports check_reap_backoff"""
...
class TestRecordReapExists:
    def test_importable_from_stuck_executing_reaper(self):
        """Function defined: bob.stuck_executing_reaper.record_reap"""
        from bob.stuck_executing_reaper import record_reap as fn
        assert callable(fn)

    def test_in_module_all(self):
        import bob.stuck_executing_reaper as m
