...
(default $20, override via BOB3_PER_FEATURE_COST_CEILING) rather than the entire
...
Fix:
    ...
    (overridable via BOB3_PER_FEATURE_COST_CEILING), which is then passed to
...
class TestPerFeatureCeilingContract:
    ...
    def test_default_ceiling_is_twenty_dollars(self):
        ...
        env_key = "BOB3_PER_FEATURE_COST_CEILING"
    ...
    def test_env_override_ceiling_respected(self):
        """BOB3_PER_FEATURE_COST_CEILING env var overrides the default."""
        env_key = "BOB3_PER_FEATURE_COST_CEILING"
        old = os.environ.pop(env_key, None)
        try:
    ...
    def test_invalid_env_override_falls_back_to_default(self):
        """Non-numeric BOB3_PER_FEATURE_COST_CEILING falls back to $20 default."""
        env_key = "BOB3_PER_FEATURE_COST_CEILING"
        old = os.environ.pop(env_key, None)
        try:
    ...
    def test_negative_env_override_falls_back_to_default(self):
        """Negative BOB3_PER_FEATURE_COST_CEILING falls back to $20 default."""
        env_key = "BOB3_PER_FEATURE_COST_CEILING"
        old = os.environ.pop(env_key, None)
        try:
            os.environ[env_key] = "-5.0"
