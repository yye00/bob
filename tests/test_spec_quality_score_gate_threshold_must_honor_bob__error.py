"""Error path tests for spec_quality_score gate threshold honor BOB_SPEC_QUALITY_THRESHOLD.
...
class TestErrorInvalidEnvVarDoesNotRaise:
    """Invalid BOB_SPEC_QUALITY_THRESHOLD falls back to 0.85 without raising."""
    ...
    def test_score_threshold_never_raises_on_bad_env(self, monkeypatch):
        ...
        monkeypatch.setattr(_tr, "_frozen_initialized", False)
        monkeypatch.setattr(_tr, "_frozen_value", None)
        monkeypatch.setenv("BOB_SPEC_QUALITY_THRESHOLD", "not_a_number")
    ...
    def test_nan_string_env_var_falls_back(self, monkeypatch):
        ...
        monkeypatch.setenv("BOB_SPEC_QUALITY_THRESHOLD", "totally_invalid")
    ...
    def test_frozen_env_with_invalid_value_falls_back(self, monkeypatch):
        monkeypatch.setattr(_tr, "_frozen_initialized", False)
        monkeypatch.setattr(_tr, "_frozen_value", None)
        monkeypatch.setenv("BOB_SPEC_QUALITY_THRESHOLD_FROZEN", "bad_value")
