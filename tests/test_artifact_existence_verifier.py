"""Tests for bob.artifact_existence_verifier.verify_ac_artifacts.
...
from bob.artifact_existence_verifier import ArtifactMiss, verify_ac_artifacts
...
class TestVerifyAcArtifactsFunctionDefined:
    def test_function_defined_present(self):
        ...
        result = verify_ac_artifacts(
            ["Function defined: bob.artifact_existence_verifier.verify_ac_artifacts"],
            workspace=ws,
        )
        assert result == []
