"""Tests for bob3.criteria_synthesizer.

Verifies that parse_criteria_response and inject_boundary_error_criteria
are importable from bob3.criteria_synthesizer and behave correctly.
"""
from __future__ import annotations

import pytest
from bob3.criteria_synthesizer import parse_criteria_response, inject_boundary_error_criteria
