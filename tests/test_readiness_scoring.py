"""Tests for bob.readiness_scoring (feature c13e7eb9).
...
class TestModuleImports:
    ...
    def test_module_importable(self):
        import bob.readiness_scoring  # noqa: F401

    def test_derive_readiness_from_components_importable(self):
        from bob.readiness_scoring import derive_readiness_from_components

        assert callable(derive_readiness_from_components)

    def test_seed_zero_readiness_features_importable(self):
        from bob.readiness_scoring import seed_zero_readiness_features
...
class TestDeriveReadinessFromComponents:
    ...
    def test_delegates_to_readiness_module(self):
        """derive_readiness_from_components must use bob.readiness.derive_readiness_score."""
        from bob.readiness_scoring import derive_readiness_from_components

        with patch("bob.readiness_scoring._derive_readiness_score", return_value=0.777) as mock:
...
class TestSeedZeroReadinessFeatures:
    ...
    def test_returns_int(self):
        ...
        with patch("bob.readiness_scoring._seed_readiness_at_iteration_start", return_value=0):
    ...
    def test_returns_count_from_delegate(self):
        ...
        with patch("bob.readiness_scoring._seed_readiness_at_iteration_start", return_value=5):
            result = seed_zero_readiness_features("test-project-id")
        assert result == 5
    ...
    def test_delegates_to_run_loop(self):
        ...
        with patch("bob.readiness_scoring._seed_readiness_at_iteration_start", return_value=3) as mock:
...
class TestOrchestratorIntegration:
    ...
    def test_seed_zero_readiness_callable_from_orchestrator_context(self):
        ...
        with patch("bob.readiness_scoring._seed_readiness_at_iteration_start", return_value=2):
            result = seed_zero_readiness_features("orch-project")
        assert result == 2

    def test_readiness_scoring_module_in_bob_namespace(self):
        """bob.readiness_scoring is accessible via the bob package namespace."""
        import bob.readiness_scoring as rs
