...
from bob.orchestrator import rca_infra_recovery
...
class TestPreNHHookCalledByOrchestrator(unittest.TestCase):
    ...
    def test_rca_infra_recovery_module_importable(self):
        ...
        mod = importlib.import_module("bob.orchestrator.rca_infra_recovery")
    ...
    def test_auto_reset_if_infra_returns_bool(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            agent_logs = tmpdir / ".bob" / "agent_logs"
            ...
            with (
                patch("bob.orchestrator.rca_infra_recovery._AGENT_LOGS_DIR", agent_logs),
                patch("bob.orchestrator.rca_infra_recovery._RCA_RESETS_JSONL", reviews / "rca_resets.jsonl"),
                patch("bob.orchestrator.rca_infra_recovery._SPAWN_RETRY_CONFIG", spawn_cfg),
            ):
