...
from bob.spec_quality.example_grammar import KeyExample, PropertyAC
...
class TestContractGrammarIntegration:
    ...
    def test_import_alongside_contract_grammar(self):
        from bob.spec_quality.contract_grammar import ContractSpec, emit_icontract_decorators
