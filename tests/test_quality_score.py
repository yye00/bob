"""Tests for bob3.spec_quality.quality_score — compute_score and gate_for_ready."""
...
def _reset_threshold_to_default(monkeypatch):
    ...
    BOB3_SPEC_QUALITY_THRESHOLD may be set to a lower value in the operator
...
def _make_good_feature():
    ...
    return {
        "name": "Good feature",
        "description": "Expose a public function compute_score in bob3.spec_quality.quality_score.",
        "acceptance_criteria": [
