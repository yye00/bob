"""Tests for bob.run_loop.readiness_seed_sweep (feature a892281e).

Verifies that:
- readiness_seed_sweep is importable and callable from bob.run_loop
...
class TestReadinessSeedSweepImport:
    """readiness_seed_sweep must be importable from bob.run_loop."""

    def test_importable(self):
        from bob.run_loop import readiness_seed_sweep
...
class TestAssessFeatureConfidenceImport:
    """bob.feature_assessment.assess_feature_confidence must be importable."""

    def test_importable(self):
        from bob.feature_assessment import assess_feature_confidence
