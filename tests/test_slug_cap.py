"""Tests for bob.slug_cap — length-capped module slug derivation.

Feature 3ae452ae-fa7e-4ed8-9028-59e1cb8dd420

Verifies that derive_canonical_slug in bob.slug_cap caps slugs at 60
...
from bob.slug_cap import build_fallback_criteria, derive_canonical_slug
...
def test_integration_with_spec_synthesizer() -> None:
    ...
    from bob.spec_synthesizer import _derive_canonical_slug as ss_fn
