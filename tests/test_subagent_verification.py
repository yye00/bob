"""Tests for VERIFICATION_PROMPT_SECTION and get_verification_prompt in bob.superpowers.
...
import bob.superpowers as superpowers
...
class TestGetVerificationPrompt:
    ...
    def test_non_pytest_acs_not_included_as_paths(self):
        ...
        assert "src/bob/my_module.py" not in result.replace(VERIFICATION_PROMPT_SECTION, "")
...
class TestScopedPytestIntegration:
    ...
    def test_verification_prompt_forbids_stdout_redirect(self):
        ...
        from bob.superpowers import verification_prompt_forbids_stdout_redirect
