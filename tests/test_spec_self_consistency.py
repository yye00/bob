...
from bob.spec_quality.self_consistency import SelfConsistencyResult
...
class TestRunStabilityCheck:
    ...
    def test_high_stability_routes_to_auto_accept(self, tmp_path):
        from bob.spec_quality.self_consistency import _route_result, AUTO_ACCEPT_THRESHOLD
...
class TestComputeJaccardScore:
    ...
    def test_below_clarification_threshold(self):
        from bob.spec_quality.self_consistency import CLARIFICATION_THRESHOLD
    ...
    def test_above_auto_accept_threshold(self):
        from bob.spec_quality.self_consistency import AUTO_ACCEPT_THRESHOLD
