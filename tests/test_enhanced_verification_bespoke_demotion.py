"""Tests for bob3.enhanced_verification.demote_bespoke_on_failure (dfaba5e5).
...
from bob3.enhanced_verification import demote_bespoke_on_failure
...
def test_probe_fails_module_absent_returns_false(tmp_path):
    ...
    absent = tmp_path / "src" / "bob3" / "missing.py"
...
def test_probe_raises_module_absent_returns_false(tmp_path):
    ...
    absent = tmp_path / "src" / "bob3" / "not_there.py"
