...
AC verification:
  - File exists: src/bob/bf_2_research_documentarian_sub_agent_hide_ticket_pattern.py
  - Function defined: bob.bf_2_research_documentarian_sub_agent_hide_ticket_pattern
...
Protocol invariants tested:
  ...
  5. output path resolves to .bob/features/<id>/research_notes.md
...
_MODULE = "bob.bf_2_research_documentarian_sub_agent_hide_ticket_pattern"
...
class TestOutputPath:
    ...
    def test_output_path_contains_feature_id(self, tmp_path):
        ...
        assert ".bob/features" in str(output_path).replace("\\", "/")
...
class TestCacheLogic:
    ...
    def test_cache_hit_when_notes_match(self, tmp_path):
        ...
        notes_dir = tmp_path / ".bob" / "features" / fid
