"""Tests for bob.code_test_matrix — CodeT KxK mutual-agreement triangulation.

Acceptance criteria verified:
  - File exists: src/bob/code_test_matrix.py
  - Function defined: bob.code_test_matrix.mutual_agreement_score
  - Function defined: bob.code_test_matrix.spawn_kxk_matrix
...
from bob.code_test_matrix import (
    CandidateImpl,
    CandidateTestSet,
    MatrixCell,
    NoCandidatesError,
...
class TestModuleExists:
    """AC: File exists: src/bob/code_test_matrix.py"""

    def test_module_importable(self):
        import bob.code_test_matrix  # noqa: F401
    ...
    def test_spawn_kxk_matrix_defined_in_module(self):
        import bob.code_test_matrix as m
...
class TestSpawnKxKMatrix:
    """AC: Function defined: bob.code_test_matrix.spawn_kxk_matrix"""
...
class TestMutualAgreementScore:
    """AC: Function defined: bob.code_test_matrix.mutual_agreement_score"""
...
class TestOrchestratorIntegration:
    ...
    def test_codet_triangulation_importable_from_orchestrator(self):
        from bob.orchestrator import codet_triangulation  # noqa: F401

    def test_spawn_k_tests_importable_from_orchestrator(self):
        from bob.orchestrator.codet_triangulation import spawn_k_tests  # noqa: F401
        assert callable(spawn_k_tests)

    def test_spawn_k_impls_importable_from_orchestrator(self):
        from bob.orchestrator.codet_triangulation import spawn_k_impls  # noqa: F401
        assert callable(spawn_k_impls)

    def test_score_matrix_importable_from_orchestrator(self):
        from bob.orchestrator.codet_triangulation import score_matrix  # noqa: F401
        assert callable(score_matrix)

    def test_mutual_agreement_score_importable_from_code_test_matrix(self):
        from bob.code_test_matrix import mutual_agreement_score  # noqa: F401
        assert callable(mutual_agreement_score)

    def test_spawn_kxk_matrix_importable_from_code_test_matrix(self):
        from bob.code_test_matrix import spawn_kxk_matrix  # noqa: F401
        assert callable(spawn_kxk_matrix)
    ...
    def test_code_test_matrix_delegates_to_orchestrator_codet_triangulation(self):
        from bob.orchestrator.codet_triangulation import score_matrix as _score_matrix
        from bob.code_test_matrix import score_matrix as cm_score_matrix
...
class TestTripleFilterReexport:
    def test_triple_filter_reachable_via_code_test_matrix(self):
        from bob.code_test_matrix import triple_filter  # noqa: F401
