"""Tests for bob3.spec_provenance.
...
Integration: bob3.spec_synthesizer — provenance spans can be attached after
...
from bob3.spec_provenance import compute_coverage, trace_ac_to_source
...
def test_compute_coverage_integrates_with_synthesizer_output():
    ...
    from bob3 import spec_synthesizer  # noqa: F401 — ensure importable
