...
- File exists: src/bob3/schema.py
- Function defined: bob3.schema.add_spec_slot_column
- Function defined: bob3.weekend_watchdog.check_convergence
- integration: bob3.spawn_watchdog
"""
...
# ---------------------------------------------------------------------------
# bob3.schema.add_spec_slot_column tests
# ---------------------------------------------------------------------------
...
class TestAddSpecSlotColumn:
    def test_adds_column_when_absent(self, tmp_path):
        ...
        from bob3.schema import add_spec_slot_column
...
# ---------------------------------------------------------------------------
# bob3.weekend_watchdog.check_convergence tests
# ---------------------------------------------------------------------------


class TestWeekendWatchdogCheckConvergence:
    def test_converged_identical_spec_slots(self, tmp_path):
        from bob3.orchestrator.weekend_watchdog import check_convergence
...
# ---------------------------------------------------------------------------
# bob3.spawn_watchdog integration tests (import + instantiation)
# ---------------------------------------------------------------------------
...
class TestSpawnWatchdogIntegration:
    ...
    def test_spawn_watchdog_module_importable(self):
        import bob3.spawn_watchdog as sw
