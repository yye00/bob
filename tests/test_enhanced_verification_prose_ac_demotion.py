...
and is_executable_or_structural_criterion in bob3.enhanced_verification.
"""
...
class TestProseAcDemotionViaCheckCriterionWithDetails:
    ...
    def test_function_defined_nonexistent_still_hard_fails(self, tmp_path):
        ...
        criterion = "Function defined: bob3.totally_nonexistent_module_xyz.nonexistent_func"
        assert is_executable_or_structural_criterion(criterion) is True
    ...
    def test_demotion_logged_as_prose_ac_demoted_event(self, tmp_path, caplog):
        ...
        demoted_records = [
            ...
            if r.name == "bob3.verification.prose_demotion"
        ]
    ...
    def test_is_executable_or_structural_criterion_importable_from_enhanced_verification(self):
        """is_executable_or_structural_criterion is accessible via bob3.enhanced_verification."""
        from bob3.enhanced_verification import is_executable_or_structural_criterion as fn
        assert callable(fn)
    ...
    def test_check_criterion_with_details_importable_from_enhanced_verification(self):
        """_check_criterion_with_details is accessible via bob3.enhanced_verification."""
        from bob3.enhanced_verification import _check_criterion_with_details as fn
        assert callable(fn)
