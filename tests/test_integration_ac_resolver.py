...
src/bob3/verification/integration_ac_resolver.py.
"""
...
class TestExtractIntegrationTargets:
    ...
    def test_extracts_dotted_tokens(self):
        ...
        criterion = "integration: all writes in bob3.reviews route through atomic_write_yaml"
    ...
    def test_does_not_include_first_word_if_undotted(self):
        ...
        criterion = "integration: all spec_findings.yaml writes in bob3.reviews route through atomic_write_yaml"
        targets = extract_integration_targets(criterion)
    ...
    def test_c09e9e64_regression_form(self):
        """Regression: the exact c09e9e64 criterion form extracts bob3.reviews."""
        from bob3.verification.integration_ac_resolver import extract_integration_targets
        ...
        targets = extract_integration_targets(criterion)
        assert "bob3.reviews" in targets, (
            f"Expected 'bob3.reviews' in targets, got: {targets}"
        )
...
class TestResolveIntegrationAc:
    ...
    def test_returns_true_for_wired_module(self, real_workspace):
        ...
        criterion = "integration: bob3.verification module exists"
    ...
    def test_unwired_single_dotted_returns_false(self, tmp_path):
        ...
        criterion = "integration: bob3.totally.nonexistent.xyz"
        passed, reason = resolve_integration_ac(criterion, tmp_path)
...
class TestLogIntegrationAcProseDemoted:
    ...
    def test_log_contains_criterion_and_candidates(self, caplog):
        ...
        criterion = "integration: all passes must route through bob3.checker"
        candidates = ["bob3.checker"]
