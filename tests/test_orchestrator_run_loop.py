"""Tests for bob.orchestrator.run_loop.
...
- apply_pessimistic_cost uses a per-feature ceiling (BOB_PER_FEATURE_COST_CEILING,
...
def test_loop_termination_importable():
    """LoopTermination can be imported from bob.orchestrator.run_loop."""
