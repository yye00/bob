"""Tests for bob.spec_synthesis.deterministic_fallback and
bob.spec_synthesis.ensure_boundary_and_error_coverage.

AC: pytest: tests/test_spec_synthesis_fallback.py
    integration: bob.spec_synthesis
"""
...
from bob.spec_synthesis import (
...
class TestDeterministicFallbackViaSpecSynthesis:
    """deterministic_fallback is accessible via bob.spec_synthesis and works correctly."""

    def test_import_deterministic_fallback(self):
        """Function is importable from bob.spec_synthesis."""
        from bob.spec_synthesis import deterministic_fallback as df
        assert callable(df)
...
class TestEnsureBoundaryAndErrorCoverageViaSpecSynthesis:
    """ensure_boundary_and_error_coverage is accessible via bob.spec_synthesis."""
    ...
    def test_injects_boundary_when_missing(self):
        criteria = ["File exists: src/bob/thing.py", "pytest: tests/test_thing.py"]
