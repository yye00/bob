"""Tests for bob.gate_blocked_feature_recovery (feature 36b33b52).
...
import importlib
import pytest
import bob.gate_blocked_feature_recovery as recovery
...
def test_module_importable():
    mod = importlib.import_module("bob.gate_blocked_feature_recovery")
