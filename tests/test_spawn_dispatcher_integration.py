"""Integration test: bob.orchestrator.spawn_dispatcher routes all spawns through spawn_with_retry.

AC 20: integration: bob.orchestrator.spawn_dispatcher
"""
...
from bob.orchestrator.spawn_dispatcher import dispatch_spawn
