"""Tests for bob3.spec_consistency_checker — N-sample stability check pre-critic.
...
Verifies:
  ...
  - Integration point: can be called before bob3.spec_critic.critique_spec
"""
...
from bob3.spec_consistency_checker import (
...
# ---------------------------------------------------------------------------
# Integration smoke test: check_spec_stability → bob3.spec_critic.critique_spec
# ---------------------------------------------------------------------------


class TestCheckSpecStabilityIntegration:
    """Smoke test for integration with bob3.spec_critic."""
    ...
    def test_import_from_bob3_spec_critic_works(self):
        # Integration: bob3.spec_critic module must be importable alongside checker
        from bob3.spec_critic import SpecCritic  # noqa: F401
        from bob3.spec_consistency_checker import check_spec_stability as _cs  # noqa: F401
        assert callable(_cs)
