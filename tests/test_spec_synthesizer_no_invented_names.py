...
3. Integration: bob3.spec_synthesizer is importable and the gate function works
...
from bob3.spec_synthesizer import should_emit_function_defined_ac, should_emit_function_ac
...
class TestIntegrationBobSpecSynthesizer:
    """Integration: bob3.spec_synthesizer module is wired up correctly."""
...
class TestReaperHandleExponentialBackoff:
    ...
    def test_backoff_decision_class_importable(self):
        from bob3.reaper import BackoffDecision
