...
def test_reconcile_from_disk_is_callable() -> None:
    """reconcile_from_disk is importable and callable from bob.disk_reconciler."""
...
# ---------------------------------------------------------------------------
# Integration: bob.run_loop exports are all present
# ---------------------------------------------------------------------------


def test_run_loop_exports_verify_fail_functions() -> None:
    """All required disk_reconciler verify-fail functions are accessible from bob.run_loop."""
