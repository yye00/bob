"""Tests for bob.zombie_subagentruns_reaper.reap_zombie_subagentruns.

AC: pytest: tests/test_zombie_subagentruns_reaper.py
    Function defined: bob.zombie_subagentruns_reaper.reap_zombie_subagentruns
"""
...
from bob.zombie_subagentruns_reaper import reap_zombie_subagentruns
...
class TestReapZombieSubagentrunsImport:
    ...
    def test_module_importable(self):
        import bob.zombie_subagentruns_reaper  # noqa: F401
...
class TestReapZombieSubagentrunsHappyPath:
    ...
    def test_no_zombies_returns_empty_list(self):
        with patch(
            "bob.zombie_subagentruns_reaper.scan_and_reap", return_value=[]
        ) as mock:
    ...
    def test_returns_reaped_ids(self):
        with patch(
            "bob.zombie_subagentruns_reaper.scan_and_reap",
...
class TestReapZombieSubagentrunsIntegrationOrchestrator:
    """Integration: bob.orchestrator already imports from zombie_run_reaper.
