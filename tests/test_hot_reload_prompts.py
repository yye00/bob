"""Tests for bob3.superpowers.reload_prompt_source_if_changed (feature 6a31a708).

Verifies that the per-module hot-reload function:
- is importable and callable from bob3.superpowers
...
- works for the default module (bob3.superpowers) and for explicit names
...
def test_reload_prompt_source_if_changed_importable():
    """reload_prompt_source_if_changed must be importable from bob3.superpowers."""
    from bob3.superpowers import reload_prompt_source_if_changed  # noqa: F401


def test_reload_prompt_source_if_changed_is_callable():
    """reload_prompt_source_if_changed must be callable."""
    from bob3.superpowers import reload_prompt_source_if_changed
...
def test_reload_prompt_source_if_changed_default_module():
    """Default module_name is bob3.superpowers."""
    from bob3.superpowers import reload_prompt_source_if_changed
    import bob3.orchestrator.prompt_source_reloader as _reloader
...
def test_orchestrator_reloader_module_watches_superpowers():
    """The reloader's module watch-list includes bob3.superpowers."""
...
def test_orchestrator_reloader_module_watches_models():
    """The reloader's module watch-list includes bob3.models."""
    from bob3.orchestrator.prompt_source_reloader import _PROMPT_SOURCE_MODULES
...
def test_reload_prompt_source_if_changed_idempotent_on_consecutive_calls():
    ...
    try:
        ...
        mtime = _reloader._MTIME_CACHE.get("bob3.superpowers", 0.0)
