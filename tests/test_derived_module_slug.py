"""Tests for bob3.derived_module_slug module.
...
from bob3.derived_module_slug import (
...
def test_build_fallback_criteria_file_and_function_same_slug() -> None:
    ...
    # Extract slug from File exists: src/bob3/<slug>.py
    file_slug = file_acs[0].replace("File exists: src/bob3/", "").replace(".py", "")
    # Extract slug from Function defined: bob3.<slug>.<something>
    func_parts = func_acs[0].replace("Function defined: bob3.", "").split(".")
