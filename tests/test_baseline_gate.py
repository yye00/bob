...
from bob3.verifier import validate_collection as vc_from_verifier, CollectionResult as CR_from_verifier
...
# ---------------------------------------------------------------------------
# Integration: bob3.verifier exposes validate_collection
# ---------------------------------------------------------------------------

def test_verifier_integration_exposes_validate_collection():
    """bob3.verifier re-exports validate_collection from bob.baseline_gate."""
