"""Tests for bob3.deterministic_pytest_snapshots.

Acceptance criteria:
- File exists: src/bob3/deterministic_pytest_snapshots.py
- Function defined: bob3.deterministic_pytest_snapshots.enforce_maxfail_zero_snapshot
...
import bob3.deterministic_pytest_snapshots as mod
from bob3.deterministic_pytest_snapshots import (
    MAXFAIL_ZERO,
...
class TestOrchestratorIntegration:
    """bob3.deterministic_pytest_snapshots integrates with bob3.orchestrator."""
    ...
    def test_module_importable_from_orchestrator_import_chain(self):
        from bob3.deterministic_pytest_snapshots import enforce_maxfail_zero_snapshot
        assert callable(enforce_maxfail_zero_snapshot)

    def test_enforce_maxfail_zero_snapshot_used_by_orchestrator(self):
        import ast
        import pathlib
        run_loop_path = pathlib.Path(__file__).parent.parent / "src" / "bob3" / "orchestrator" / "run_loop.py"
