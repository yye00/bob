"""Tests for bob.sub_translation_provenance.
...
from bob.sub_translation_provenance import add_provenance_to_ac, trace_ac_to_intent
...
def _make_temp_db(feature_id: str, description: str, acs: list[str]) -> str:
    """Create a minimal bob.db in a temp directory and return its path."""
