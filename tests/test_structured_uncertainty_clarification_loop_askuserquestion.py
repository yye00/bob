...
from bob.structured_uncertainty_clarification_loop_askuserquestion import (
...
class TestStructuredUncertaintyClarificationLoopAskUserQuestion:
    ...
    _FUNCS_AC = [
        "File exists: src/bob/structured_uncertainty_clarification_loop_askuserquestion.py",
        "Function defined: bob.structured_uncertainty_clarification_loop_askuserquestion.structured_uncertainty_clarification_loop_askuserquestion",
    ]
    ...
    def test_file_exists_ac_produces_no_stubs(self):
        acs = ["File exists: src/bob/some_module.py"]
        result = structured_uncertainty_clarification_loop_askuserquestion(
            acceptance_criteria=acs,
            ci_mode=True,
        )
