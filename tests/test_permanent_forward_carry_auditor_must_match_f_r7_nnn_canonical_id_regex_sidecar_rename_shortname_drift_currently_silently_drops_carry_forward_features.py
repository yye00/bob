...
import bob.permanent_forward_carry_auditor_must_match_f_r7_nnn_canonical_id_regex_sidecar_rename_shortname_drift_currently_silently_drops_carry_forward_features as auditor_module
from bob.permanent_forward_carry_auditor_must_match_f_r7_nnn_canonical_id_regex_sidecar_rename_shortname_drift_currently_silently_drops_carry_forward_features import (
    BootstrapAuditError,
