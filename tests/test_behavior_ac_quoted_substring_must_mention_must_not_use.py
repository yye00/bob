...
AC: Function defined: bob3.behavior_ac_quoted_substring_must_mention_must_not_use.behavior_ac_quoted_substring_must_mention_must_not_use
"""
...
from bob3.behavior_ac_quoted_substring_must_mention_must_not_use import (
