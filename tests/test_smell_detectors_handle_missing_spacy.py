...
from bob.spec_quality.smell_detectors import SpacyModelMissingError, handle_missing_spacy_model
...
class TestHandleMissingSpacyModel:
    ...
    def test_spacy_model_missing_error_importable(self):
        from bob.spec_quality.smell_detectors import SpacyModelMissingError as E
