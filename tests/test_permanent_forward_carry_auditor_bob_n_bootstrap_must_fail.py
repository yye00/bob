"""Tests for the permanent-forward-carry bootstrap auditor (short-name AC module).
...
from bob3.permanent_forward_carry_auditor_bob_n_bootstrap_must_fail import (
    BootstrapAuditError,
    permanent_forward_carry_auditor_bob_n_bootstrap_must_fail as auditor_fn,
)
...
def test_permanent_forward_carry_auditor_bob_n_bootstrap_must_fail():
