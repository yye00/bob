"""Tests for bob3.watchdog.stall_escalation.escalate_spec_gate_stall."""
...
from bob3.watchdog.stall_escalation import escalate_spec_gate_stall, escalate_stall_observation
...
class TestEscalateSpecGateStallBasic:
    ...
    def test_custom_threshold_triggers_at_n(self, tmp_path):
        marker = tmp_path / "STALL.txt"
        with patch.dict(os.environ, {"BOB3_STALL_ESCALATION_COUNT": "2"}):
