...
from bob.spec_quality.ambiguity_linter import lint_feature, is_ambiguous_ac, has_concrete_identifier


class TestAcceptsStructuredForms:
    def test_file_exists(self):
        result = lint_feature("F", ["File exists: src/bob/spec_quality/ambiguity_linter.py"])
    ...
    def test_function_defined(self):
        result = lint_feature("F", ["Function defined: bob.spec_quality.ambiguity_linter.lint_feature"])
        assert result.passed
    ...
    def test_all_forms_together(self):
        criteria = [
            ...
            "Class defined: bob.spec_quality.ambiguity_linter.FeatureLintResult",
    ...
    def test_is_ambiguous_ac_returns_false_for_structured_form(self):
        ...
        assert is_ambiguous_ac("Function defined: bob.foo.bar") is False
    ...
    def test_has_concrete_identifier_true_for_structured_forms(self):
        ...
        assert has_concrete_identifier("Function defined: bob.foo.bar") is True
