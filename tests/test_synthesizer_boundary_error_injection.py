"""Tests for inject_boundary_and_error_acs from bob3.synthesizer.
...
class TestInjectBoundaryAndErrorAcs:
    ...
    def test_injects_boundary_ac_when_absent(self):
        ...
        criteria = [
            "File exists: src/bob3/synthesizer_boundary_error_injector.py",
    ...
    def test_injects_error_ac_when_absent(self):
        ...
        criteria = [
            "File exists: src/bob3/synthesizer_boundary_error_injector.py",
            "Function defined: bob3.synthesizer.inject_boundary_and_error_criteria",
        ]
        result = inject_boundary_and_error_acs(criteria, title="my feature")
        joined = " ".join(result).lower()
