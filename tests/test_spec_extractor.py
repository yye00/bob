"""Tests for bob.spec_extractor.reject_behavior_ac_for_verifier_extension.
...
class TestIntegrationWithOrchestrator:
    """Integration tests verifying bob.spec_extractor works with orchestrator context."""

    def test_same_verifier_extension_modules_as_spec_quality(self):
        """bob.spec_extractor re-exports the same VERIFIER_EXTENSION_MODULES as spec_quality."""
