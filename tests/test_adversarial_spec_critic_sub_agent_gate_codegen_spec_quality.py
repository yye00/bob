...
Acceptance criteria:
  - File exists: src/bob/adversarial_spec_critic_sub_agent_gate_codegen_spec_quality.py
  ...
  - Function defined: bob.adversarial_spec_critic_sub_agent_gate_codegen_spec_quality.adversarial_spec_critic_sub_agent_gate_codegen_spec_quality
"""
...
from bob.adversarial_spec_critic_sub_agent_gate_codegen_spec_quality import (
...
def test_adversarial_spec_critic_sub_agent_gate_codegen_spec_quality(tmp_path):
    ...
    from bob.spec_quality.spec_critic import ConstitutionMissingError
