"""Tests for bob3.verifier.check_baseline_collection.

AC: pytest: tests/test_verifier_baseline_gate.py
    integration: bob3.verifier
    Function defined: bob3.verifier.check_baseline_collection

Verifies that check_baseline_collection is accessible from bob3.verifier
...
from bob3.verifier import check_baseline_collection
from bob.baseline_gate import CollectionResult
...
def test_check_baseline_collection_importable_from_bob3_verifier():
    """check_baseline_collection must be importable from bob3.verifier."""
    from bob3.verifier import check_baseline_collection as fn  # noqa: F401
    assert callable(fn)


def test_check_baseline_collection_in_verifier_namespace():
    """check_baseline_collection must exist in bob3.verifier's namespace."""
    import bob3.verifier as verifier_mod
