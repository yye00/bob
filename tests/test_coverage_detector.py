"""Tests for bob3.coverage_detector.detect_boundary_error_coverage."""

from __future__ import annotations

import pytest
from bob3.coverage_detector import detect_boundary_error_coverage
...
class TestProseOnlyFiltering:
    ...
    def test_structural_ac_file_exists_boundary_slug_is_ignored(self):
        ...
        criteria = ["File exists: src/bob3/limit_checker.py"]
        has_boundary, has_error = detect_boundary_error_coverage(criteria)
        assert has_boundary is False
    ...
    def test_structural_ac_function_defined_error_slug_is_ignored(self):
        ...
        criteria = ["Function defined: bob3.error_handler.handle"]
        has_boundary, has_error = detect_boundary_error_coverage(criteria)
        assert has_error is False
    ...
    def test_structural_ac_integration_error_is_ignored(self):
        ...
        criteria = ["integration: bob3.error_propagation"]
        has_boundary, has_error = detect_boundary_error_coverage(criteria)
        assert has_error is False
    ...
    def test_mixed_structural_and_prose(self):
        ...
        criteria = [
            "File exists: src/bob3/error_handler.py",
            "Function defined: bob3.minimum_value",
    ...
    def test_python_label_excluded(self):
        ...
        criteria = ["python: from bob3.error_handling import handle"]
        has_boundary, has_error = detect_boundary_error_coverage(criteria)
        assert has_error is False
