"""Tests for bob3.linters.full_22_smell — Full 22-smell linter extension to F-R7-410.

Verifies that detect_smells is accessible from the bob3.linters.full_22_smell
...
from bob3.linters.full_22_smell import (
    BLOCKING_SMELLS,
    SMELL_BY_ID,
    SMELL_CATALOG,
    SPACY_SMELLS,
