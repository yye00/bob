"""Tests for bob3.agent_run.create_agent_run.

Verifies that the facade in bob3.agent_run correctly delegates to bob3.db and
...
from bob3 import db
from bob3.agent_run import create_agent_run
...
def test_create_agent_run_importable():
    from bob3.agent_run import create_agent_run as fn
    assert callable(fn)
