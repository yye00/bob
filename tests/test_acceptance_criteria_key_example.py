"""Tests for bob.acceptance_criteria.parse_key_example_ac.

Verifies the key_example sub-key parsing: given/then dict and string forms
are correctly handled and exported from bob.acceptance_criteria.
"""
...
from bob.acceptance_criteria import parse_key_example_ac
...
class TestParseKeyExampleACImport:
    def test_function_importable_from_acceptance_criteria(self):
        from bob.acceptance_criteria import parse_key_example_ac as fn
        assert callable(fn)
