...
from bob.skill_library.registry import add_skill, similarity_threshold
from bob.voyager_style_persistent_skill_library_env_workarounds_shims import (
...
def test_persist_path_writes_new_skill_to_library(tmp_path):
    ...
    from bob.skill_library.registry import search_skills
    hits = search_skills(
...
def test_module_importable_and_function_defined():
    ...
    import bob.voyager_style_persistent_skill_library_env_workarounds_shims as mod
    assert callable(
