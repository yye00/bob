"""Tests for src/bob/property_based_test_generator_hypothesis_ears.py (feature d92d055b).
...
from bob.property_based_test_generator_hypothesis_ears import (
    EARSClause,
    EARSClauseKind,
    PropertyTestResult,
    PropertyTestSuite,
...
class TestRunPropertySuite:
    ...
    def test_run_with_differential_harness(self):
        ...
        from bob.differential_testing_harness import run_differential_test
