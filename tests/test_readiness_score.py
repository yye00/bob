"""Tests for bob3.readiness_score — live derivation from confidence components.

Acceptance criteria verified:
- Function defined: bob3.readiness_score.compute_readiness_from_components
- Function defined: bob3.readiness_score.seed_zero_readiness_features
"""
...
from bob3.readiness_score import (
...
class TestSeedZeroReadinessFeatures:
    ...
    def test_delegates_to_derivation_layer(self):
        with patch("bob3.readiness_score.seed_zero_readiness_features") as mock_fn:
    ...
    def test_returns_int_on_no_op(self):
        ...
        with patch("bob3.readiness_derivation.seed_zero_readiness_features", return_value=0):
