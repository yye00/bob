"""Tests for bob3.spawn_reinit_guard.verify_project_metadata.
...
rsync-copies the parent bob3.db without re-running bob3 init.
"""
...
class TestVerifyProjectMetadata:
    """Core behavior of bob3.spawn_reinit_guard.verify_project_metadata."""
    ...
    def test_stale_name_is_detected_and_corrected(self, tmp_path):
        ...
        from bob3.spawn_reinit_guard import verify_project_metadata
