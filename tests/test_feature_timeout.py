"""Tests for bob.timeout — per-feature wall-clock timeout enforcement.
...
- resolve_timeout_seconds reads BOB_FEATURE_TIMEOUT_SECONDS env var correctly
- Empty/zero/invalid inputs produce well-defined errors (not silent success/crash)
- Integration: execute_feature in bob.orchestrator module is importable
"""
...
# ---------------------------------------------------------------------------
# Integration — bob.orchestrator.execute_feature importable
# ---------------------------------------------------------------------------
...
def test_timeout_module_exports():
    from bob import timeout as timeout_mod
