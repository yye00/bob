"""Tests for bob3.self_discover_meta_agent.
...
class TestSpecSynthesizerIntegration:
    def test_select_spec_sections_importable_from_self_discover(self):
        from bob3.self_discover_meta_agent import select_spec_sections as fn
        assert callable(fn)

    def test_run_focused_extractor_importable_from_self_discover(self):
        from bob3.self_discover_meta_agent import run_focused_extractor as fn
        assert callable(fn)
    ...
    def test_run_focused_extractor_section_map_valid(self):
        from bob3.spec_quality.section_selector import validate_output_schema
        result = run_focused_extractor(
