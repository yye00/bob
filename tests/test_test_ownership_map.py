"""Tests for bob.test_ownership_map — build_test_ownership_map and verify_regression_owner.
...
class TestBuildTestOwnershipMap:
    ...
    def test_non_pytest_acs_are_ignored(self):
        features = [
            {
                "id": "feat-x",
                "acceptance_criteria": '["File exists: src/bob/x.py", "Function defined: bob.x.my_fn"]',
            }
        ]
        result = build_test_ownership_map(features)
        assert result == {}
