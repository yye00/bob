"""Tests for bob3.brownfield.search_subagent (Feature 5c5826d3).
...
class TestSearchResult:
    ...
    def test_from_dict_roundtrip(self):
        ...
        assert sr.path == "src/bob3/bar.py"
