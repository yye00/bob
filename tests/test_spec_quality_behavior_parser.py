"""Tests for bob3.spec_quality.parse_behavior_ac integration.
...
Verifies:
  - parse_behavior_ac importable from bob3.spec_quality
  - BehaviorAC importable from bob3.spec_quality
...
# ---------------------------------------------------------------------------
# Integration: importable from bob3.spec_quality
# ---------------------------------------------------------------------------

def test_parse_behavior_ac_importable():
    """parse_behavior_ac must be accessible from bob3.spec_quality."""
...
def test_accepts_synonym_conditional_importable():
    """accepts_synonym_conditional must be importable from bob3.spec_quality."""
    import bob3.spec_quality as sq
