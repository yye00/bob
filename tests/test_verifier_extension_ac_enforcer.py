"""Tests for bob3.verifier_extension_ac_enforcer.enforce_ac_discipline.
...
def test_enforce_ac_discipline_demotes_behavior_ac():
    ...
    acs = [
        "structural: src/bob3/enhanced_verification.py contains regex PATTERN",
...
def test_enforce_ac_discipline_multiple_behavior_acs():
    ...
    result = enforce_ac_discipline(
        acs,
        "src/bob3/verification/verifier.py",
...
def test_enforce_ac_discipline_warning_logged_per_demoted_ac():
    ...
    handler = _Capture()
    logger = logging.getLogger("bob3.spec_quality.spec_extractor")
...
def test_enforce_ac_discipline_returns_ac_filter_result():
    ...
    result = enforce_ac_discipline([], "src/bob3/enhanced_verification.py")
...
def test_enforce_ac_discipline_integration_with_spec_extractor():
    ...
    target = "src/bob3/enhanced_verification.py"
