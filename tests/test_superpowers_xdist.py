"""Tests for pytest-xdist parallelisation in bob.superpowers.
...
- Integration: bob.superpowers module exposes _select_xdist_workers
"""
...
class TestCheckTestsPassXdist:
    ...
    def test_xdist_flags_in_cmd_when_available(self, tmp_path):
        ...
        with mock.patch("bob.superpowers._run_with_pgroup_timeout", side_effect=fake_run):
            with mock.patch.dict("sys.modules", {"xdist": mock.MagicMock()}):
                with mock.patch("bob.superpowers._select_xdist_workers", return_value=4):
