...
class TestAgentRunSignature:
    ...
    def test_run_accepts_round_num(self, module_name):
        import importlib
        mod = importlib.import_module(f"bob3.research.{module_name}")
