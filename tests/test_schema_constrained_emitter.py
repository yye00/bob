"""Tests for bob.schema_constrained_emitter.emit_with_schema.

Tests the integration facade: schema validation, rejection behaviour,
and integration with bob.spec_critic.
"""
...
class TestEmitWithSchemaExists:
    def test_module_importable(self):
        """bob.schema_constrained_emitter must be importable."""
        import bob.schema_constrained_emitter  # noqa: F401

    def test_function_defined(self):
        """emit_with_schema must be defined in bob.schema_constrained_emitter."""
        from bob.schema_constrained_emitter import emit_with_schema
...
class TestIntegrationWithSpecCritic:
    def test_spec_critic_importable(self):
        """bob.spec_critic must be importable alongside schema_constrained_emitter."""
        import bob.spec_critic  # noqa: F401
        import bob.schema_constrained_emitter  # noqa: F401
