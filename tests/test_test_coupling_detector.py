...
from bob3.test_coupling_detector import (
    CouplingFinding,
    CouplingResult,
...
class TestDataModels:
    def test_coupling_finding_has_required_fields(self):
        f = CouplingFinding(
            ...
            detail="tests/test_foo.py imports src/bob3/foo directly",
        )
...
class TestDetectInternalImports:
    ...
    def test_direct_src_submodule_import_flagged(self, tmp_path):
        """Importing bob3.internal or bob3._private from a test file is flagged."""
        _write(tmp_path, "src/bob3/__init__.py", "")
        _write(tmp_path, "src/bob3/_internal.py", "SECRET = 'x'")
        _write(tmp_path, "tests/test_internal.py", """\
            from bob3._internal import SECRET
    ...
    def test_underscore_private_module_import_flagged(self, tmp_path):
        ...
        _write(tmp_path, "tests/test_priv.py", """\
            from bob3._helpers import _helper_fn
