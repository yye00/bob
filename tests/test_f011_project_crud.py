...
class TestUpdateProject:
    ...
    def test_update_project_changes_name(self, db_path):
        from bob.db import create_project, get_project, update_project
    ...
    def test_update_project_returns_updated_project(self, db_path):
        from bob.db import create_project, update_project
        from bob.models import Project
...
class TestListProjects:
    ...
    def test_list_projects_empty(self, db_path):
        from bob.db import list_projects

        projects = list_projects()
        assert projects == []

    def test_list_projects_returns_all(self, db_path):
        from bob.db import create_project, list_projects
    ...
    def test_list_projects_after_update(self, db_path):
        from bob.db import create_project, update_project, list_projects
