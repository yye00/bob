"""Tests for bob.readiness_score.derive_readiness_from_confidence (feature 7042c0c5).

Verifies that:
- derive_readiness_from_confidence is importable from bob.readiness_score
...
class TestDeriveReadinessFromConfidenceImport:
    """derive_readiness_from_confidence must be importable from bob.readiness_score."""

    def test_importable(self):
        from bob.readiness_score import derive_readiness_from_confidence
    ...
    def test_module_file_exists(self):
        ...
        spec = importlib.util.find_spec("bob.readiness_score")
        assert spec is not None, "bob.readiness_score module must exist"

    def test_derive_readiness_score_also_exported(self):
        from bob.readiness_score import derive_readiness_score
...
class TestReadinessScoreModuleIntegrity:
    """The readiness_score module must correctly re-export from bob.readiness."""

    def test_delegates_to_same_logic_as_readiness_module(self):
        from bob.readiness import derive_readiness_score as canonical
        from bob.readiness_score import derive_readiness_from_confidence
    ...
    def test_derive_readiness_score_alias_gives_same_result(self):
        from bob.readiness_score import derive_readiness_from_confidence, derive_readiness_score
