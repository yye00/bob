"""Tests for bob3.features — spec_slot column management and backfill.
...
def test_backfill_spec_slot_is_importable():
    """backfill_spec_slot must be importable from bob3.features."""
    from bob3.features import backfill_spec_slot  # noqa: F401
...
def test_backfill_spec_slot_matches_by_name(tmp_path):
    ...
    from bob3.features import backfill_spec_slot
