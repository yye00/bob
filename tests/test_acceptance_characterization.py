"""Tests for bob3.acceptance.characterization and bob3.acceptance.observer modules.
...
Covers the public API surface required by BF-6 acceptance criteria:
  ...
  - observe_target_behavior is importable from bob3.acceptance.observer
...
from bob3.acceptance.characterization import CharacterizationAC
from bob3.acceptance.observer import observe_target_behavior
