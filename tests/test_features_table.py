"""Tests for bob.features_table — spec_slot column management."""
...
def test_features_table_module_importable():
    """bob.features_table must be importable."""
    import bob.features_table  # noqa: F401


def test_add_spec_slot_column_is_callable():
    """add_spec_slot_column must be a callable."""
    from bob.features_table import add_spec_slot_column
...
def test_backfill_spec_slot_returns_updated_count(tmp_path):
    ...
    from bob.features_table import backfill_spec_slot
...
def test_backfill_spec_slot_skips_already_filled(tmp_path):
    ...
    from bob.features_table import backfill_spec_slot, add_spec_slot_column
