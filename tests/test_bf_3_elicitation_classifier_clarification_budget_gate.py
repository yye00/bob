...
Acceptance criteria tested:
  - File exists: src/bob/bf_3_elicitation_classifier_clarification_budget_gate.py
  - Function defined: bob.bf_3_elicitation_classifier_clarification_budget_gate.bf_3_elicitation_classifier_clarification_budget_gate
  ...
  - File exists: src/bob/brownfield/elicit.py
"""
...
def test_brownfield_elicit_module_importable():
    """File exists AC: src/bob/brownfield/elicit.py must be importable."""
    from bob.brownfield import elicit  # noqa: F401
...
def test_brownfield_intent_schema_fields():
    ...
    from bob.brownfield.elicit import classify_intent, BrownfieldIntent
...
def test_run_loop_integration_import():
    """Integration AC: bob.orchestrator.run_loop must import BF-3 entry point."""
    import bob.orchestrator.run_loop as rl  # noqa: F401
