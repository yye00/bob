"""Tests for bob.verifier_extension_enforcer.
...
from bob.verifier_extension_enforcer import (
...
_NORMAL_TARGET = "src/bob/some_unrelated_module.py"
...
class TestIsVerifierExtensionModule:
    ...
    def test_unknown_path_returns_false(self):
        assert is_verifier_extension_module("src/bob/some_module.py") is False

    def test_empty_string_returns_false(self):
        assert is_verifier_extension_module("") is False

    def test_partial_match_in_path_still_detects(self):
        assert is_verifier_extension_module("src/bob/enhanced_verification.py") is True

    def test_unrelated_module_returns_false(self):
        assert is_verifier_extension_module("src/bob/database.py") is False
...
class TestRejectBehaviorAc:
    ...
    def test_warning_logged_per_demoted_ac(self):
        ...
        handler = _Capture()
        log = logging.getLogger("bob.verifier_extension_enforcer")
