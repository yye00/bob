"""Tests for stuck_readiness_decomposition_trigger_kill_eval_demotion."""

import pytest

from bob3.models import Feature
from bob3.stuck_readiness_decomposition_trigger_kill_eval_demotion import (
    stuck_readiness_decomposition_trigger_kill_eval_demotion,
)
...
def test_stuck_readiness_decomposition_trigger_kill_eval_demotion():
    """Core acceptance-criteria test: validates all decision branches."""
    fn = stuck_readiness_decomposition_trigger_kill_eval_demotion
