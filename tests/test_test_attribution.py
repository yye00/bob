"""Tests for bob.test_attribution module.
...
def test_function_is_importable():
    """attribute_regression_to_owning_feature is importable from bob.test_attribution."""
...
def test_importable_from_verifier():
    """attribute_regression_to_owning_feature is re-exported via bob.verifier."""
