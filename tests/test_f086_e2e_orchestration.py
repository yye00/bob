...
End-to-end integration test that exercises the full Bob workflow:
Step 1: Run bob init test-project
...
class TestE2EInitProject:
    ...
    def test_init_creates_project_and_database(self, tmp_path):
        """bob init creates project directory, database, and project record."""
        ...
        assert (project_path / "bob.db").exists()

    def test_init_inserts_project_record(self, tmp_path):
        """bob init inserts a project record into the database."""
        import sqlite3
...
class TestE2ERunOrchestration:
    """Step 4-7: Run bob run and verify full orchestration flow."""
