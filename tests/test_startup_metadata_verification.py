"""Tests for bob.startup.verify_project_metadata.
...
class TestStartupModuleExposesVerifyProjectMetadata:
    """bob.startup.verify_project_metadata is accessible and functional."""

    def test_importable_from_startup_module(self):
        from bob.startup import verify_project_metadata
        assert callable(verify_project_metadata)

    def test_returns_project_metadata_check_result(self, tmp_path):
        from bob.startup import verify_project_metadata, ProjectMetadataCheckResult
