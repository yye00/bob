"""Tests for successor-gen verification handoff in bob3.run_loop (3682d2e7).

Acceptance criteria:
- File exists: src/bob3/enhanced_verification.py
- Function defined: bob3.run_loop.handle_pending_successor_verify
...
# ---------------------------------------------------------------------------
# AC 1: File exists — src/bob3/enhanced_verification.py
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# AC 2: Function defined — bob3.run_loop.handle_pending_successor_verify
# ---------------------------------------------------------------------------
...
class TestGuardConditions:
    ...
    def test_workspace_without_verifier_module_returns_false(self, tmp_path):
        ...
        src_bob3 = tmp_path / "src" / "bob3"
        src_bob3.mkdir(parents=True)
        (src_bob3 / "something_else.py").write_text("# unrelated")
...
class TestRunLoopIntegration:
    ...
    def test_handle_pending_delegates_to_status_handlers(self):
        """handle_pending_successor_verify delegates to bob3.status_handlers."""
        from bob3.run_loop import handle_pending_successor_verify
        with patch("bob3.status_handlers.handle_pending_successor_verify") as mock_handler:
    ...
    def test_set_pending_delegates_to_pending_successor_verify(self, tmp_path):
        """set_pending_successor_verify delegates to bob3.pending_successor_verify."""
        from bob3.run_loop import set_pending_successor_verify
    ...
    def test_handle_and_set_consistent_for_valid_verifier_workspace(self, tmp_path):
        ...
        from bob3.run_loop import handle_pending_successor_verify, set_pending_successor_verify
