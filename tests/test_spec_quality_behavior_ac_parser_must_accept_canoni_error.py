...
import pytest
from bob3.parser.behavior_ac_parser import parse_behavior_ac
from bob3.spec_quality.behavior_ac_parser import parse_behavior_ac as sq_parse_behavior_ac
...
class TestNonBehaviorPrefixRaisesValueError:
    ...
    def test_file_exists_prefix_raises(self):
        with pytest.raises(ValueError):
            parse_behavior_ac("File exists: src/bob3/parser/behavior_ac_parser.py")

    def test_function_defined_prefix_raises(self):
        with pytest.raises(ValueError):
            parse_behavior_ac("Function defined: bob3.parser.behavior_ac_parser.parse_behavior_ac")
