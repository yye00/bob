"""Tests for src/bob3/build_twice.py (Gap #7: Build-twice nondeterminism detector).
...
class TestCompareBuilds:
    ...
    def test_logs_to_progress_jsonl_when_flagged(self, tmp_path):
        ...
        # When flagged, progress.jsonl must exist in workspace/.bob3/
        progress = tmp_path / ".bob3" / "progress.jsonl"
        if report.flagged:
