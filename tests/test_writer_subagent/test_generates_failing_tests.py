...
class TestGeneratesFailingTests:
    def test_single_ac_emits_one_test(self, tmp_path):
        ...
        result = generate_failing_tests(
            "feat-gft-single",
            ["File exists: src/bob3/target.py"],
            workspace=tmp_path,
        )
    ...
    def test_multiple_acs_emit_multiple_tests(self, tmp_path):
        ...
        acs = [
            "File exists: src/bob3/mod_a.py",
            "Function defined: bob3.mod_a.func_a",
    ...
    def test_emitted_tests_are_under_tests_feature_id_directory(self, tmp_path):
        ...
        result = generate_failing_tests(
            feature_id,
            ["File exists: src/bob3/path_check.py"],
            workspace=tmp_path,
        )
    ...
    def test_result_has_required_keys(self, tmp_path):
        ...
        result = generate_failing_tests(
            "feat-gft-keys",
            ["File exists: src/bob3/keys_check.py"],
            workspace=tmp_path,
        )
    ...
    def test_emitted_test_feature_id_matches(self, tmp_path):
        ...
        result = generate_failing_tests(
            feature_id,
            ["File exists: src/bob3/id_check.py"],
            workspace=tmp_path,
        )
        for et in result["emitted"]:
    ...
    def test_emitted_ac_index_is_sequential(self, tmp_path):
        ...
        acs = [
            "File exists: src/bob3/seq_a.py",
            "File exists: src/bob3/seq_b.py",
        ]
    ...
    def test_filter_results_length_matches_emitted(self, tmp_path):
        ...
        acs = ["File exists: src/bob3/fr_a.py", "File exists: src/bob3/fr_b.py"]
    ...
    def test_bijection_satisfied(self, tmp_path):
        ...
        result = generate_failing_tests(
            "feat-gft-bijection",
            ["File exists: src/bob3/bij.py", "Function defined: bob3.bij.fn"],
            workspace=tmp_path,
        )
    ...
    def test_gate_passed_true_for_valid_acs(self, tmp_path):
        ...
        result = generate_failing_tests(
            "feat-gft-gate",
            ["File exists: src/bob3/gate_check.py"],
            workspace=tmp_path,
        )
