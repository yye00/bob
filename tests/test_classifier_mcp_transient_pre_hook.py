"""Tests for bob3.classifier_mcp_transient.classify_mcp_transient_pre_hook.

AC: pytest: tests/test_classifier_mcp_transient_pre_hook.py
AC: File exists: src/bob3/classifier_mcp_transient.py
AC: Function defined: bob3.classifier_mcp_transient.classify_mcp_transient_pre_hook
...
from bob3.classifier_mcp_transient import (
...
class TestMcpTransientPreHookImport:
    """Module and function must be importable from bob3.classifier_mcp_transient."""
...
class TestRunLoopIntegration:
    """Verify the integration: bob3.run_loop exports match what classifier_mcp_transient wraps."""
