"""Tests for sticky_completed_gate_re_evaluation_cannot_un_complete.

Feature 305ff67f — Sticky-completed gate: re-evaluation cannot un-complete persisted work.
"""
...
from bob3.sticky_completed_gate_re_evaluation_cannot_un_complete import (
    sticky_completed_gate_re_evaluation_cannot_un_complete,
)
...
def _make_feature(
    *,
    ...
    return Feature(
        id="305ff67f-0000-0000-0000-000000000000",
...
def test_sticky_completed_gate_re_evaluation_cannot_un_complete(tmp_path):
    ...
    result = sticky_completed_gate_re_evaluation_cannot_un_complete(
