...
class TestRunLoopIntegrationImports(unittest.TestCase):
    """integration: bob3.orchestrator.run_loop — module-level symbol checks."""
    ...
    def test_sweep_orphan_subagents_in_run_loop(self):
        """AC: Function defined: bob3.orchestrator.run_loop.sweep_orphan_subagents"""
        from bob3.orchestrator.run_loop import sweep_orphan_subagents
    ...
    def test_run_locked_method_exists_on_orchestration_class(self):
        ...
        assert found, "_run_locked must be defined in bob3.orchestrator.run_loop"
    ...
    def test_sweep_orphan_subagents_module_level_callable(self):
        """sweep_orphan_subagents must be callable from bob3.orchestrator.run_loop."""
        from bob3.orchestrator.run_loop import sweep_orphan_subagents

        with patch("bob3.orchestrator.run_loop._sweep_orphan_subagents") as mock_inner:
