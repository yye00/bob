...
Acceptance criteria tested:
  - Function defined: bob.bf_4_hierarchical_localizer_file_class_symbol_edit_site
  ...
  - File exists: src/bob/brownfield/localizer.py
"""
...
from bob.bf_4_hierarchical_localizer_file_class_symbol_edit_site import (
...
def test_brownfield_localizer_module_importable():
    """File exists AC: src/bob/brownfield/localizer.py must be importable."""
    from bob.brownfield import localizer  # noqa: F401
...
def test_check_disjoint_overlapping():
    ...
    from bob.brownfield.localizer import check_disjoint
