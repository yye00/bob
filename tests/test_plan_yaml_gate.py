"""Tests for bob.plan_yaml_gate — the public facade for plan.yaml gate operations.

Covers load_plan_yaml and validate_plan_approved in both happy-path and error
cases.  Integration with bob.orchestrator is verified by the fact that the
module delegates to bob.orchestrator.plan_gate internally.
"""
...
from bob.plan_yaml_gate import (
