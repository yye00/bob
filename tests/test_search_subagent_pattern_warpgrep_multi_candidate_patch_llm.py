"""Tests for bob3.search_subagent_pattern_warpgrep_multi_candidate_patch_llm.
...
from bob3.search_subagent_pattern_warpgrep_multi_candidate_patch_llm import (
...
class TestSearchSubagentIntegration:
    ...
    def test_delegates_to_search_subagent(self):
        ...
        with patch(
            "bob3.search_subagent_pattern_warpgrep_multi_candidate_patch_llm"
