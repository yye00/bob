"""Tests for bob3.ownership_evidenced_regression.
...
from bob3.ownership_evidenced_regression import (
...
# ---------------------------------------------------------------------------
# Tests for integration: bob3.detect_regression exposes the new function
# ---------------------------------------------------------------------------

class TestIntegrationDetectRegression:
    def test_importable_from_detect_regression(self):
        from bob3.detect_regression import detect_regression_with_ownership as fn
        assert callable(fn)

    def test_file_touched_in_commit_importable_from_detect_regression(self):
        from bob3.detect_regression import file_touched_in_commit as fn
        assert callable(fn)
