"""Tests for bob.demoter_gates — F-0a9d5eb0.
...
class TestIsStructuralPrefixMatch:
    ...
    def test_file_exists_prefix_returns_true(self):
        assert is_structural_prefix_match("file exists: src/bob/demoter_gates.py") is True

    def test_function_defined_prefix_returns_true(self):
        assert is_structural_prefix_match("function defined: bob.demoter_gates.is_structural_prefix_match") is True
