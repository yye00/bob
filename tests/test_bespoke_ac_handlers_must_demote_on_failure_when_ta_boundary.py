"""Boundary cases for bob3.enhanced_verification.demote_on_failure (bc07b13a).
...
def test_probe_false_deeply_nested_module_exists_demotes(tmp_path):
    ...
    mod = _make_module(tmp_path, rel="src/bob3/sub/deep/nested/module.py")
