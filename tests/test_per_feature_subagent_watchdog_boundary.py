"""Boundary-case tests for bob.feature_watchdog (per-feature subagent watchdog).
...
from bob.orchestrator.feature_watchdog import compute_deadline, arm_feature_watchdog
from bob.feature_watchdog import FeatureWatchdog, spawn_feature_watchdog
