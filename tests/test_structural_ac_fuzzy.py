...
def _run_structural_check(
    ...
    import sys
    # Ensure bob source on path
    bob_src = pathlib.Path(__file__).parent.parent / "src"
    if str(bob_src) not in sys.path:
        sys.path.insert(0, str(bob_src))
...
class TestPassViaFuzzy:
    ...
    def test_pass_via_fuzzy(self, tmp_path: pathlib.Path) -> None:
        ...
        workspace = _make_workspace(
            ...
            src_files={
                ...
                "src/bob/expected_module.py": "def other_function():\n    pass\n",
                # Z.py DOES define the function (different module)
                "src/bob/actual_module.py": "def my_special_func(x, y):\n    return x + y\n",
            },
        )
        criterion = (
            "structural: src/bob/expected_module.py defines function my_special_func"
        )
    ...
    def test_pass_via_fuzzy_class(self, tmp_path: pathlib.Path) -> None:
        ...
        workspace = _make_workspace(
            tmp_path,
            src_files={
                "src/bob/wrong_module.py": "def unrelated():\n    pass\n",
                "src/bob/right_module.py": "class MySpecialClass:\n    pass\n",
            },
        )
        criterion = (
            "structural: src/bob/wrong_module.py defines class MySpecialClass"
        )
        result = _run_structural_check(workspace, criterion)
        assert result is True, (
...
class TestFailWhenTrulyAbsent:
    ...
    def test_fail_when_truly_absent(self, tmp_path: pathlib.Path) -> None:
        ...
        workspace = _make_workspace(
            tmp_path,
            src_files={
                "src/bob/some_module.py": "def different_function():\n    pass\n",
                "src/bob/another_module.py": "x = 1\n",
            },
        )
        criterion = (
            "structural: src/bob/some_module.py defines function totally_absent_func"
        )
        result = _run_structural_check(workspace, criterion)
    ...
    def test_exact_match_still_passes(self, tmp_path: pathlib.Path) -> None:
        ...
        workspace = _make_workspace(
            tmp_path,
            src_files={
                "src/bob/correct_module.py": "def correct_function(a, b):\n    return a + b\n",
            },
        )
        criterion = (
            "structural: src/bob/correct_module.py defines function correct_function"
        )
        result = _run_structural_check(workspace, criterion)
        assert result is True, (
...
class TestWarningEmittedOnFuzzyHit:
    ...
    def test_warning_emitted_on_fuzzy_hit(self, tmp_path: pathlib.Path) -> None:
        ...
        workspace = _make_workspace(
            tmp_path,
            src_files={
                "src/bob/named_module.py": "def something_else():\n    pass\n",
                "src/bob/other_module.py": "def fuzzy_hit_function():\n    pass\n",
            },
        )
        criterion = (
            "structural: src/bob/named_module.py defines function fuzzy_hit_function"
        )
    ...
    def test_no_warning_on_exact_match(self, tmp_path: pathlib.Path) -> None:
        ...
        workspace = _make_workspace(
            tmp_path,
            src_files={
                "src/bob/exact_module.py": "def exact_func():\n    pass\n",
            },
        )
        criterion = (
            "structural: src/bob/exact_module.py defines function exact_func"
        )
        findings_path = workspace / "reviews" / "findings.yaml"
        before_content = findings_path.read_text()
...
class TestFuzzyFallbackFunction:
    ...
    def test_function_exists_in_workspace(self, tmp_path: pathlib.Path) -> None:
        ...
        from bob.enhanced_verification import _structural_ac_fuzzy_fallback

        workspace = _make_workspace(
            tmp_path,
            src_files={
                "src/bob/module_a.py": "def target_function(x):\n    return x\n",
            },
        )
        findings_path = workspace / "reviews" / "findings.yaml"
        result = _structural_ac_fuzzy_fallback(
            workspace=workspace,
            expected_module_path="src/bob/other_module.py",
    ...
    def test_class_exists_in_workspace(self, tmp_path: pathlib.Path) -> None:
        ...
        workspace = _make_workspace(
            tmp_path,
            src_files={
                "src/bob/module_b.py": "class TargetClass:\n    pass\n",
            },
        )
        findings_path = workspace / "reviews" / "findings.yaml"
        result = _structural_ac_fuzzy_fallback(
            workspace=workspace,
            expected_module_path="src/bob/wrong_module.py",
    ...
    def test_absent_returns_false(self, tmp_path: pathlib.Path) -> None:
        ...
        workspace = _make_workspace(
            tmp_path,
            src_files={
                "src/bob/module_c.py": "def unrelated():\n    pass\n",
            },
        )
        findings_path = workspace / "reviews" / "findings.yaml"
        result = _structural_ac_fuzzy_fallback(
            workspace=workspace,
            expected_module_path="src/bob/module_c.py",
