"""Tests for bob.hot_reload — hot-reload prompt source on each dispatch.
...
def test_module_importable():
    """bob.hot_reload is importable without error."""
    import bob.hot_reload  # noqa: F401


def test_function_defined():
    """bob.hot_reload.reload_prompt_source_if_changed is callable."""
    from bob.hot_reload import reload_prompt_source_if_changed
...
def test_default_module_is_superpowers():
    """The default module_name is bob.superpowers."""
    import bob.orchestrator.prompt_source_reloader as _reloader
    from bob.hot_reload import reload_prompt_source_if_changed
...
def test_delegates_to_reload_if_stale():
    ...
    assert call_log == ["bob.superpowers"]
