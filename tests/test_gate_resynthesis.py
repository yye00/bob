"""Tests for bob.orchestrator.gate_resynthesis (feature 066763fc).
...
import bob.orchestrator.gate_resynthesis as gr
...
def test_module_importable():
    import importlib
    mod = importlib.import_module("bob.orchestrator.gate_resynthesis")
...
def test_all_exports():
    import bob.orchestrator.gate_resynthesis as mod
