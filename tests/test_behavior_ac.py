"""Tests for bob.behavior_ac.parse_behavior_ac and BehaviorACTuple.
...
from bob.behavior_ac import BehaviorACTuple, parse_behavior_ac
...
def test_evaluator_integration_via_bob_evaluator():
    """bob.evaluator imports parse_behavior_ac and it uses the same grammar."""
    from bob.evaluator import parse_behavior_ac as evaluator_parse_behavior_ac
