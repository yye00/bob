...
class TestModelsFileExists:
    """Step 1: Create src/bob/models.py file."""

    def test_models_file_exists(self):
        models_path = WORKSPACE / "src" / "bob" / "models.py"
        assert models_path.exists(), "src/bob/models.py must exist"

    def test_models_module_importable(self):
        import bob.models  # noqa: F401

    def test_models_uses_pydantic(self):
        import bob.models
        import inspect

        source = inspect.getsource(bob.models)
...
class TestFeatureReviewIssueModel:
    ...
    def test_model_exists(self):
        from bob.models import FeatureReviewIssue
...
class TestBugLedgerModel:
    ...
    def test_model_exists(self):
        from bob.models import BugLedger
...
class TestCalibrationDataModel:
    ...
    def test_model_exists(self):
        from bob.models import CalibrationData
...
class TestScopeChangeModel:
    ...
    def test_model_exists(self):
        from bob.models import ScopeChange
...
class TestForgettingEventModel:
    ...
    def test_model_exists(self):
        from bob.models import ForgettingEvent
...
class TestDependencyModels:
    ...
    def test_task_dependency_exists(self):
        from bob.models import TaskDependency
...
class TestBobSpecificModels:
    """Step 5r: Bob-specific models (ResearchResult, ReferenceDocument, FeatureReference)."""

    def test_research_result_exists(self):
        from bob.models import ResearchResult
    ...
    def test_reference_document_exists(self):
        from bob.models import ReferenceDocument
    ...
    def test_feature_reference_exists(self):
        from bob.models import FeatureReference
