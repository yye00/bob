"""Tests for bob3.demoter.is_structural_prefix_match and get_prose_connectors (F-9ed93698).

Verifies the public API exposed via bob3.demoter for structural prefix matching
...
from bob3.demoter import is_structural_prefix_match, get_prose_connectors
...
class TestIsStructuralPrefixMatchOtherPrefixes:
    ...
    def test_integration_at_start(self):
        assert is_structural_prefix_match("integration: bob3.version_probe") is True
