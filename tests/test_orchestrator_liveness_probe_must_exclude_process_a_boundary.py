...
Covers boundary cases for:
  ...
  - bob.orchestrator.probe_ancestry.is_shell_wrapper
  - bob.orchestrator.probe_ancestry.collect_ancestor_pids
  - bob.orchestrator_liveness_probe_must_exclude_process_ancestry (probe function)
"""
