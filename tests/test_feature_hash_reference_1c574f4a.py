...
from bob3.verification.policy_verb_registry import is_feature_hash_reference
...
class TestIsFeatureHashReference:
    ...
    def test_bob3_module_func_is_not_hash_reference(self):
        """Python dotted path must return False."""
        assert is_feature_hash_reference("bob3.module.func") is False
...
class TestIntegrationHandlerSkipsHashReferences:
    ...
    def test_real_dotted_target_still_calls_wiring_lookup(self, tmp_path):
        """A genuine dotted target like bob3.foo.bar MUST call _integration_wired."""
        criterion = "integration: bob3.foo.bar is wired"
