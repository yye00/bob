"""Tests for bob3.rca_infra_verdict — second-line defense against false NH.
...
class TestAssessInfraOnly:
    ...
    def test_returns_false_when_feature_defect(self) -> None:
        ...
        with patch(
            "bob3.rca_infra_verdict.classify_attempts",
