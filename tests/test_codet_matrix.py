"""Tests for bob.codet_matrix — the stable public API for CodeT KxK triangulation."""
...
# ---------------------------------------------------------------------------
# Integration: bob.orchestrator re-exports
# ---------------------------------------------------------------------------
...
class TestOrchestratorIntegration:
    ...
    def test_mutual_agreement_score_importable_from_codet_matrix(self):
        from bob.codet_matrix import mutual_agreement_score  # noqa: F401
        assert callable(mutual_agreement_score)

    def test_spawn_k_candidates_importable_from_codet_matrix(self):
        from bob.codet_matrix import spawn_k_candidates  # noqa: F401
...
class TestTripleFilterReexport:
    def test_triple_filter_reachable_via_codet_matrix(self):
        from bob.codet_matrix import triple_filter  # noqa: F401
