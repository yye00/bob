"""Tests for bob3.f_r7_597_ordering_fix_classify_mcp_transient_before_git_hook (F-R7-607).
...
from bob3.f_r7_597_ordering_fix_classify_mcp_transient_before_git_hook import (
...
def test_drain_pre_hook_transient_summary_delegates() -> None:
    ...
    with patch(
        "bob3.f_r7_597_ordering_fix_classify_mcp_transient_before_git_hook.drain_mcp_transient_summary",
...
# ---------------------------------------------------------------------------
# Integration: bob3.orchestrator.run_loop import sanity check
# ---------------------------------------------------------------------------

def test_orchestrator_run_loop_importable() -> None:
    """bob3.orchestrator.run_loop must be importable (integration AC)."""
    import bob3.orchestrator.run_loop  # noqa: F401  (import-only check)


def test_run_loop_classify_mcp_transient_importable() -> None:
    """bob3.run_loop.classify_mcp_transient must exist (backing function)."""
