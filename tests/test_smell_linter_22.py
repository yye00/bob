"""Tests for bob3.smell_linter_22 — Full 22-smell linter extension (F-R7-410).
...
from bob3.smell_linter_22 import (
    SmellFinding,
    blocks_plan_create,
    detect_all_smells,
    filter_by_severity,
...
class TestIntegrationWithPatterns:
    """Verify bob3.patterns can import from bob3.smell_linter_22."""

    def test_smell_linter_22_importable_from_bob3(self):
        import bob3.smell_linter_22 as module
        assert hasattr(module, "detect_all_smells")
        assert hasattr(module, "filter_by_severity")

    def test_detect_all_smells_callable(self):
        from bob3.smell_linter_22 import detect_all_smells
        assert callable(detect_all_smells)

    def test_filter_by_severity_callable(self):
        from bob3.smell_linter_22 import filter_by_severity
