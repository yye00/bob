"""Tests for bob.readiness — live readiness derivation.
...
class TestComputeReadinessScore:
    ...
    def test_mean_of_equal_components(self):
        from bob.readiness import compute_readiness_score
    ...
    def test_delegates_to_derive_readiness_score(self):
        ...
        from bob.readiness import compute_readiness_score, derive_readiness_score
...
class TestRestoreBaselineConfidence:
    ...
    def test_returns_false_for_missing_feature(self):
        from bob.readiness import restore_baseline_confidence
...
class TestSeedReadinessOnReadyFeatures:
    ...
    def test_importable(self):
        from bob.run_loop import seed_readiness_on_ready_features  # noqa: F401

    def test_returns_int(self):
        """With a dummy project ID that has no features, should return 0."""
        from bob.run_loop import seed_readiness_on_ready_features
