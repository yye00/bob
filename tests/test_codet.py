"""Tests for bob3.codet — CodeT KxK mutual-agreement triangulation entry point."""

from __future__ import annotations

import pytest

from bob3.codet import (
    CandidateImpl,
    CandidateTestSet,
    ScoredMatrix,
    score_kxk_matrix,
...
class TestOrchestratorIntegration:
    ...
    def test_orchestrator_score_kxk_matrix_callable(self, tmp_path):
        from bob3.orchestrator import score_kxk_matrix as orch_score
