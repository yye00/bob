"""Tests for bob.brownfield.elicit — BF-3 elicitation classifier + clarification-budget gate.
...
class TestDispatcherIntegration:
    def test_dispatcher_is_importable(self):
        from bob.brownfield import dispatcher  # noqa: F401

    def test_dispatch_elicitation_importable(self):
        from bob.brownfield.dispatcher import dispatch_elicitation  # noqa: F401

    def test_dispatch_elicitation_returns_dict(self):
        from bob.brownfield.dispatcher import dispatch_elicitation
    ...
    def test_dispatcher_exports_extract_intent(self):
        from bob.brownfield.dispatcher import extract_intent  # noqa: F401

    def test_dispatcher_exports_score_ambiguity(self):
        from bob.brownfield.dispatcher import score_ambiguity  # noqa: F401

    def test_dispatcher_exports_should_ask_user(self):
        from bob.brownfield.dispatcher import should_ask_user  # noqa: F401
