"""Tests for bob.brownfield.resurrection.get_graveyard_signal (BF-5 scope reduction).

ACs verified:
  - Function defined: bob.brownfield.resurrection.get_graveyard_signal
...
class TestGetGraveyardSignalReturnType(unittest.TestCase):
    ...
    @patch("bob.brownfield.resurrection.subprocess.run")
