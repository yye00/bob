...
from bob.spec_quality.ac_auto_repair import apply_repairs, repair_feature_acs
...
class TestOptOutRespected:
    ...
    def test_repair_feature_acs_respects_auto_repair_false(self, tmp_path: Path) -> None:
        ...
        with (
            ...
            patch("bob.spec_quality.ac_auto_repair.verify_semantic_equivalence", return_value=(True, "OK")),
        ):
