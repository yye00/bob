...
AC:
 - Function defined: bob.watchdog_must_escalate_...watchdog_must_escalate_...
...
_MOD = "bob.watchdog_must_escalate_repeated_spec_gate_stall_observed_needs_human_attention_sentinel_silent_60s_log_spam_masks_chain_dead_lock"
