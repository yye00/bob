"""Tests for bob3.plan_reviewer — Independent plan-review agent (Gap #6)."""
...
from bob3.plan_reviewer import (
    PlanReview,
    parse_plan_review,
    review_plan,
)
...
class TestReviewPlan:
    ...
    async def test_approve_plan_returns_plan_review(self):
        ...
        with patch("bob3.plan_reviewer._run_haiku_review", new_callable=AsyncMock) as mock_run:
