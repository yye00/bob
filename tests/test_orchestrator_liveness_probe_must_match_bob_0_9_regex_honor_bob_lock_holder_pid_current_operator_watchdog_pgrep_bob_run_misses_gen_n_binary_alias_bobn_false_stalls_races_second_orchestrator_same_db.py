...
Verifies that:
  ...
  - Signal 2: .bob.lock holder PID is probed with kill -0
...
import bob.orchestrator_liveness_probe_must_match_bob_0_9_regex_honor_bob_lock_holder_pid_current_operator_watchdog_pgrep_bob_run_misses_gen_n_binary_alias_bobn_false_stalls_races_second_orchestrator_same_db as _mod

_FN_NAME = (
    "orchestrator_liveness_probe_must_match_bob_0_9_regex_honor_bob_lock_holder_pid"
    "_current_operator_watchdog_pgrep_bob_run_misses_gen_n_binary_alias_bobn_false_stalls"
...
def test_orchestrator_liveness_probe_must_match_bob_0_9_regex_honor_bob_lock_holder_pid_current_operator_watchdog_pgrep_bob_run_misses_gen_n_binary_alias_bobn_false_stalls_races_second_orchestrator_same_db():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        lock_path = pathlib.Path(tmpdir) / ".bob.lock"
