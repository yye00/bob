...
from bob.spec_synthesizer import score_gate_threshold_from_env
...
class TestScoreGateThresholdFromEnv:
    ...
    def test_reads_from_env(self, monkeypatch):
        """Returns the float value from BOB_SPEC_QUALITY_THRESHOLD."""
    ...
    def test_clamps_to_minimum_0_0(self, monkeypatch):
        ...
        monkeypatch.setenv("BOB_SPEC_QUALITY_THRESHOLD", "-0.5")
        threshold = score_gate_threshold_from_env()
