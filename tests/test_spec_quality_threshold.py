...
Verifies that:
- _resolve_threshold reads BOB3_SPEC_QUALITY_THRESHOLD from env on every call
...
- BOB3_SPEC_QUALITY_THRESHOLD_FROZEN escape hatch works for test determinism
"""
...
class TestResolveThreshold:
    ...
    def test_clamps_above_1_0(self, monkeypatch):
        ...
        monkeypatch.setattr(tr, "_frozen_initialized", False)
        monkeypatch.setattr(tr, "_frozen_value", None)
        monkeypatch.setenv("BOB3_SPEC_QUALITY_THRESHOLD", "1.9")
