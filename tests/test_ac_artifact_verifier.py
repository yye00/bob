"""Tests for bob.ac_artifact_verifier.verify_ac_artifacts.
...
class TestFunctionDefinedAc:
    def test_missing_function_returns_miss(self):
        result = verify_ac_artifacts(
            ["Function defined: bob.ac_artifact_verifier.nonexistent_function_xyz"],
    ...
    def test_present_function_returns_no_miss(self):
        result = verify_ac_artifacts(
            ["Function defined: bob.ac_artifact_verifier.verify_ac_artifacts"],
            workspace="/home/yelkhamr/dark-factory/bob85",
        )
        assert result == []
