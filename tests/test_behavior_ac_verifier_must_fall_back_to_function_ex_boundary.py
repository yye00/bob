...
Asserts bob3.enhanced_verification._search_for_function is importable and behaves deterministically on empty/zero/
...
def test_boundary_importable_and_defined():
    ...
    assert hasattr(mod, '_search_for_function'), '_search_for_function' + " must be defined in " + 'bob3.enhanced_verification'
