"""Tests for F016: Bob Memory in-process client (formerly TITANS).
...
MODULE_PATH = SRC_DIR / "bob" / "memory_client.py"
...
class TestModuleExists:
    """Step 1: src/bob/memory_client.py must exist and be importable."""
    ...
    def test_module_is_importable(self):
        import bob.memory_client

        assert bob.memory_client is not None
    ...
    def test_valid_pools_constant_exists(self):
        from bob.memory import VALID_POOLS
    ...
    def test_classify_pool_function_exists(self):
        from bob.memory import _classify_pool
...
class TestValidatePool:
    ...
    def test_valid_pools_accepted(self):
        from bob.memory_client import _validate_pool
