...
Acceptance criteria:
- File exists: src/bob3/per_feature_subagent_cost_cap_default_10_single_subagent.py
- Function defined: bob3.per_feature_subagent_cost_cap_default_10_single_subagent
...
import bob3.per_feature_subagent_cost_cap_default_10_single_subagent as mod
from bob3.per_feature_subagent_cost_cap_default_10_single_subagent import (
    per_feature_subagent_cost_cap_default_10_single_subagent,
)
...
def test_per_feature_subagent_cost_cap_default_10_single_subagent():
    ...
    with patch("bob3.per_feature_subagent_cost_cap_default_10_single_subagent.enforce_per_attempt_cap") as mock_enforce:
...
class TestCapEnvOverride:
    """BOB3_PER_ATTEMPT_COST_CAP env var overrides the default cap."""

    def test_env_var_override_respected(self, monkeypatch):
        monkeypatch.setenv("BOB3_PER_ATTEMPT_COST_CAP", "20.0")
        with patch(
            "bob3.per_feature_subagent_cost_cap_default_10_single_subagent.enforce_per_attempt_cap"
        ) as mock_enforce:
            mock_enforce.return_value = False
            per_feature_subagent_cost_cap_default_10_single_subagent(
                feature_id="fid",
    ...
    def test_env_var_clamped_at_minimum(self, monkeypatch):
        monkeypatch.setenv("BOB3_PER_ATTEMPT_COST_CAP", "0.0")
        with patch(
            "bob3.per_feature_subagent_cost_cap_default_10_single_subagent.enforce_per_attempt_cap"
        ) as mock_enforce:
            mock_enforce.return_value = False
    ...
    def test_env_var_clamped_at_maximum(self, monkeypatch):
        monkeypatch.setenv("BOB3_PER_ATTEMPT_COST_CAP", "9999.0")
        with patch(
            "bob3.per_feature_subagent_cost_cap_default_10_single_subagent.enforce_per_attempt_cap"
        ) as mock_enforce:
            mock_enforce.return_value = False
...
class TestModuleExports:
    ...
    def test_source_file_exists(self):
        src = Path(__file__).parent.parent / "src" / "bob3" / "per_feature_subagent_cost_cap_default_10_single_subagent.py"
