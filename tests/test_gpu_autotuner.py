...
from bob3.gpu_autotuner import (
    KernelConfig,
    SweepResult,
    roofline_efficiency,
    sweep,
...
class TestParetoFrontier:
    ...
    def test_import(self):
        from bob3.gpu_autotuner import pareto_frontier
...
class TestEnhancedVerificationIntegration:
    ...
    def test_enhanced_verification_importable(self):
        ...
        assert bob3.enhanced_verification is not None
