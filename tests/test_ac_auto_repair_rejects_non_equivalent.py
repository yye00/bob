...
from bob.spec_quality.ac_auto_repair import verify_semantic_equivalence
...
class TestVerifySemanticEquivalenceRejectsNonEquivalent:
    ...
    def test_returns_false_when_judge_says_not_equivalent(self) -> None:
        ...
        with patch("bob.spec_quality.ac_auto_repair._call_llm_judge", return_value=judge_response):
    ...
    def test_suggest_rewrite_returns_string(self) -> None:
        from bob.spec_quality.ac_auto_repair import suggest_rewrite
