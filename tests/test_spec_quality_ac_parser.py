...
Verifies:
  ...
  - Function defined: bob.spec_quality.parse_behavior_ac
...
def test_spec_quality_py_file_exists():
    """src/bob/spec_quality.py must exist on disk."""
    from pathlib import Path
    path = Path(__file__).parent.parent / "src" / "bob" / "spec_quality.py"
    assert path.exists(), f"Expected file {path} to exist"


def test_spec_quality_module_importable():
    """bob.spec_quality must be importable."""
    import bob.spec_quality as sq
    assert sq is not None


def test_parse_behavior_ac_defined():
    """bob.spec_quality.parse_behavior_ac must be defined and callable."""
    from bob.spec_quality import parse_behavior_ac
...
def test_when_form_returns_behavior_ac():
    ...
    from bob.spec_quality import parse_behavior_ac, BehaviorAC
...
def test_accepts_synonym_conditional_defined():
    """bob.spec_quality.accepts_synonym_conditional must be callable."""
    from bob.spec_quality import accepts_synonym_conditional
