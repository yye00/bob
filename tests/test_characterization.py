...
Covers:
  ...
  - observe_target / verify_snapshot_diff aliases in bob3.acceptance.characterization
  - orchestrator integration: bob3.acceptance registry has 'characterization' kind
"""
...
# ---------------------------------------------------------------------------
# Aliases: observe_target, verify_snapshot_diff (from bob3.acceptance.characterization)
# ---------------------------------------------------------------------------
...
class TestOrchestratorIntegration:
    def test_registry_has_characterization_kind(self):
        from bob3.acceptance.registry import get_ac_kind
