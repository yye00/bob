"""Tests for bob3.linters.smella_22 — the 22-smell linter in the linters subpackage.
...
symbols are all accessible via bob3.linters.smella_22.
"""
...
from bob3.linters.smella_22 import (
    BLOCKING_SMELLS,
    SMELL_CATALOG,
    SMELL_BY_ID,
    SPACY_SMELLS,
