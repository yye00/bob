"""Tests for bob3.loader.handle_scanner_error and load_safe.
...
from bob3.loader import handle_scanner_error, load_safe
...
class TestHandleScannerError:
    ...
    def test_logs_spec_findings_corrupt_event(self, tmp_path, caplog):
        ...
        p = tmp_path / "spec_findings.yaml"
        p.write_text("data", encoding="utf-8")
        with caplog.at_level(logging.ERROR, logger="bob3.loader"):
            handle_scanner_error(p)
...
class TestLoadSafe:
    ...
    def test_scanner_error_replicates_original_boot_bug(self, tmp_path):
        """Simulate the exact boot corruption from bob3 version 13 r10."""
