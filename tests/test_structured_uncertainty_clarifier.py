"""Tests for bob3.structured_uncertainty_clarifier.
...
from bob3.structured_uncertainty_clarifier import (
...
class TestGenerateCandidateImplementations:
    def test_returns_list_of_candidate_stubs(self):
        acs = ["Function defined: bob3.structured_uncertainty_clarifier.generate_candidate_implementations"]
    ...
    def test_non_function_ac_returns_empty(self):
        result = generate_candidate_implementations(["File exists: src/bob3/foo.py"])
        assert result == []
...
class TestFullPipeline:
    def test_pipeline_ci_mode_blocked(self):
        acs = [
            "Function defined: bob3.structured_uncertainty_clarifier.generate_candidate_implementations",
            "Function defined: bob3.structured_uncertainty_clarifier.detect_disagreement_slots",
            "Function defined: bob3.structured_uncertainty_clarifier.trigger_user_clarification",
        ]
