"""Tests for bob3.verification.enhanced_verification.criterion_checker.
...
from bob3.verification.enhanced_verification import criterion_checker
...
class TestCriterionCheckerClassDefined:
    def test_class_defined_recognized(self):
        ...
        result = criterion_checker("Class defined: bob3.verification.mutation_gate.MutationReport", workspace)
