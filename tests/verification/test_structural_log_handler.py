"""Tests for bob.verification.structural_log_handler.match_log_line_ac.

Verifies that:
- match_log_line_ac is importable from bob.verification.structural_log_handler
...
from bob.verification.structural_log_handler import match_log_line_ac
...
class TestMatchLogLineAcAdjacentLiteralConcat:
    ...
    def test_adjacent_literal_concat_with_subdirectory(self, tmp_path):
        ...
        subdir = tmp_path / "src" / "bob" / "orchestrator"
...
class TestMatchLogLineAcIntegrationWithEnhancedVerification:
    """Confirm match_log_line_ac is also accessible via bob.verification.enhanced_verification."""

    def test_importable_from_verification_enhanced_verification(self):
        from bob.verification.enhanced_verification import match_log_line_ac as mla
        assert callable(mla)

    def test_same_function_object(self):
        from bob.verification.enhanced_verification import match_log_line_ac as mla
        from bob.verification.structural_log_handler import match_log_line_ac as slh
