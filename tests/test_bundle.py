"""Tests for the reproducibility bundle exporter (bob bundle --run-id)."""
...
def _make_temp_db(tmp_path: pathlib.Path) -> pathlib.Path:
    """Create a minimal bob.db with schema needed for bundle tests."""
...
# ---------------------------------------------------------------------------
# Unit tests for bob.bundle module
# ---------------------------------------------------------------------------
...
class TestCreateBundle:
    def test_creates_tarball(self, tmp_path, monkeypatch):
        ...
        from bob.bundle import create_bundle
