"""Tests for bob3.confidence_elicitor — Uniform predicted-confidence elicitor."""
...
from bob3.confidence_elicitor import (
    ConfidenceResult,
    elicit_confidence,
...
class TestElicitConfidence:
    ...
    async def test_returns_confidence_result(self):
        ...
        with patch("bob3.confidence_elicitor._run_haiku_probe", new_callable=AsyncMock) as mock_llm, \
             patch("bob3.confidence_elicitor._store_calibration") as mock_store, \
             patch("bob3.confidence_elicitor._emit_cost_checkpoint") as mock_emit:
    ...
    async def test_uniform_probe_text(self):
        ...
        with patch("bob3.confidence_elicitor._run_haiku_probe", side_effect=capture_prompt), \
             patch("bob3.confidence_elicitor._store_calibration"), \
             patch("bob3.confidence_elicitor._emit_cost_checkpoint"):
