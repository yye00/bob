"""Tests for bob.codet_triangulator module.
...
- Integration: functions are importable from bob.codet_triangulator
"""
...
from bob.codet_triangulator import (
    CandidateImpl,
    CandidateTestSet,
    MatrixCell,
    ScoredMatrix,
...
class TestIntegration:
    ...
    def test_orchestrator_codet_triangulation_reachable(self):
        """Integration AC: bob.orchestrator.codet_triangulation is reachable."""
        from bob.orchestrator import codet_triangulation
