"""Tests for bob3.verifier.shell_script_ac_handler.handle_shell_script_ac (F-R7-594).
...
from bob3.verifier.shell_script_ac_handler import handle_shell_script_ac
...
def test_non_shell_integration_ac_returns_none(tmp_path: pathlib.Path) -> None:
    ...
    result = handle_shell_script_ac("integration: bob3.verifier", tmp_path)
