...
Verifies:
  ...
  - Integration: bob3.orchestrator.run_loop is importable
...
def test_integration_orchestrator_run_loop_importable():
    """Verify bob3.orchestrator.run_loop is accessible (integration AC)."""
    ...
    assert hasattr(run_loop_mod, "OrchestrationLoop"), (
        "bob3.orchestrator.run_loop must expose OrchestrationLoop"
    )
