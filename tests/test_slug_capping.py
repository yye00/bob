"""Tests for bob.slug_capping.derive_canonical_slug.
...
from bob.slug_capping import derive_canonical_slug
...
# ── integration: bob.spec_synthesizer uses the same pipeline ─────────────────

def test_consistent_with_spec_synthesizer() -> None:
    """derive_canonical_slug agrees with spec_synthesizer._derive_canonical_slug."""
    from bob.spec_synthesizer import _derive_canonical_slug as ss_derive
