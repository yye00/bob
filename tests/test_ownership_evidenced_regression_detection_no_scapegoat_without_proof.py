"""Tests for ownership_evidenced_regression_detection_no_scapegoat_without_proof.
...
from bob3.ownership_evidenced_regression_detection_no_scapegoat_without_proof import (
    UNATTRIBUTED_KEY,
...
def test_ownership_evidenced_regression_detection_no_scapegoat_without_proof():
    ...
    result = ownership_evidenced_regression_detection_no_scapegoat_without_proof(
