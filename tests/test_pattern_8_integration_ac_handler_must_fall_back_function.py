...
``bob.pattern_8_integration_ac_handler_must_fall_back_function``
...
from bob.pattern_8_integration_ac_handler_must_fall_back_function import (
...
def _make_src_file(workspace: pathlib.Path, rel: str, content: str) -> pathlib.Path:
    """Write a Python source file into workspace/src/bob/."""
...
def test_bad_dotted_path_falls_back_to_function_existence(tmp_path: pathlib.Path) -> None:
    ...
    # The dotted path 'bob.nonexistent' won't resolve, but 'periodic_sweep' will.
