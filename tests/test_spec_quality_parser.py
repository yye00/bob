"""Tests for bob.spec_quality.parse_behavior_ac.
...
Covers:
  ...
  - Import path: bob.spec_quality.parse_behavior_ac (integration AC)
"""

import pytest

from bob.spec_quality import parse_behavior_ac, accepts_synonym_conditional, BehaviorAC
from bob.spec_quality.behavior_ac_parser import parse_behavior_ac as _parse_direct
