...
from bob3.schema_constrained_spec_emission_eliminate_parse_failure_retries import (
    SpecSchemaError,
...
def test_use_outlines_dispatches_to_emit_via_outlines() -> None:
    ...
    with patch(
        "bob3.schema_constrained_spec_emission_eliminate_parse_failure_retries.emit_via_outlines",
