"""Tests for bob.spawn_retry — infra-error transient classifier + spawn-layer recovery.
...
from bob.spawn_retry import classify_exit, load_patterns, spawn_with_retry
