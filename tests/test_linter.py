"""Tests for bob3.linter — public 22-smell linter entry point.

Verifies that detect_smells at bob3.linter correctly wraps the 22-detector
...
class TestDetectSmells:
    ...
    def test_file_exists_ac_clean(self):
        findings = detect_smells("File exists: src/bob3/linter.py")
