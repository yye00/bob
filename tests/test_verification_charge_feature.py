"""Tests for bob.verification.charge_feature_from_test.

Feature 3310e08a-0932-4664-a7b2-b93bb01d88e5

Verifies that charge_feature_from_test is importable from bob.verification
...
class TestChargeFeatureFromTestImport:
    def test_importable_from_bob_verification(self):
        from bob.verification import charge_feature_from_test as cft  # noqa: F401
        assert cft is not None

    def test_importable_from_blame_feature_charger(self):
        from bob.verification.blame_feature_charger import charge_feature_from_test as cft
        assert callable(cft)
