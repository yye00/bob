"""Tests for bob.verifier_extension_validator.validate_ac_for_extension.
...
from bob.verifier_extension_validator import (
...
def test_enhanced_verification_in_verifier_extension_modules():
    """src/bob/enhanced_verification.py is in VERIFIER_EXTENSION_MODULES."""
    assert any(
