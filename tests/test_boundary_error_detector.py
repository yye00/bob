"""Tests for bob.boundary_error_detector.detect_coverage_with_boundaries.
...
class TestDetectCoverageWithBoundaries:
    ...
    def test_slug_containing_fail_does_not_trigger_error_coverage(self):
        ...
        criteria = [
            ...
            "File exists: src/bob/failing_handler.py",
        ]
    ...
    def test_slug_containing_limit_does_not_trigger_boundary_coverage(self):
        ...
        criteria = [
            ...
            "File exists: src/bob/limit_checker.py",
            "Function defined: bob.limit_checker.check_limit",
        ]
        has_boundary, has_error = detect_coverage_with_boundaries(criteria)
    ...
    def test_failing_slug_false_positive_regression(self):
        ...
        criteria = [
            "File exists: src/bob/failing_tests_processor.py",
            "Function defined: bob.failing_tests_processor.process_failing_tests",
            "pytest: tests/test_failing_tests_processor.py",
            "integration: bob.failing_tests_processor",
        ]
        has_boundary, has_error = detect_coverage_with_boundaries(criteria)
    ...
    def test_length_capped_slug_false_positive_regression(self):
        ...
        criteria = [
            "File exists: src/bob/length_capped_validator.py",
            "Function defined: bob.length_capped_validator.validate_length_capped",
