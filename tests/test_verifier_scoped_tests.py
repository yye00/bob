"""Tests for bob3.verifier_scoped_tests.scope_pytest_to_feature.
...
from bob3.verifier_scoped_tests import SiblingTestCollectionError, scope_pytest_to_feature
...
class TestOrchestratorIntegration:
    def test_orchestrator_exposes_scope_pytest_to_feature(self):
        from bob3.orchestrator import scope_pytest_to_feature as orch_fn
        assert callable(orch_fn)

    def test_orchestrator_exposes_sibling_error(self):
        from bob3.orchestrator import SiblingTestCollectionError as ErrCls
