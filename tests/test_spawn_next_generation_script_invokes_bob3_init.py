"""Tests: spawn_next_generation.sh includes a 'bob3 init' invocation.

Asserts that tools/spawn_next_generation.sh contents include a 'bob3 init'
...
def test_spawn_script_contains_bob3_init():
    """Script must contain a 'bob3 init' string or equivalent alias invocation."""
    text = _script_text()
    # Either literal 'bob3 init' or the gen-specific alias pattern
