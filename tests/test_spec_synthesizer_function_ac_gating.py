...
3. Integration: bob.spec_synthesizer exports both functions correctly.
...
class TestIntegrationSpecSynthesizerFunctionAcGating:
    """Integration: bob.spec_synthesizer module exports gating functions correctly."""
    ...
    def test_extract_verbatim_symbols_importable(self):
        from bob.spec_synthesizer import extract_verbatim_symbols
    ...
    def test_module_is_bob_spec_synthesizer(self):
        import bob.spec_synthesizer as mod
        assert mod.__name__ == "bob.spec_synthesizer"
