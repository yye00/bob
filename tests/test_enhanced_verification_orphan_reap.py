"""Tests for _run_shell_with_pgroup_timeout in bob3.enhanced_verification.
...
from bob3.enhanced_verification import _run_shell_with_pgroup_timeout
...
class TestIntegrationWithVerifierChecks:
    ...
    def test_check_behavioral_signature_uses_shell_helper(self, tmp_path):
        from bob3.enhanced_verification import check_behavioral_signature
    ...
    def test_check_deterministic_output_uses_shell_helper(self, tmp_path):
        from bob3.enhanced_verification import check_deterministic_output
    ...
    def test_check_resource_limit_uses_shell_helper(self, tmp_path):
        from bob3.enhanced_verification import check_resource_limit
