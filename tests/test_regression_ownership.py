"""Tests for bob.regression.check_regression_ownership and find_touching_commits.
...
from bob.regression import check_regression_ownership, find_touching_commits
...
def test_orchestrator_exports_check_regression_ownership():
    """bob.orchestrator must re-export check_regression_ownership."""
    from bob.orchestrator import check_regression_ownership as fn  # noqa: F401
    assert callable(fn)


def test_orchestrator_exports_find_touching_commits():
    """bob.orchestrator must re-export find_touching_commits."""
    from bob.orchestrator import find_touching_commits as fn  # noqa: F401
    assert callable(fn)
