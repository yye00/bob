...
Acceptance criteria:
- File exists: src/bob3/deterministic_pytest_snapshots_disable_xdist_early_halt.py
- Function defined: bob3.deterministic_pytest_snapshots_disable_xdist_early_halt
...
import bob3.deterministic_pytest_snapshots_disable_xdist_early_halt as mod
from bob3.deterministic_pytest_snapshots_disable_xdist_early_halt import (
    MAXFAIL_FLAG,
    deterministic_pytest_snapshots_disable_xdist_early_halt,
)
