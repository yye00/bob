"""Tests for devin_style_editable_plan_yaml_gate_before_any_implementer.

Acceptance criteria:
  - File exists: src/bob3/devin_style_editable_plan_yaml_gate_before_any_implementer.py
  - pytest: tests/test_devin_style_editable_plan_yaml_gate_before_any_implementer.py::test_devin_style_editable_plan_yaml_gate_before_any_implementer
  - Function defined: bob3.devin_style_editable_plan_yaml_gate_before_any_implementer.devin_style_editable_plan_yaml_gate_before_any_implementer
"""
...
from bob3.devin_style_editable_plan_yaml_gate_before_any_implementer import (
    devin_style_editable_plan_yaml_gate_before_any_implementer,
)


def test_devin_style_editable_plan_yaml_gate_before_any_implementer(tmp_path):
    ...
    result_approved = devin_style_editable_plan_yaml_gate_before_any_implementer(
        feature_id=feature_id,
        name=name,
        description=description,
        acceptance_criteria=acceptance_criteria,
    ...
    result_drift = devin_style_editable_plan_yaml_gate_before_any_implementer(
        feature_id=feature_id,
        name=name,
        description=description,
    ...
    result_stable = devin_style_editable_plan_yaml_gate_before_any_implementer(
        feature_id=feature_id,
        name=name,
        description=description,
        acceptance_criteria=changed_ac,
