"""Tests for _derive_canonical_slug length-capping in bob.spec_synthesizer.
...
Covers:
  ...
  - Integration: _derive_canonical_slug is accessible from bob.spec_synthesizer
"""
...
class TestIntegration:
    ...
    def test_function_importable_from_spec_synthesizer(self) -> None:
        from bob.spec_synthesizer import _derive_canonical_slug as fn
        assert callable(fn)
    ...
    def test_slug_used_consistently_for_file_and_function(self) -> None:
        ...
        from bob.spec_synthesizer import _derive_canonical_slug, _infer_primary_symbol
        ...
        if slug is not None and inferred is not None:
            ...
            # The module path is "bob.<slug>"; the symbol == slug
            assert module_path == f"bob.{slug}", (
