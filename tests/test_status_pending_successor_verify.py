"""Tests for bob.status_pending_successor_verify (c770e876).
...
class TestShouldDeferToSuccessorGen:
    ...
    def test_verifier_extension_feature_with_structural_ac_sets_status(self, tmp_path):
        ...
        with patch("bob.status_pending_successor_verify.set_pending_successor_verify", return_value=True) as mock_set:
    ...
    def test_returns_false_when_set_pending_returns_false(self, tmp_path):
        ...
        with patch("bob.status_pending_successor_verify.set_pending_successor_verify", return_value=False):
...
class TestPromoteOnSuccessorVerify:
    ...
    def test_delegates_to_promote_from_successor_gen(self):
        from bob.status_pending_successor_verify import promote_on_successor_verify
        with patch(
            "bob.status_pending_successor_verify.promote_from_successor_gen",
    ...
    def test_db_failure_returns_pending_status(self):
        from bob.status_pending_successor_verify import (
...
class TestRunLoopIntegration:
    ...
    def test_should_defer_uses_is_verifier_extension_feature(self, tmp_path):
        ...
        with patch("bob.status_pending_successor_verify.set_pending_successor_verify", return_value=True):
            with patch("bob.status_pending_successor_verify.is_verifier_extension_feature", return_value=True) as mock_is:
