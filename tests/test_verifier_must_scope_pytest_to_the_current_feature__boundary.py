"""Boundary tests for bob.verifier.scope_pytest_to_feature.
...
from bob.verifier import scope_pytest_to_feature, collect_feature_test_paths
...
def test_nonexistent_workspace_still_returns_ac_paths():
    ...
    workspace = "/tmp/nonexistent_bob_workspace_for_boundary_test_xyzzy"
