"""Tests for BF-8 Part A — bob3.hooks.context_budget.enforce_context_budget."""
...
from bob3.hooks.context_budget import (
...
def test_enforce_context_budget_emits_telemetry_event(tmp_path, monkeypatch):
    ...
    workspace.mkdir()
    monkeypatch.setenv("BOB3_WORKSPACE", str(workspace))
    ...
    events_path = workspace / ".bob3" / "events.jsonl"
