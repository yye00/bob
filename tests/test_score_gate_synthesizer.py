"""Tests for bob3.score_gate_synthesizer (feature d987030c).
...
def test_module_importable():
    mod = importlib.import_module("bob3.score_gate_synthesizer")
...
def test_score_gate_loop_is_coroutine():
    from bob3.score_gate_synthesizer import score_gate_loop
...
def test_synthesize_for_feature_is_coroutine():
    from bob3.score_gate_synthesizer import synthesize_for_feature
...
def test_score_gate_loop_same_as_spec_synthesizer():
    ...
    from bob3.score_gate_synthesizer import score_gate_loop as sgs_fn
    from bob3.spec_synthesizer import score_gate_loop as ss_fn
...
def test_synthesize_for_feature_same_as_spec_synthesizer():
    ...
    from bob3.score_gate_synthesizer import synthesize_for_feature as sgs_fn
    from bob3.spec_synthesizer import synthesize_for_feature as ss_fn
    assert sgs_fn is ss_fn
