"""Tests for rename_all_blocked_termination_label_queue_drained_log_line_clearer_user_facing_cli_message.
...
from bob3.rename_all_blocked_termination_label_queue_drained_log_line_clearer_user_facing_cli_message import (
    rename_all_blocked_termination_label_queue_drained_log_line_clearer_user_facing_cli_message,
)


def test_rename_all_blocked_termination_label_queue_drained_log_line_clearer_user_facing_cli_message():
    """ALL_BLOCKED maps to QUEUE_DRAINED; other names pass through unchanged."""
    rename = rename_all_blocked_termination_label_queue_drained_log_line_clearer_user_facing_cli_message
...
def test_run_loop_uses_queue_drained_label(tmp_path, monkeypatch):
