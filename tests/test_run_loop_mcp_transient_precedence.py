"""Tests for bob3.run_loop.classify_mcp_transient (F-R7-607).
...
AC: Function defined: bob3.run_loop.classify_mcp_transient
...
# ---------------------------------------------------------------------------
# Integration: function is importable from bob3.run_loop (AC: integration)
# ---------------------------------------------------------------------------
