...
AC: Function defined: bob.enhanced_verification.verify_class_defined
...
def test_returns_true_when_class_exists(workspace_with_class):
    result = verify_class_defined("Class defined: bob.mymod.MyReport", workspace_with_class)
    assert result is True


def test_returns_false_when_class_missing(empty_workspace):
    result = verify_class_defined("Class defined: bob.mymod.Missing", empty_workspace)
...
def test_uses_last_component_of_dotted_path(workspace_with_class):
    # 'bob.deep.nested.path.MyReport' → class name is 'MyReport'
    result = verify_class_defined("Class defined: bob.deep.nested.path.MyReport", workspace_with_class)
    assert result is True
...
def test_non_class_defined_prefix_returns_false(workspace_with_class):
    ...
    result = verify_class_defined("Function defined: bob.mymod.MyReport", workspace_with_class)
    assert result is False
...
def test_does_not_match_substring_of_class_name(workspace_with_class):
    ...
    result = verify_class_defined("Class defined: bob.mymod.Report", workspace_with_class)
    assert result is False
