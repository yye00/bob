...
def test_check_bootstrap_override_integration_with_feature_watchdog():
    """Integration: check_bootstrap_override can be used alongside bob3.feature_watchdog."""
    from bob3.feature_watchdog import FeatureWatchdog  # noqa: F401 — import verifies integration
    feature = _feature(bootstrap_attempts=0, research_iterations=0)
    result = check_bootstrap_override(feature)
