"""Tests for bob3.orchestrator.resume_scan (feature e072706e).
...
def test_resume_scan_importable_from_orchestrator():
    """bob3.orchestrator.resume_scan must be importable."""
    from bob3.orchestrator import resume_scan  # noqa: F401
    assert callable(resume_scan)


def test_resume_scan_importable_from_periodic_resume():
    """bob3.orchestrator.periodic_resume.resume_scan must be importable."""
    from bob3.orchestrator.periodic_resume import resume_scan  # noqa: F401
    assert callable(resume_scan)
...
def test_promotes_interrupted_features():
    ...
    from bob3.orchestrator import resume_scan
...
def test_resume_scan_is_callable_from_orchestrator_namespace():
    """bob3.orchestrator.resume_scan must be callable."""
