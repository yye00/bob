"""Tests for bob3.criterion_demoter public API (feature 81735692).
...
from bob3.criterion_demoter import (
...
class TestIsStructuralPrefixMatch:
    ...
    def test_function_defined_at_start_is_structural(self):
        assert is_structural_prefix_match("function defined: bob3.criterion_demoter.is_structural_prefix_match") is True
