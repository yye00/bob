...
- integration shim in bob.orchestrator
"""
...
class TestValidateCausalLink:
    ...
    def _call(self, feature_id, owned_files, breaking_files, transitive_deps=None):
        from bob.regression_detector import validate_causal_link
...
class TestDetectRegressionWithEvidence:
    ...
    def _call(self, **kwargs):
        from bob.regression_detector import detect_regression_with_evidence
...
# ---------------------------------------------------------------------------
# Integration: bob.orchestrator shim
# ---------------------------------------------------------------------------

class TestOrchestratorIntegration:
    """bob.orchestrator must expose detect_regression_with_evidence."""

    def test_importable_from_orchestrator(self):
        from bob.orchestrator import regression_detector  # type: ignore[attr-defined]
    ...
    def test_orchestrator_shim_delegates_correctly(self):
        from bob.orchestrator.regression_detector import detect_regression_with_evidence
