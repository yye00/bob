"""Tests for bob3.verifier.pattern_9_shell_integration.demote_shell_script_ac (F-R7-594)."""
...
def test_python_module_integration_returns_none(tmp_path: pathlib.Path) -> None:
    """'integration: bob3.verifier.ac_validator' → None (not a shell script)."""
    result = demote_shell_script_ac("integration: bob3.verifier.ac_validator", tmp_path)
