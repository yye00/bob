"""Tests for bob3.verifier.baseline_gate.abort_on_collection_failure.

Acceptance criteria:
  - File exists: src/bob3/verifier/baseline_gate.py
  - Function defined: bob3.verifier.baseline_gate.abort_on_collection_failure
  - pytest: tests/verifier/test_baseline_gate.py
  - integration: bob3.verifier.orchestrator
"""
...
from bob3.verifier.baseline_gate import (
...
# ---------------------------------------------------------------------------
# Integration: bob3.verifier re-exports abort_on_collection_failure
# ---------------------------------------------------------------------------


def test_verifier_package_exports_abort_on_collection_failure():
    import bob3.verifier as v
...
# ---------------------------------------------------------------------------
# Integration: bob3.verifier.orchestrator exposes abort_on_collection_failure
# ---------------------------------------------------------------------------


def test_orchestrator_exposes_abort_on_collection_failure():
    import bob3.orchestrator as o
