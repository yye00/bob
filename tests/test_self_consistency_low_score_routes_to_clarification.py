...
from bob3.spec_quality.self_consistency import run_n_samples, SelfConsistencyResult
...
class TestLowScoreRoutesToClarification:
    ...
    def test_low_stability_routes_to_clarification(self, tmp_path):
        ...
        from bob3.spec_quality.self_consistency import jaccard_stability, SelfConsistencyResult
        variants = [
    ...
    def test_disagreeing_slots_populated_when_low(self, tmp_path):
        ...
        from bob3.spec_quality.self_consistency import jaccard_stability
        score = jaccard_stability(variants)
        from bob3.spec_quality.self_consistency import _route_result
