...
- Integration with bob3.codegen (emit_key_example_test)
- Integration with bob3.verifier (run_key_example_test)
"""
...
# ---------------------------------------------------------------------------
# Integration: bob3.codegen emit_key_example_test
# ---------------------------------------------------------------------------


class TestCodegenIntegration:
    def test_emit_key_example_test_importable(self):
        from bob3.codegen import emit_key_example_test
