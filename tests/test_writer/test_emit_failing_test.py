"""Tests for bob.test_writer.emit_failing_test.
...
from bob.test_writer import emit_failing_test, EmittedTest
...
class TestEmitFailingTest:
    ...
    def test_emitted_test_is_red_contains_pytest_fail(self, tmp_path):
        ...
        et = emit_failing_test("feat-red", 0, "Function defined: bob.mod.fn", workspace=tmp_path)
    ...
    def test_emitted_test_fields_match_inputs(self, tmp_path):
        ...
        ac_text = "Function defined: bob.mymod.myfn"
