"""Tests for bob.orchestrator.test_writer_agent.emit_failing_tests (plural).
...
from bob.orchestrator.test_writer_agent import EmittedTest, emit_failing_tests
...
class TestEmitFailingTests:
    def test_returns_list_of_emitted_tests(self, tmp_path):
        ...
        results = emit_failing_tests(
            "feat-bulk-return",
            ["File exists: src/a.py", "Function defined: bob.mod.fn"],
            workspace=tmp_path,
        )
    ...
    def test_each_test_file_contains_pytest_fail(self, tmp_path):
        ...
        acs = ["File exists: src/a.py", "Function defined: bob.x.y"]
    ...
    def test_ac_text_preserved_in_emitted_test(self, tmp_path):
        ...
        acs = ["File exists: src/alpha.py", "Function defined: bob.beta.gamma"]
