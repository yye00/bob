...
persists the start time into .bob3.lock.
"""
...
from bob3.orchestrator.stale_bytecode_guard import check_freshness, record_start_time
...
class TestCheckFreshness:
    ...
    def test_scans_multiple_bob_dirs(self, tmp_path):
        """src/bob3/orchestrator and src/bob4/orchestrator both scanned."""
        for gen in ("bob3", "bob4"):
