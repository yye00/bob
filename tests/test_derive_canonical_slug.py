"""Tests for bob._derive_canonical_slug length-capping behavior.
...
from bob.test_slug_capping import verify_slug_capping, slug_is_capped
...
class TestIntegrationWithSpecSynthesizer:
    ...
    def test_build_fallback_criteria_raises_for_empty_title(self) -> None:
        ...
        from bob.spec_synthesizer import _build_fallback_criteria
    ...
    def test_build_fallback_criteria_produces_capped_slug(self) -> None:
        ...
        file_slug = file_criteria[0].split("src/bob/")[1].removesuffix(".py")
        func_slug = func_criteria[0].split("bob.")[1].split(".")[0]
    ...
    def test_slugify_delegates_to_derive_canonical_slug(self) -> None:
        ...
        from bob.spec_synthesizer import _slugify
