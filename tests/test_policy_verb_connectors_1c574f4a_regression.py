...
Background: feature 1c574f4a NH'd in bob3 version 16 round 13 because its AC:
...
from bob3.verification.policy_verb_registry import policy_verb_connectors
...
def test_1c574f4a_wired_target_returns_true_not_demoted(tmp_path):
    ...
    criterion_with_dotted = (
        "integration: bob3.real.module MUST trigger fresh-attempt grant "
        "rather than NH-demote"
    )
