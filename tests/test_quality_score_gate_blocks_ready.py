...
class TestSpecQualityGateBlocksReady:
    def test_well_specified_feature_passes_gate(self):
        allowed, msg = _simulate_planning_gate(
            ...
            description="Expose compute_score and gate_for_ready in bob3.spec_quality.quality_score.",
            criteria=[
    ...
    def test_integration_criterion_that_is_reachable_passes(self):
        ...
        report = compute_score(
            ...
            description="Wire quality scoring into bob3.orchestrator.run_loop.",
            acceptance_criteria=[
        ...
        # bob3.orchestrator.run_loop should be reachable
    ...
    def test_gate_returns_two_tuple(self):
        ...
        from bob3.spec_quality.quality_score import QualityReport, ScoreComponents
