"""Tests for bob.zombie_subruns_reaper.reap_zombie_subruns.

AC: File exists: src/bob/zombie_subruns_reaper.py
AC: Function defined: bob.zombie_subruns_reaper.reap_zombie_subruns
...
from bob.zombie_subruns_reaper import reap_zombie_subruns
...
class TestImport:
    ...
    def test_module_importable(self):
        import bob.zombie_subruns_reaper  # noqa: F401
...
class TestOrchestratorIntegration:
    """The module integrates with bob.orchestrator via zombie_run_reaper."""
    ...
    def test_reap_zombie_subruns_delegates_to_scan_and_reap(self):
        with patch("bob.zombie_subruns_reaper.scan_and_reap") as mock_sar:
