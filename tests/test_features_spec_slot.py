"""Tests for bob3.features.add_spec_slot_column.

AC: File exists: src/bob3/features.py
AC: Function defined: bob3.features.add_spec_slot_column
...
class TestFeaturesModuleStructure:
    def test_features_module_importable(self):
        """bob3.features must be importable."""
        import bob3.features  # noqa: F401

    def test_add_spec_slot_column_callable(self):
        """bob3.features.add_spec_slot_column must be a callable."""
        from bob3.features import add_spec_slot_column
