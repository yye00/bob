"""Tests for bob.spec_writer.atomic_write.

Feature 6cafea74-a3f0-4600-836c-335bb156a72d

Verifies that bob.spec_writer.atomic_write uses an atomic tmp+rename sequence
...
from bob.spec_writer import atomic_write
