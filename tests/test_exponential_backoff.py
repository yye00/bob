"""Tests for bob.exponential_backoff — exponential backoff after reaper-reset.
...
from bob.exponential_backoff import (
    BackoffDecision,
...
class TestShouldRefuseRedispatch:
    """Tests for bob.exponential_backoff.should_refuse_redispatch."""
...
class TestStampReapMetadata:
    """Tests for bob.exponential_backoff.stamp_reap_metadata."""
...
class TestDispatchIntegration:
    """Verify bob.dispatch imports should_refuse_redispatch."""
    ...
    def test_dispatch_imports_should_refuse_redispatch(self):
        ...
        assert hasattr(dispatch_module, "should_refuse_redispatch"), (
            "bob.dispatch must expose should_refuse_redispatch for integration"
        )

    def test_exponential_backoff_module_importable(self):
        import bob.exponential_backoff as mod
...
class TestCalculateBackoffDuration:
    """Tests for bob.exponential_backoff.calculate_backoff_duration."""
