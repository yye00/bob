"""Tests for src/bob3/pattern_9_shell_script_handler.py — Pattern 9 (F-R7-594).
...
from bob3.pattern_9_shell_script_handler import demote_shell_script_ac
...
class TestDemoteShellScriptAc:
    ...
    def test_integration_dotted_python_path_returns_none(self, tmp_path: pathlib.Path) -> None:
        result = demote_shell_script_ac("integration: bob3.patterns", tmp_path)
        assert result is None
