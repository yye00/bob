...
from bob3.ac_discipline_rule_verifier_extension_features_must_express import (
...
def test_warning_logged_for_each_demoted_ac():
    ...
    acs = [
        ...
        "structural: src/bob3/enhanced_verification.py has function check",
    ]
