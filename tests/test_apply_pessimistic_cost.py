...
- The per-feature ceiling (BOB_PER_FEATURE_COST_CEILING, default $20) is used, not the whole
...
class TestApplyPessimisticCostFixesBudgetExceededBug:
    ...
    Fix: use BOB_PER_FEATURE_COST_CEILING (default $20) as the ceiling.
    """
...
class TestApplyPessimisticCostEnvOverride:
    """Tests for BOB_PER_FEATURE_COST_CEILING environment variable override.

    The run_loop reads BOB_PER_FEATURE_COST_CEILING and passes it as
