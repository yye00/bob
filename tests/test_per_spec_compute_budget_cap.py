...
Acceptance criteria:
- File exists: src/bob3/per_spec_compute_budget_cap.py
...
class TestImports:
    def test_module_imports(self):
        from bob3.per_spec_compute_budget_cap import SpecBudgetCap, BudgetAction
        assert SpecBudgetCap is not None
        assert BudgetAction is not None

    def test_budget_action_values(self):
        from bob3.per_spec_compute_budget_cap import BudgetAction
...
class TestFromSpec:
    def test_no_max_cost_gives_disabled_cap(self):
        from bob3.per_spec_compute_budget_cap import SpecBudgetCap
