"""Tests for bob.spec_critic registry — F-R7-450.

Verifies the three AC-mandated functions:
  - bob.spec_critic.write_findings
  - bob.spec_critic.detect_regression
  - bob.spec_critic.check_repeat_rate_halt_gate

And confirms integration with bob.orchestrator (module is importable,
...
from bob.spec_critic import write_findings, detect_regression, check_repeat_rate_halt_gate
...
class TestOrchestratorIntegration:
    ...
    def test_spec_critic_functions_accessible_from_bob(self):
        import bob.spec_critic as sc
...
def test_spec_findings_yaml_exists_in_bob():
    """AC: File exists: src/bob/reviews/spec_findings.yaml"""
    p = Path(__file__).resolve().parents[1] / "src" / "bob" / "reviews" / "spec_findings.yaml"
