"""Tests for bob.spec_loader.verify_integration_targets."""
...
from bob.spec_loader import validate_integration_targets, verify_integration_targets, check_integration_reachability
...
def test_integration_target_reachability(tmp_path):
    ...
    Verifies the canonical AC: validate_integration_targets in bob.spec_loader
