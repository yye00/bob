"""Tests for bob3.resume_scanner.scan_and_promote_interrupted (feature 89c6e29f).
...
def test_module_importable():
    import bob3.resume_scanner  # noqa: F401


def test_function_defined():
    from bob3.resume_scanner import scan_and_promote_interrupted
