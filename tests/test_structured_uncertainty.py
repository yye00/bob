"""Tests for bob.structured_uncertainty.
...
from bob.structured_uncertainty import (
    SPEC_NEEDS_HUMAN,
...
class TestGenerateCandidateImplementations:
    def test_returns_list_for_function_ac(self):
        acs = ["Function defined: bob.structured_uncertainty.clarify_ambiguous_slots"]
    ...
    def test_file_exists_ac_produces_no_stubs(self):
        acs = ["File exists: src/bob/structured_uncertainty.py"]
        result = generate_candidate_implementations(acs)
        assert result == []
...
class TestClarifyAmbiguousSlots:
    _FUNC_AC = ["Function defined: bob.structured_uncertainty.clarify_ambiguous_slots"]
    ...
    def test_ci_mode_with_uncertain_slots_returns_spec_needs_human(self):
        acs = [
            "Function defined: bob.structured_uncertainty.clarify_ambiguous_slots",
            "Function defined: bob.structured_uncertainty.generate_candidate_implementations",
        ]
