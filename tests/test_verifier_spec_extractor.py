"""Integration tests for bob3.verifier.spec_extractor.
...
from bob3.verifier.spec_extractor import (
...
_NORMAL_TARGET = "src/bob3/unrelated_module.py"
...
def test_behavior_ac_rejected_for_verifier_extension():
    ...
    acs = [
        "structural: src/bob3/enhanced_verification.py contains function foo",
...
def test_warning_logged_for_demoted_acs(caplog):
    ...
    with caplog.at_level(logging.WARNING, logger="bob3.verifier.spec_extractor"):
        result = reject_behavior_acs_for_verifier_extensions(
