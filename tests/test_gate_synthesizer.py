"""Tests for bob3.gate_synthesizer (feature a61c0e92).
...
def test_module_importable():
    mod = importlib.import_module("bob3.gate_synthesizer")
...
def test_second_call_returns_none_for_same_feature():
    ...
    import bob3.gate_synthesizer as gs
...
def test_orchestrator_exposes_re_synthesize_gate_blocked_feature():
    """bob3.orchestrator must re-export or import re_synthesize_gate_blocked_feature."""
