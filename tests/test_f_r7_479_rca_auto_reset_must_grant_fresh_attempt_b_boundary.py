...
from bob3.rca import classify_verification_failure_cause, should_grant_fresh_attempt_budget
from bob3.rca_classifier import classify_verification_failure, should_grant_fresh_attempt
...
def test_classify_single_integration_ac_returns_code_emission_defect():
    ...
    result = classify_verification_failure_cause(["integration: bob3.rca.fn works"])
    assert result == "code_emission_defect"
