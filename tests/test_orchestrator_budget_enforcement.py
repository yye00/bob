...
Tests for bob3.orchestrator.enforce_budget_on_zero_cost — the unified entry
...
from bob3.orchestrator import enforce_budget_on_zero_cost as enforce_from_pkg
from bob3.orchestrator import enforce_budget_with_telemetry_loss as enforce_with_telemetry_loss_from_pkg


class TestEnforceBudgetOnZeroCostImport:
    """enforce_budget_on_zero_cost is importable from bob3.orchestrator."""

    def test_importable_from_orchestrator_package(self):
        """AC: bob3.orchestrator.enforce_budget_on_zero_cost is importable."""
    ...
    def test_same_object_as_module_level(self):
        ...
        from bob3.orchestrator.cost_telemetry_guard import enforce_budget_on_zero_cost as direct
...
class TestThresholdBoundary:
    ...
    def test_custom_threshold_via_env(self, monkeypatch):
        """BOB3_COST_TELEMETRY_LOST_WORK_THRESHOLD env var shifts the boundary."""
...
# enforce_budget_with_telemetry_loss must be importable from bob3.orchestrator
...
def test_zero_cost_with_work_events_enforces_ceiling():
    ...
    # Also verify it's callable from bob3.orchestrator package namespace
