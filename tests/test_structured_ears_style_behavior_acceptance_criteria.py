...
from bob.structured_ears_style_behavior_acceptance_criteria import (
...
def test_returns_none_for_non_behavior_ac():
    ...
    assert structured_ears_style_behavior_acceptance_criteria("integration: bob.cli") is None
