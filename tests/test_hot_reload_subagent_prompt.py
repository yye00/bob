"""Tests for bob.hot_reload_subagent_prompt (feature f417f178).
...
def test_returns_false_when_no_change():
    ...
    mock_reload.assert_called_once_with("bob.superpowers")
...
def test_unknown_module_returns_false():
    ...
    result = reload_prompt_source_if_changed("bob.__nonexistent_xyz_module__")
    assert result is False
