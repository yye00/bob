"""Tests for bob3.linter_22_smell — the public 22-smell linter API (F-R7-410 extension).

Verifies that detect_smells and filter_by_severity work correctly through
the bob3.linter_22_smell module name (with underscore between 22 and smell).
"""
...
from bob3.linter_22_smell import (
    BLOCKING_SMELLS,
    SMELL_CATALOG,
    SMELL_BY_ID,
    SPACY_SMELLS,
