"""Tests for bob3.run_loop subagent reaping on terminal-state transitions.
...
class TestBackstopReaperForOrphanSubagents(unittest.TestCase):
    ...
    def test_default_call_returns_list(self):
        ...
        from bob3.run_loop import backstop_reaper_for_orphan_subagents
    ...
    def test_function_is_importable_from_run_loop(self):
        """backstop_reaper_for_orphan_subagents is accessible from bob3.run_loop."""
