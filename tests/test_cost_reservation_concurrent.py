...
from bob.orchestrator.cost_reservation import (
...
# ---------------------------------------------------------------------------
# Integration: bob.orchestrator.run_loop imports cost_reservation
# ---------------------------------------------------------------------------


class TestRunLoopIntegration:
    """Verify that bob.orchestrator imports cost_reservation without error."""

    def test_run_loop_importable(self):
        import bob.orchestrator.run_loop  # noqa: F401 — just checking the import

    def test_cost_reservation_in_orchestrator_package(self):
        import bob.orchestrator.cost_reservation as cr  # noqa: F401
    ...
    def test_run_loop_references_cost_reservation(self):
        ...
        import pathlib
        src = pathlib.Path(__file__).parent.parent / "src" / "bob" / "orchestrator" / "run_loop.py"
        text = src.read_text()
