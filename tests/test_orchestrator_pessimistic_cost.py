...
Verifies that apply_pessimistic_cost is importable from bob3.orchestrator.run_loop
...
# --- Importability: Function defined in bob3.orchestrator.run_loop ---
...
def test_apply_pessimistic_cost_module():
    """apply_pessimistic_cost must live in bob3.orchestrator.* namespace."""
    module = apply_pessimistic_cost.__module__
    assert "bob3.orchestrator" in module, (
        f"Expected bob3.orchestrator.* module, got: {module}"
    )
...
# --- env override: BOB3_PER_FEATURE_COST_CEILING ---
