"""Tests for bob3.subagent_prompt_reloader.
...
def test_module_importable():
    ...
    import bob3.subagent_prompt_reloader  # noqa: F401


def test_function_importable():
    """reload_prompt_sources_if_changed must be importable from the feature module."""
    from bob3.subagent_prompt_reloader import reload_prompt_sources_if_changed
...
def test_reload_prompt_sources_if_changed_result_contains_only_strings():
    ...
    with patch.object(
        _reloader,
        "maybe_reload_all",
        return_value=["bob3.superpowers", "bob3.models"],
    ):
        result = reload_prompt_sources_if_changed()
...
def test_orchestrator_reload_prompt_sources_if_changed_importable():
    """bob3.orchestrator must expose reload_prompt_sources_if_changed."""
    from bob3.orchestrator import reload_prompt_sources_if_changed  # noqa: F401
...
def test_subagent_prompt_reloader_in_all():
    ...
    import bob3.subagent_prompt_reloader as mod
