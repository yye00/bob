"""Tests for bob.orchestrator_concurrent — ConcurrentDispatchSlot and dispatch_concurrent_features.

AC: File exists: src/bob/orchestrator_concurrent.py
AC: Function defined: bob.orchestrator.dispatch_concurrent_features
AC: Function defined: bob.orchestrator.ConcurrentDispatchSlot
...
from bob.orchestrator_concurrent import ConcurrentDispatchSlot
...
def test_concurrent_dispatch_slot_importable():
    """ConcurrentDispatchSlot is importable from bob.orchestrator_concurrent."""
...
def test_dispatch_concurrent_features_importable_from_orchestrator_concurrent():
    """dispatch_concurrent_features is accessible from bob.orchestrator_concurrent."""
    from bob.orchestrator_concurrent import dispatch_concurrent_features
    assert callable(dispatch_concurrent_features)


def test_dispatch_concurrent_features_importable_from_orchestrator():
    """dispatch_concurrent_features is importable from bob.orchestrator (integration AC)."""
    from bob.orchestrator import dispatch_concurrent_features
    assert callable(dispatch_concurrent_features)


def test_concurrent_dispatch_slot_importable_from_orchestrator():
    """ConcurrentDispatchSlot is importable from bob.orchestrator (integration AC)."""
    from bob.orchestrator import ConcurrentDispatchSlot as CDS
