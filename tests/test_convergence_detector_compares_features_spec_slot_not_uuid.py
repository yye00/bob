...
Acceptance criteria:
- File exists: src/bob3/convergence_detector_compares_features_spec_slot_not_uuid.py
- Function defined: bob3.convergence_detector_compares_features_spec_slot_not_uuid.convergence_detector_compares_features_spec_slot_not_uuid
...
def test_convergence_detector_compares_features_spec_slot_not_uuid(tmp_path):
    ...
    """
    from bob3.convergence_detector_compares_features_spec_slot_not_uuid import (
