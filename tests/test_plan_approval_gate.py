...
from bob3.planner import emit_plan_ready_event as planner_emit_plan_ready_event
...
def test_planner_emit_plan_ready_event_is_same_function(tmp_path):
    """bob3.planner.emit_plan_ready_event must delegate correctly."""
...
# ---------------------------------------------------------------------------
# orchestrator integration — plan_gate is importable from bob3.orchestrator
# ---------------------------------------------------------------------------

def test_plan_gate_importable_from_orchestrator():
    """Verify bob3.orchestrator.plan_gate is importable (integration AC)."""
    from bob3.orchestrator import plan_gate  # noqa: F401
...
def test_orchestrator_init_exports_plan_gate():
    """bob3.orchestrator package must not hide plan_gate."""
    import bob3.orchestrator.plan_gate as pg
