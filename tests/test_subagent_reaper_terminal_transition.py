...
class TestReapSubagentForFeature(unittest.TestCase):
    ...
    def test_reap_sends_sigterm_and_returns_reaped_count(self):
        ...
        with patch("bob.orchestrator.subagent_reaper.find_subagent_pid_for_feature") as mock_find, \
             patch("bob.orchestrator.subagent_reaper._read_proc_argv") as mock_argv, \
             patch("bob.orchestrator.subagent_reaper._send_signal") as mock_signal, \
             patch("bob.orchestrator.subagent_reaper._wait_for_exit") as mock_wait, \
             patch("bob.orchestrator.subagent_reaper._pid_is_alive") as mock_alive, \
             patch("bob.orchestrator.subagent_reaper._append_audit_sentinel") as mock_audit:
    ...
    def test_reap_appends_audit_sentinel(self):
        ...
        with patch("bob.orchestrator.subagent_reaper.find_subagent_pid_for_feature") as mock_find, \
             patch("bob.orchestrator.subagent_reaper._read_proc_argv") as mock_argv, \
             patch("bob.orchestrator.subagent_reaper._send_signal"), \
             patch("bob.orchestrator.subagent_reaper._pid_is_alive") as mock_alive, \
             patch("bob.orchestrator.subagent_reaper._append_audit_sentinel") as mock_audit, \
             patch("bob.orchestrator.subagent_reaper._wait_for_exit") as mock_wait:
