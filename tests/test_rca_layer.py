"""Tests for bob.rca_layer — second-line infra-error recovery.

Covers:
- Module is importable at bob.rca_layer.
...
class TestAppendSpawnRetrySignature:
    ...
    def test_delegates_to_append_discovered_pattern(self) -> None:
        ...
        with patch(
            "bob.rca_layer._append_discovered_pattern"
        ) as mock_append:
    ...
    def test_pattern_appears_in_yaml(self, tmp_path: pathlib.Path, monkeypatch) -> None:
        ...
        import bob.orchestrator.rca_infra_recovery as mod
