...
Asserts bob.spec_synthesizer.resilient_import_scorer is importable and behaves deterministically on empty/zero/
...
def test_boundary_importable_and_defined():
    ...
    assert hasattr(mod, 'resilient_import_scorer'), 'resilient_import_scorer' + " must be defined in " + 'bob.spec_synthesizer'
