"""Tests for bob3.demoter.is_structural_prefix_match (F-f192b763).
...
class TestStartOfStringPrefixRequired:
    ...
    def test_function_defined_at_start_is_structural(self):
        """'function defined: bob3.module.func' is structural."""
        assert is_structural_prefix_match("function defined: bob3.module.func") is True
    ...
    def test_integration_at_start_is_structural(self):
        """'integration: bob3.run_loop' at start is structural."""
        assert is_structural_prefix_match("integration: bob3.run_loop") is True
