"""Tests for F103: bob generate-features CLI command.

Usage: bob generate-features spec.yaml --refs paper.pdf --output features.yaml [--auto-continue]
"""
...
class TestParseSpecAndPDF:
    ...
    def test_accepts_spec_file_argument(self, tmp_path):
        ...
        with patch("bob.cli._run_generate_features") as mock_gen:
...
class TestSpawnResearchAgent:
    ...
    def test_passes_pdf_content_when_refs_provided(self, tmp_path):
        ...
        runner = CliRunner()
        with patch("bob.cli._run_generate_features") as mock_gen, \
             patch("bob.cli.extract_pdf_text") as mock_pdf:
            mock_gen.return_value = []
...
class TestParseAgentOutput:
    ...
    def test_parse_features_from_yaml_text(self):
        ...
        from bob.cli import _parse_features_from_output
