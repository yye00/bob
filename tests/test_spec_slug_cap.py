"""Tests for bob3.spec_slug_cap — length-capped module slug derivation.

Feature c47f7cc6-07d0-4c52-bf8a-eff8285e3783

Verifies that derive_canonical_slug in bob3.spec_slug_cap caps slugs at
...
from bob3.spec_slug_cap import build_fallback_criteria, derive_canonical_slug
...
def test_result_is_valid_identifier() -> None:
    ...
    titles = [
        ...
        "bob3 dispatch parallel feature",
    ]
    for title in titles:
        result = derive_canonical_slug(title)
