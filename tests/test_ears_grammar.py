"""Tests for bob3.ears_grammar — sixth AC grammar: behavior: <subject> <verb> <object> when <condition>.
...
5. The module integrates with bob3.evaluator.
"""
...
from bob3.ears_grammar import BehaviorAC, evaluate_behavior_ac, parse_behavior_ac
...
class TestParseBehaviorAC:
    ...
    def test_missing_when_returns_none_or_raises(self):
        ...
        from bob3.ears_grammar import raises_on_malformed, EARSParseError
...
class TestEvaluatorIntegration:
    """Integration tests: bob3.ears_grammar connects to bob3.evaluator."""
