...
Asserts bob3.database.create_agent_run is importable and behaves deterministically on empty/zero/
...
def test_boundary_importable_and_defined():
    ...
    assert hasattr(mod, 'create_agent_run'), 'create_agent_run' + " must be defined in " + 'bob3.database'
