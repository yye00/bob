...
Tests that the three BF scope-reduction modules integrate correctly:
  ...
  (D) Integration with bob3.orchestrator import structure
"""
...
# ===========================================================================
# (D) Module import integration — bob3.orchestrator wiring
# ===========================================================================


class TestBrownfieldOrchestratorImports:
    """Integration: all required functions are importable at the bob3 package level."""

    def test_survey_run_repomapper_mcp_importable(self):
        """bob3.brownfield.survey.run_repomapper_mcp is importable."""
        from bob3.brownfield.survey import run_repomapper_mcp
        assert callable(run_repomapper_mcp)

    def test_resurrection_filter_signals_by_feature_flag_importable(self):
        """bob3.brownfield.resurrection.filter_signals_by_feature_flag is importable."""
        from bob3.brownfield.resurrection import filter_signals_by_feature_flag
        assert callable(filter_signals_by_feature_flag)

    def test_elicit_route_by_mode_importable(self):
        """bob3.brownfield.elicit.route_by_mode is importable."""
        from bob3.brownfield.elicit import route_by_mode
        assert callable(route_by_mode)

    def test_brownfield_package_importable(self):
        """bob3.brownfield package imports without error."""
        import bob3.brownfield
        assert bob3.brownfield is not None
    ...
    def test_all_three_modules_importable_together(self):
        ...
        from bob3.brownfield import survey as s, resurrection as r, elicit as e
