"""Tests for bob3.prose_ac_demoter (F-R7-578).
...
from bob3.prose_ac_demoter import (
...
class TestIsStructuralPrefixMatch:
    ...
    def test_file_exists_at_start_is_structural(self):
        assert is_structural_prefix_match("file exists: src/bob3/foo.py") is True

    def test_function_defined_at_start_is_structural(self):
        assert is_structural_prefix_match("function defined: bob3.foo.bar") is True

    def test_integration_at_start_is_structural(self):
        assert is_structural_prefix_match("integration: bob3.orchestrator") is True
