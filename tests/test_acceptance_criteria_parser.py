"""Tests for bob3.acceptance_criteria_parser.
...
from bob3.acceptance_criteria_parser import BehaviorCriterion, parse_behavior_criterion
...
def test_returns_none_for_integration_ac():
    assert parse_behavior_criterion("integration: bob3.cli") is None
...
# ---------------------------------------------------------------------------
# Evaluator integration — bob3.evaluator imports parse_behavior_criterion
# ---------------------------------------------------------------------------


def test_evaluator_integration():
    """bob3.evaluator.check_behavior_criterion uses parse_behavior_criterion."""
    from bob3.evaluator import check_behavior_criterion
