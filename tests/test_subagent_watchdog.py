"""Tests for bob.subagent_watchdog — SubagentWatchdog and spawn_watchdog_task."""
...
from bob.subagent_watchdog import SubagentWatchdog, spawn_watchdog_task

FEATURE_ID = "9089a21d-be23-4d92-ba13-f1825f388af7"
TEST_PID = 99999

_ARM_PATCH = "bob.subagent_watchdog.arm_feature_watchdog"
...
def test_subagent_watchdog_class_exists():
    """SubagentWatchdog must be importable from bob.subagent_watchdog."""
    assert SubagentWatchdog is not None


def test_spawn_watchdog_task_function_exists():
    """spawn_watchdog_task must be importable from bob.subagent_watchdog."""
...
def test_run_loop_exports_create_subagent_watchdog():
    """bob.run_loop must export create_subagent_watchdog."""
...
def test_subagent_watchdog_module_all_exports():
    """bob.subagent_watchdog.__all__ must include SubagentWatchdog and spawn_watchdog_task."""
    from bob import subagent_watchdog
