...
class TestSweepOrphansOnExit:
    def test_sweep_orphans_on_orchestrator_exit(self):
        ...
        from bob3.reaper import sweep_orphans_on_exit
        from unittest.mock import patch

        feature_id = "feat-orphan-0001-0000-0000-000000000001"

        with patch("bob3.final_reaper.sweep_orphans_on_exit") as mock_impl:
    ...
    def test_sweep_orphans_on_exit_returns_list(self):
        ...
        with patch("bob3.reaper.sweep_orphans_on_exit") as mock_fn:
    ...
    def test_sweep_orphans_delegates_to_final_reaper(self):
        """sweep_orphans_on_exit in reaper delegates to bob3.final_reaper."""
        from bob3 import reaper
        from unittest.mock import patch

        with patch("bob3.final_reaper.sweep_orphans_on_exit") as mock_final:
