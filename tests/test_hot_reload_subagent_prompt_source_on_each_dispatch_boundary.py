"""Boundary tests for bob.orchestrator.reload_prompt_sources (feature 804db4ef).
...
def test_reload_if_stale_returns_false_for_unknown_module():
    ...
    result = reload_if_stale("bob.__nonexistent_boundary_module_xyz__")
...
def test_get_prompt_mtime_returns_none_for_missing_module():
    ...
    result = get_prompt_mtime("bob.__nonexistent_boundary_module_xyz__")
