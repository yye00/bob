"""Tests for bob3.spec_quality.behavior_ac_parser.parse_behavior_ac.

AC: spec_quality behavior-AC parser MUST accept canonical clause forms beyond
strict "subject verb object when condition".

Covers:
  - File existence: src/bob3/spec_quality/behavior_ac_parser.py
  - Function: bob3.spec_quality.behavior_ac_parser.parse_behavior_ac
  - Integration: bob3.spec_quality exposes parse_behavior_ac
  - Canonical 'when' form
...
from bob3.spec_quality.behavior_ac_parser import (
    parse_behavior_ac,
...
# ---------------------------------------------------------------------------
# File / module existence (AC: "File exists: src/bob3/spec_quality/behavior_ac_parser.py")
# ---------------------------------------------------------------------------

def test_module_importable():
    """Module bob3.spec_quality.behavior_ac_parser must be importable."""
    import bob3.spec_quality.behavior_ac_parser as m
...
def test_package_import_same_object():
    ...
    from bob3.spec_quality import parse_behavior_ac as pkg_fn
    assert pkg_fn is parse_behavior_ac


def test_behavior_ac_importable_from_package():
    """BehaviorAC dataclass must be importable from bob3.spec_quality."""
    from bob3.spec_quality import BehaviorAC as pkg_cls
