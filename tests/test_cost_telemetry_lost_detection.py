...
from bob.orchestrator.cost_telemetry_guard import is_cost_telemetry_lost
...
class TestThresholdOverride:
    """BOB_COST_TELEMETRY_LOST_WORK_THRESHOLD env var overrides the default."""
    ...
    def test_env_threshold_clamped_below_1(self, monkeypatch):
        ...
        monkeypatch.setenv("BOB_COST_TELEMETRY_LOST_WORK_THRESHOLD", "0")
    ...
    def test_env_threshold_clamped_above_10000(self, monkeypatch):
        ...
        monkeypatch.setenv("BOB_COST_TELEMETRY_LOST_WORK_THRESHOLD", "99999")
    ...
    def test_env_threshold_invalid_falls_back_to_default(self, monkeypatch):
        ...
        monkeypatch.setenv("BOB_COST_TELEMETRY_LOST_WORK_THRESHOLD", "not_a_number")
        assert is_cost_telemetry_lost(reported_cost=0.0, work_events=101) is True
        assert is_cost_telemetry_lost(reported_cost=0.0, work_events=100) is False
