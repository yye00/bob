"""Tests for bob.acceptance_criteria.verify_artifact_existence (FC56E557).
...
from bob.acceptance_criteria import (
    ArtifactMiss,
...
def test_unknown_prefix_returns_miss_with_unknown_prefix_kind(workspace):
    misses = verify_artifact_existence(["integration: bob.run_loop"], workspace)
    assert len(misses) == 1
