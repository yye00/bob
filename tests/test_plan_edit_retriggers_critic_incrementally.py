...
class TestPlanVsSpecDrift:
    ...
    def test_no_drift_when_unchanged(self, tmp_path):
        from bob3.orchestrator.plan_gate import compute_plan_vs_spec_drift, write_plan_artifact
    ...
    def test_drift_on_missing_plan(self, tmp_path):
        from bob3.orchestrator.plan_gate import compute_plan_vs_spec_drift
