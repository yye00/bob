"""Tests for bob3.orchestrator.stale_bytecode.should_relaunch_on_stale_bytecode.
...
from bob3.orchestrator.stale_bytecode import should_relaunch_on_stale_bytecode
...
def workspace_with_orch(tmp_path):
    """Workspace with a properly structured bob3/orchestrator directory."""
...
class TestShouldRelaunchHappyPath:
    ...
    def test_returns_false_when_all_files_older_than_start_time(self, workspace_with_orch):
        ...
        orch = workspace_with_orch / "src" / "bob3" / "orchestrator"
