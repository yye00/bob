"""Tests for bob.stale_bytecode.check_stale_bytecode (feature 0769add9-d0b4-4f81-853e-d0037104d8d0).
...
from bob.stale_bytecode import check_stale_bytecode
