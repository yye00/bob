"""Tests for bob.feature_watchdog public API.
...
- Integration: both are importable from bob.feature_watchdog.
"""
...
from bob.feature_watchdog import (
    FeatureWatchdog,
...
# Patch target: the name as bound in bob.feature_watchdog (the importer module)
_ARM_PATCH = "bob.feature_watchdog.arm_feature_watchdog"
...
def test_feature_watchdog_class_is_importable():
    """FeatureWatchdog must be importable from bob.feature_watchdog."""
    assert FeatureWatchdog is not None


def test_spawn_feature_watchdog_is_importable():
    """spawn_feature_watchdog must be importable from bob.feature_watchdog."""
