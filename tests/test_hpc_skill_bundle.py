...
HPC_PKG = Path(__file__).parent.parent / "src" / "bob" / "skill_bundles" / "hpc"
...
class TestFileExistence:
    ...
    def test_init_py_importable(self) -> None:
        import bob.skill_bundles.hpc  # noqa: F401
...
class TestHPCBundleAPI:
    def test_is_hpc_spec_none_returns_false(self) -> None:
        from bob.skill_bundles.hpc import is_hpc_spec
    ...
    def test_load_hpc_skills_returns_dict(self) -> None:
        from bob.skill_bundles.hpc import load_hpc_skills
    ...
    def test_hpc_skill_files_constant_defined(self) -> None:
        from bob.skill_bundles.hpc import HPC_SKILL_FILES
...
class TestIntegration:
    def test_get_hpc_skill_content_returns_none_for_non_hpc(self) -> None:
        from bob.per_domain_skill_bundles_hpc_ml_pl import get_hpc_skill_content
