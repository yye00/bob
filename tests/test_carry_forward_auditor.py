"""Tests for bob.carry_forward_auditor.match_by_canonical_id.
...
from bob.carry_forward_auditor import (
...
class TestMatchByCanonicalIdImportable:
    """match_by_canonical_id must be importable from bob.carry_forward_auditor."""
