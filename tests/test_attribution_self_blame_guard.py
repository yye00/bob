...
class TestSelfBlameGuard:
    ...
    def test_self_blame_guard_attribute_returns_marker(self):
        ...
        ownership_map = {
            REGRESSION_ATTRIBUTION_FEATURE_ID: {"src/bob3/orchestrator/regression_attribution.py"},
        }
        recent_commits = [
            _make_commit("c1", ["src/bob3/orchestrator/regression_attribution.py"])
        ]
    ...
    def test_self_blame_guard_does_not_demote_self(self):
        ...
        demote_with_evidence(
            ...
            recent_commits=[_make_commit("c1", ["src/bob3/orchestrator/regression_attribution.py"])],
    ...
    def test_attribute_breakage_detects_self_blame_via_file_path(self):
        ...
        ownership_map = {
            "some-feature": {"src/bob3/orchestrator/regression_attribution.py", "src/other.py"},
        }
        recent_commits = [
            _make_commit("c1", ["src/bob3/orchestrator/regression_attribution.py"])
        ]
