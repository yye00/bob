...
from bob3.spec_quality_score_gate_features_below_threshold_cannot_reach_ready import (
...
def test_score_is_float_in_unit_interval():
    ...
    for acs in [
        [],
        ["File exists: src/bob3/spec_quality/quality_score.py"],
        ["File exists: src/bob3/spec_quality/quality_score.py", "Function defined: bob3.spec_quality.quality_score.compute_score"],
    ]:
...
def test_threshold_env_override(monkeypatch):
    """BOB3_SPEC_QUALITY_THRESHOLD env var should adjust the gate threshold."""
