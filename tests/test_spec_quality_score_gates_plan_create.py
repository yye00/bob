"""Tests for spec_quality_score gate behavior in bob plan --create.
...
class TestGateGreen:
    ...
    def test_good_spec_proceeds_silently(self):
        result = compute(
            "Good feature",
            "Function defined: src/bob/feature.compute. File src/bob/feature.py exists.",
            [
                "File exists: src/bob/feature.py",
                "Function defined: bob.feature.compute",
