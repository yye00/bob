...
When bob run is invoked, automatically detect and resume interrupted work:
...
# ============================================================
# Step 1: On bob run, query for features with status='executing'
# ============================================================
...
class TestFindResumableCheckpoints:
    ...
    def test_find_resumable_checkpoint(self, tmp_db, project, interrupted_feature_with_checkpoint):
        ...
        with patch("bob.db.get_database_path", return_value=tmp_db):
            ...
            from bob.db import find_resumable_checkpoints
...
class TestBulkPromoteFeaturesToReady:
    ...
    * Fast: 100 features promoted in well under 100ms (single UPDATE).
    ...
    def test_empty_input_is_noop(self, tmp_db, project):
        ...
        from bob.db import bulk_promote_features_to_ready
