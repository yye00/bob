...
Verifies:
  - File exists: src/bob/spec_quality_behavior_ac_parser_must_accept_canonical_clause.py
  - Function defined: bob.spec_quality_behavior_ac_parser_must_accept_canonical_clause.spec_quality_behavior_ac_parser_must_accept_canonical_clause
...
def test_module_importable():
    ...
    import bob.spec_quality_behavior_ac_parser_must_accept_canonical_clause as m
