"""Tests for bob3.bootstrap_auditor — permanent-forward-carry bootstrap check.
...
from bob3.bootstrap_auditor import (
    BootstrapAuditError,
...
class TestAuditPermanentForwardCarryEnvExtension:
    """Env-var BOB3_PERMANENT_CARRY_IDS extends required set without replacing base."""
    ...
    def test_env_var_does_not_replace_base_set(self, monkeypatch):
        monkeypatch.setenv("BOB3_PERMANENT_CARRY_IDS", "F-EXTRA-999")
