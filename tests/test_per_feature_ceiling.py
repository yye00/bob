"""Tests for bob.orchestrator.per_feature_ceiling.compute_per_feature_ceiling.

AC: pytest: tests/test_per_feature_ceiling.py
    File exists: src/bob/orchestrator/per_feature_ceiling.py
    Function defined: bob.orchestrator.per_feature_ceiling.compute_per_feature_ceiling
"""
...
_ENV = "BOB_PER_FEATURE_COST_CEILING"
