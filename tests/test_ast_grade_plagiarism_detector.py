"""Tests for src/bob3/ast_grade_plagiarism_detector.py (feature 7bb3af48).
...
- The module is importable from ``bob3.ast_grade_plagiarism_detector``
...
from bob3.ast_grade_plagiarism_detector import (
    ASTFingerprint,
    PlagiarismResult,
    ReferenceRegistry,
