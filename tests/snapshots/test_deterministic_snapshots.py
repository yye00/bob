...
- integration: bob.test_slug_capping
"""
...
class TestSlugCappingIntegration:
    """Integration: snapshot enforcement is compatible with bob.test_slug_capping."""

    def test_slug_capping_importable(self):
        from bob.test_slug_capping import verify_slug_capping, slug_is_capped  # noqa: F401
        assert callable(verify_slug_capping)
        assert callable(slug_is_capped)

    def test_slug_is_capped_for_normal_title(self):
        from bob.test_slug_capping import slug_is_capped
    ...
    def test_verify_slug_capping_returns_string(self):
        from bob.test_slug_capping import verify_slug_capping
