"""Tests for bob3.run_loop.disk_reconciler_promotion_check (b255ed0f).

Acceptance criteria verified:
  - Function defined: bob3.run_loop.disk_reconciler_promotion_check
...
def test_function_defined_ac_satisfies_structural_guard(mock_check):
    ...
    disk_reconciler_promotion_check(
        ...
        feature_id="feat-001",
        feature_name="Test Feature",
        acceptance_criteria_json='["Function defined: bob3.foo.bar"]',
        failed_gate="tests_pass",
        passed_gates=[],
    )
