"""Tests for bob.test_writer — the public API of the test-writer sub-agent.
...
class TestGenerateFailingTests:
    ...
    def test_returns_dict_with_required_keys(self, tmp_path):
        acs = ["File exists: src/bob/test_writer.py"]
    ...
    def test_one_ac_produces_one_emitted_test(self, tmp_path):
        acs = ["Function defined: bob.test_writer.generate_failing_tests"]
    ...
    def test_multiple_acs_produce_matching_counts(self, tmp_path):
        acs = [
            ...
            "Function defined: bob.test_writer.generate_failing_tests",
    ...
    def test_emitted_is_list_of_emitted_test(self, tmp_path):
        acs = ["Function defined: bob.core.run"]
