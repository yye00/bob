...
class TestFileExists:
    def test_enhanced_verification_file_exists(self):
        """AC: File exists: src/bob/enhanced_verification.py"""
        import bob.enhanced_verification as m
...
class TestFunctionDefined:
    def test_set_pending_successor_verify_exists_in_run_loop(self):
        """AC: Function defined: bob.run_loop.set_pending_successor_verify"""
...
class TestRunLoopIntegration:
    ...
    def test_run_loop_delegates_to_pending_successor_verify_module(self, tmp_path):
        """run_loop.set_pending_successor_verify delegates to bob.pending_successor_verify."""
        from bob.run_loop import set_pending_successor_verify
        with patch(
            "bob.pending_successor_verify.set_pending_successor_verify",
            return_value=True,
        ) as mock_fn:
    ...
    def test_set_pending_successor_verify_on_verifier_workspace(self, tmp_path):
        ...
        (src_bob / "enhanced_verification.py").write_text("# verifier patch")
