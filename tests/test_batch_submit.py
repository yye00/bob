"""Tests for bob.orchestrator.batch_submit (SLURM/PBS batch-job submission adapter).

Acceptance criteria:
- File exists: src/bob/orchestrator/batch_submit.py
- Function defined: bob.orchestrator.batch_submit.submit_slurm
- Function defined: bob.orchestrator.batch_submit.submit_pbs
- Function defined: bob.orchestrator.batch_submit.poll_until_done
...
from bob.orchestrator.batch_submit import (
    BatchJob,
    BatchJobError,
    BatchSubmitResult,
    JobStatus,
...
def test_batch_submit_importable_from_orchestrator() -> None:
    ...
    from bob.orchestrator import batch_submit  # noqa: F401
...
def test_run_loop_can_import_batch_submit() -> None:
    ...
    import bob.orchestrator.batch_submit as bs  # noqa: F401
