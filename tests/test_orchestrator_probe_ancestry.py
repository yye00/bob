...
Verifies that bob.orchestrator.probe_ancestry exports the two AC-mandated
...
class TestIsShellWrapper:
    ...
    def test_returns_bool_type(self):
        ...
        assert type(is_shell_wrapper("bob run")) is bool
...
class TestF_R7_567_AncestryExclusionIntegration:
    ...
    The bob version 17 defect: parent bash's eval string contained
