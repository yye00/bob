...
`bob.periodic_resume_scan_promote_interrupted_rows_mid_run_not` promotes
...
def test_periodic_resume_scan_promote_interrupted_rows_mid_run_not():
    ...
    from bob.periodic_resume_scan_promote_interrupted_rows_mid_run_not import (
    ...
    feat = _make_feature()
    with patch(
        "bob.periodic_resume_scan_promote_interrupted_rows_mid_run_not.db"
    ) as mock_db:
...
class TestPeriodicResumeScanPromoteInterruptedRowsMidRunNot:
    ...
    def test_logs_info_on_promotion(self, caplog):
        ...
        module = "bob.periodic_resume_scan_promote_interrupted_rows_mid_run_not"
