"""Tests for bob3.per_feature_subagent_watchdog_external_timer_cancels_hung.

Acceptance criteria:
- File exists: src/bob3/per_feature_subagent_watchdog_external_timer_cancels_hung.py
...
from bob3.per_feature_subagent_watchdog_external_timer_cancels_hung import (
...
def test_module_level_docstring_present():
    ...
    import bob3.per_feature_subagent_watchdog_external_timer_cancels_hung as mod
