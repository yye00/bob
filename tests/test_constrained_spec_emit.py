"""Tests for bob.constrained_spec_emit.
...
class TestEmitSpecWithSchema:
    def test_valid_spec_returns_spec(self):
        from bob.constrained_spec_emit import emit_spec_with_schema
...
class TestValidateSpecAgainstSchema:
    def test_valid_spec_returns_true(self):
        from bob.constrained_spec_emit import validate_spec_against_schema
        spec = _minimal_valid_spec()
...
class TestIntegrationWithSpecCritic:
    def test_module_imports_spec_critic(self):
        """constrained_spec_emit imports bob.spec_critic (integration requirement)."""
        import bob.constrained_spec_emit  # noqa: F401
