"""Tests for bob3.sub_agent_runs_reaper.reap_zombie_runs.

Acceptance criteria verified:
- File exists: src/bob3/sub_agent_runs_reaper.py
- Function defined: bob3.sub_agent_runs_reaper.reap_zombie_runs
...
def test_reap_zombie_runs_empty_project_no_rows():
    ...
    with patch("bob3.sub_agent_runs_reaper.db") as mock_db:
