...
Verifies that:
  ...
  - score_gate_loop and synthesize_for_feature are callable (they delegate
    to bob.spec_synthesizer; their integration is tested in bob's own suite)
"""
...
# ---------------------------------------------------------------------------
# Delegation: score_gate_loop and synthesize_for_feature from bob
# ---------------------------------------------------------------------------

def test_score_gate_loop_is_same_as_bob_original():
    from bob.spec_synthesizer import score_gate_loop as bob_fn
    assert orch.score_gate_loop is bob_fn


def test_synthesize_for_feature_is_same_as_bob_original():
    from bob.spec_synthesizer import synthesize_for_feature as bob_fn
    assert orch.synthesize_for_feature is bob_fn
