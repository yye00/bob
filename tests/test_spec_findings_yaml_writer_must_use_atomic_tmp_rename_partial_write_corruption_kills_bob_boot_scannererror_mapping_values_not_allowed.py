...
AC:
 - Function defined: bob.spec_findings_yaml_writer_must_use_atomic_tmp_rename_...
...
_MOD = (
    "bob.spec_findings_yaml_writer_must_use_atomic_tmp_rename_"
    "partial_write_corruption_kills_bob_boot_scannererror_mapping_values_not_allowed"
)
_FUNC = (
...
def test_spec_findings_yaml_writer_must_use_atomic_tmp_rename_partial_write_corruption_kills_bob_boot_scannererror_mapping_values_not_allowed():
