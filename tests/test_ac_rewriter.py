"""Tests for bob3.ac_rewriter — semantic-equivalence check and auto-repair."""
...
from bob3.ac_rewriter import apply_semantic_equivalence_check, auto_repair_error_severity_ac
...
class TestApplySemanticEquivalenceCheck:
    ...
    def test_equivalent_rewrites_return_true(self):
        ...
        with patch("bob3.auto_repair._call_llm_judge", return_value=resp):
    ...
    def test_llm_failure_returns_false_with_message(self):
        with patch("bob3.auto_repair._call_llm_judge", side_effect=Exception("network error")):
    ...
    def test_empty_string_inputs_return_false(self):
        with patch("bob3.auto_repair._call_llm_judge", side_effect=Exception("empty")):
            is_equiv, rationale = apply_semantic_equivalence_check("", "")
        assert is_equiv is False
...
class TestLinterIntegration:
    """Verify ac_rewriter integrates with bob3.linter."""
