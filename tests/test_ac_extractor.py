"""Tests for verifier.ac_extractor.reject_behavior_ac_for_extension.
...
from verifier.ac_extractor import (
...
def test_returns_ac_filter_result():
    ...
    result = reject_behavior_ac_for_extension([], _VERIFIER_TARGET)
...
def test_non_verifier_extension_passes_through():
    ...
    result = reject_behavior_ac_for_extension(acs, _NORMAL_TARGET)
...
def test_verifier_extension_behavior_ac_demoted():
    ...
    result = reject_behavior_ac_for_extension(acs, _VERIFIER_TARGET)
...
def test_non_list_raises_value_error():
    ...
    with pytest.raises(ValueError, match="acceptance_criteria must be a list"):
        reject_behavior_ac_for_extension("not a list", _VERIFIER_TARGET)


def test_none_raises_value_error():
    """None acceptance_criteria raises ValueError."""
    with pytest.raises(ValueError):
        reject_behavior_ac_for_extension(None, _VERIFIER_TARGET)


def test_tuple_raises_value_error():
    """Tuple (not list) acceptance_criteria raises ValueError."""
    with pytest.raises(ValueError):
        reject_behavior_ac_for_extension(("behavior: test",), _VERIFIER_TARGET)
...
def test_feature_id_optional():
    ...
    result = reject_behavior_ac_for_extension(["behavior: x"], _VERIFIER_TARGET)
    assert result is not None


def test_feature_id_passed_through():
    """Explicit feature_id does not change the structural result."""
    result = reject_behavior_ac_for_extension(
