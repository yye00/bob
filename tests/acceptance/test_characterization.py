"""Tests for bob3.acceptance.characterization module (BF-6).

Verifies that:
- CharacterizationAC is importable from bob3.acceptance.characterization.
- All public helpers are accessible from the characterization sub-module.
- The module correctly re-exports from bob3.acceptance.kinds.
...
import bob3.acceptance.characterization as char_mod
from bob3.acceptance.characterization import (
    CharacterizationAC,
    SnapshotResult,
    VerificationResult,
...
class TestCharacterizationModuleImports:
    ...
    def test_same_class_as_kinds(self):
        from bob3.acceptance.kinds import CharacterizationAC as KindsAC
...
# ---------------------------------------------------------------------------
# Integration: bob3.acceptance.kinds and bob3.acceptance.characterization
...
class TestKindsCharacterizationIntegration:
    ...
    def test_characterization_ac_from_kinds_is_same(self):
        from bob3.acceptance.kinds import CharacterizationAC as KindsAC
        from bob3.acceptance.characterization import CharacterizationAC as CharAC
        assert KindsAC is CharAC

    def test_parse_function_is_identical(self):
        from bob3.acceptance.kinds import parse_characterization_ac as kinds_fn
        from bob3.acceptance.characterization import parse_characterization_ac as char_fn
