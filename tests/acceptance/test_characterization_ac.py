...
It verifies:
- CharacterizationAC class is defined in bob.acceptance.kinds
...
- Integration: bob.acceptance package exports the correct symbols
...
# ---------------------------------------------------------------------------
# Integration: bob.acceptance package
# ---------------------------------------------------------------------------


class TestBobAcceptanceIntegration:
    def test_package_importable(self):
        import bob.acceptance  # noqa: F401

    def test_characterization_ac_exported_from_package(self):
        from bob.acceptance import CharacterizationAC as AC
        assert AC is not None
        assert AC is CharacterizationAC

    def test_parse_function_exported_from_package(self):
        from bob.acceptance import parse_characterization_ac as fn
        assert callable(fn)
    ...
    def test_characterization_module_importable(self):
        from bob.acceptance import characterization  # noqa: F401
...
class TestSampleInputs:
    ...
    def test_sample_inputs_re_exported_from_bf6_module(self):
        from bob.bf_6_characterization_ac_kind_approval_test_diffs_legacy import sample_inputs
        assert callable(sample_inputs)
