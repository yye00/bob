...
class TestInnocentFeatureNotCharged:
    ...
    def test_bystander_not_in_charged_set(self):
        ...
        from bob3.orchestrator.regression_attribution import (
            attribute_failures,
            charge_owners,
        )
...
class TestRunLoopIntegration:
    ...
    def test_regression_attribution_importable_from_orchestrator(self):
        """The module must be importable as bob3.orchestrator.regression_attribution."""
        import importlib
        mod = importlib.import_module("bob3.orchestrator.regression_attribution")
