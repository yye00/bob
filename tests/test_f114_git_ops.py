...
# ============================================================
# Step 1: Create src/bob/git_ops.py module
# ============================================================
...
class TestRevertFeatureSHAValidation:
    ...
    def test_dash_dash_abort_is_rejected(self, git_repo):
        ...
        is invoked."""
        from bob.git_ops import GitCommitError, revert_feature
...
class TestOrchestrationIntegration:
    ...
    def test_run_loop_imports_git_ops(self):
        ...
        from bob.git_ops import commit_feature, get_status
...
class TestCompleteFeatureCreatesCommit:
    ...
    def test_commit_feature_full_workflow(self, git_repo):
        from bob.git_ops import commit_feature, get_recent_commits
...
class TestRollbackFeatureCreatesRevert:
    ...
    def test_revert_feature_full_workflow(self, git_repo):
        from bob.git_ops import commit_feature, get_recent_commits, revert_feature
...
class TestCommitFeatureErrorHandling:
    ...
    def test_raises_git_repo_error_outside_repo(self, tmp_path):
        from bob.git_ops import GitRepoError, commit_feature
    ...
    def test_raises_hook_failed_error_when_pre_commit_rejects(self, git_repo):
        from bob.git_ops import GitHookFailedError, commit_feature
    ...
    def test_hook_failed_error_is_subclass_of_git_commit_error(self):
        from bob.git_ops import GitCommitError, GitHookFailedError, GitRepoError
