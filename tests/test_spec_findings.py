"""Tests for bob3.spec_findings — atomic write, quarantine, and safe load.
...
import bob3.spec_findings as sf
...
class TestWriteAtomic:
    ...
    def test_alias_is_importable(self):
        from bob3.spec_findings import write_atomic as wa  # noqa: F401
        assert callable(wa)
...
class TestLoadWithCorruptionRecovery:
    ...
    def test_alias_is_importable(self):
        from bob3.spec_findings import load_with_corruption_recovery as lwr  # noqa: F401
        assert callable(lwr)
