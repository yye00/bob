"""Tests for bob.sticky_completed.should_reset_completion_stamp.
...
from bob.sticky_completed import should_reset_completion_stamp
...
class TestShouldResetCompletionStamp:
    ...
    def test_no_ac_paths_returns_false(self, tmp_path):
        ...
        feature = _make_feature(acceptance_criteria=json.dumps([
            ...
            "Function defined: bob.sticky_completed.should_reset_completion_stamp",
        ]))
...
class TestEvaluatorIntegration:
    """Verify bob.evaluator exposes should_reset_completion_stamp."""

    def test_evaluator_exports_function(self):
        from bob import evaluator
    ...
    def test_evaluator_function_is_same_object(self):
        from bob import evaluator
        from bob.sticky_completed import should_reset_completion_stamp as direct
