"""Tests for BOB3_ABLATION_MODE environment variable and CLI flag (F-ablation)."""
...
from bob3.ablation import AblationMode, get_ablation_mode
...
class TestAblationModeConfig:
    ...
    def test_v_minus_1_disables_ai(self):
        from bob3.ablation import get_mode_config
...
class TestAblationModeProgressEvents:
    ...
    def test_telemetry_label_v_minus_1(self):
        from bob3.ablation import get_telemetry_label
