"""Tests for bob.init_validator.verify_project_metadata.
...
from bob.init_validator import verify_project_metadata, ProjectMetadataCheckResult
...
class TestVerifyProjectMetadataModule:
    """verify_project_metadata is importable from bob.init_validator."""

    def test_importable(self):
        from bob.init_validator import verify_project_metadata  # noqa: F401
        assert callable(verify_project_metadata)

    def test_result_type_importable(self):
        from bob.init_validator import ProjectMetadataCheckResult  # noqa: F401
