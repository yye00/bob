"""Tests for src/bob/hardcoded_reference_value_detector.py (feature efd53845).
...
- Public API is importable from bob.hardcoded_reference_value_detector
"""
...
from bob.hardcoded_reference_value_detector import (
