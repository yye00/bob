"""Tests for bob3.spec.verifier_extension_checker.reject_behavior_ac_for_verifier_extension.
...
from bob3.spec.verifier_extension_checker import (
...
# ---------------------------------------------------------------------------
# Integration with bob3.spec_extractor
# ---------------------------------------------------------------------------


def test_integration_bob3_spec_extractor_consistent():
    """reject_behavior_ac_for_verifier_extension is consistent with bob3.spec_extractor."""
    from bob3.spec_extractor import reject_behavior_ac_for_verifier_extension as extractor_fn
