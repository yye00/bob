...
from bob3 import registry_transfer
from bob3.registry_transfer import export_registry, import_registry
...
# ---------------------------------------------------------------------------
# Tests: BOB3_REGISTRY_TRANSFER_PATH env var integration
# ---------------------------------------------------------------------------

class TestEnvVarIntegration:
    def test_load_from_env_when_set(self, tmp_path, monkeypatch):
        """When BOB3_REGISTRY_TRANSFER_PATH is set, registry is loaded."""
        ...
        monkeypatch.setenv("BOB3_REGISTRY_TRANSFER_PATH", str(export_file))
    ...
    def test_no_load_when_env_not_set(self, tmp_path, monkeypatch):
        """When BOB3_REGISTRY_TRANSFER_PATH is not set, returns None."""
        monkeypatch.delenv("BOB3_REGISTRY_TRANSFER_PATH", raising=False)
