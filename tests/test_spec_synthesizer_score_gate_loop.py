"""Tests for bob.spec_synthesizer score-gate loop — re-synthesize TBD ACs until score reaches threshold.
...
_HIGH_SCORE_CRITERIA = [
    ...
    "Function defined: bob.spec_synthesizer.synthesize_with_score_gate_loop",
