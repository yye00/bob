"""Tests for bob3.test_writer_subagent.generate_failing_tests.

Verifies the public facade over bob3.orchestrator.test_writer_agent:
...
from bob3.test_writer_subagent import (
    BijectionReport,
    EmittedTest,
    FilterResult,
...
class TestModuleStructure:
    def test_module_is_importable(self):
        mod = importlib.import_module("bob3.test_writer_subagent")
        assert mod is not None

    def test_generate_failing_tests_is_callable(self):
        from bob3.test_writer_subagent import generate_failing_tests as fn
        assert callable(fn)
