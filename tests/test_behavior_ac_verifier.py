"""Tests for bob3.behavior_ac_verifier.verify_quoted_substring_ac.

AC: pytest: tests/test_behavior_ac_verifier.py
AC: Function defined: bob3.behavior_ac_verifier.verify_quoted_substring_ac
AC: integration: bob3.verifier
"""
...
from bob3.behavior_ac_verifier import verify_quoted_substring_ac
...
# --- integration: bob3.verifier re-exports the same function ---

def test_verifier_integration_import():
    """bob3.verifier must export verify_quoted_substring_ac."""
    from bob3.verifier import verify_quoted_substring_ac as vqs  # noqa: F401
    assert callable(vqs)


def test_verifier_integration_roundtrip(workspace_satisfying_both):
    """verify_quoted_substring_ac imported from bob3.verifier works correctly."""
    from bob3.verifier import verify_quoted_substring_ac as vqs
    criterion = (
