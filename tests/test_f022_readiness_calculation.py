...
class TestReadinessStoredInDatabase:
    ...
    def test_readiness_score_stored_after_calculation(self, db_path, project_id):
        from bob3.db import calculate_readiness, create_feature, get_feature, update_feature
