...
import pytest
from bob3.orchestrator.rca_attempt_budget import classify_verification_failure
...
def test_mixed_behavior_and_integration_returns_code_emission_defect():
    ...
    failed_acs = [
        ...
        "integration: bob3.orchestrator.rca_infra_recovery.auto_reset_if_infra extends",
    ]
    result = classify_verification_failure(failed_acs)
    assert result == "code_emission_defect"
