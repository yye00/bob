"""Tests for bob3.test_ownership_registry.
...
from bob3.test_ownership_registry import declare_test_ownership, get_owning_feature
...
class TestIntegrationWithRegressionAttribution:
    """Ensure declared ownerships can be consumed by bob3.detect_regression."""

    def test_detect_regression_uses_ownership_registry(self):
        from bob3 import detect_regression
