"""Tests for gpu_triton_kernel_synthesis module.

Covers synthesize_triton_kernel and autotune_kernel_config public API.
"""
...
class TestAutotuneKernelConfig:
    ...
    def test_custom_sweep_space(self):
        space = {"BLOCK_M": [16, 32], "BLOCK_N": [16, 32], "BLOCK_K": [16], "num_warps": [2], "num_stages": [2]}
