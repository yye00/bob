"""Tests for bob3.snapshot_enforcement.enforce_maxfail_for_snapshots.
...
from bob3.snapshot_enforcement import MAXFAIL_ZERO, enforce_maxfail_for_snapshots
...
class TestOrchestratorIntegration:
    """bob3.orchestrator can import snapshot_enforcement without error."""

    def test_snapshot_enforcement_importable_from_bob3(self):
        from bob3 import snapshot_enforcement
