...
import bob3.test_writer_sub_agent_failing_tests_before_implementer_fires as _mod
...
class TestTestWriterSubAgentEmits:
    def test_emits_one_file_per_ac(self, tmp_path):
        acs = ["File exists: src/a.py", "pytest: tests/test_b.py", "Function defined: bob3.c.fn"]
        result = _run(
...
class TestTestWriterSubAgentFilter:
    def test_all_emitted_tests_accepted_by_triple_filter(self, tmp_path):
        acs = ["File exists: src/bob3/core.py", "pytest: tests/test_core.py"]
        result = _run(
    ...
    def test_filter_results_count_matches_emitted(self, tmp_path):
        acs = ["File exists: src/x.py", "Function defined: bob3.x.run"]
        result = _run(
...
class TestTestWriterSubAgentBijection:
    def test_bijection_satisfied_after_emit(self, tmp_path):
        acs = ["File exists: src/bij.py", "Function defined: bob3.bij.fn"]
        result = _run(
    ...
    def test_bijection_has_correct_ac_ids_count(self, tmp_path):
        acs = ["File exists: src/a.py", "pytest: tests/test_a.py", "Function defined: bob3.a.fn"]
        result = _run(
...
class TestTestWriterSubAgentWorkspace:
    ...
    def test_accepts_string_workspace(self, tmp_path):
        acs = ["Function defined: bob3.strws.fn"]
        result = _run(
