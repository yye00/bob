"""Tests for bob3.subagent_observability_mandate.
...
from bob3.subagent_observability_mandate import forbid_pytest_stdout_redirection
from bob3.subagent_observability_mandate import validate_pytest_command
from bob3.subagent_observability_mandate import validate_pytest_output_streaming
...
class TestIntegrationWithSuperpowers:
    ...
    def test_mandate_and_superpowers_agree_on_forbidden_command(self):
        from bob3 import superpowers as sp
