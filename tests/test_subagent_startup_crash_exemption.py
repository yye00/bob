...
Verifies the orchestrator integration entry point:
  bob.run_loop.handle_subagent_startup_crash_exemption
...
from bob.run_loop import handle_subagent_startup_crash_exemption
...
class TestIntegrationWithRunLoop:
    """Integration: verifies handle_subagent_startup_crash_exemption is accessible from bob.run_loop."""

    def test_importable_from_bob_run_loop(self) -> None:
        """handle_subagent_startup_crash_exemption is importable from bob.run_loop."""
        from bob.run_loop import handle_subagent_startup_crash_exemption as fn
        assert callable(fn)
