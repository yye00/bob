"""Tests for bob.regression.ownership_detector.
...
- integration: bob.detect_regression re-exports
"""
...
from bob.regression.ownership_detector import (
...
class TestIntegrationDetectRegression:
    """Verify the integration AC: bob.detect_regression is wired."""

    def test_detect_regression_importable_from_bob(self):
        """bob.detect_regression module must be importable."""
        import bob.detect_regression  # noqa: F401

    def test_detect_regression_with_evidence_importable_from_regression_package(self):
        """bob.regression.ownership_detector must export detect_regression_with_evidence."""
        from bob.regression.ownership_detector import detect_regression_with_evidence
        assert callable(detect_regression_with_evidence)

    def test_has_ownership_evidence_importable_from_regression_package(self):
        """bob.regression.ownership_detector must export has_ownership_evidence."""
    ...
    def test_regression_package_re_exports_both_functions(self):
        """bob.regression package must re-export both functions."""
        import bob.regression as reg
