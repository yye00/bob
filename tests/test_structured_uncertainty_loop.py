"""Tests for bob.structured_uncertainty_loop.
...
from bob.structured_uncertainty_loop import (
    CandidateStub,
    ClarificationAnswer,
    SpecNeedsHumanError,
    UncertaintySlot,
...
class TestGenerateCandidateStubs:
    def test_returns_list_of_candidate_stubs(self):
        acs = ["Function defined: bob.structured_uncertainty_loop.generate_candidate_stubs"]
