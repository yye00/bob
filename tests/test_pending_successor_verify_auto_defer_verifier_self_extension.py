...
Acceptance criteria:
- File exists: src/bob/pending_successor_verify_auto_defer_verifier_self_extension.py
- Function defined: bob.pending_successor_verify_auto_defer_verifier_self_extension.pending_successor_verify_auto_defer_verifier_self_extension
...
REGULAR_ACS = [
    "File exists: src/bob/periodic_resume_scan.py",
    "pytest: tests/test_periodic_resume_scan.py",
    "Function defined: bob.periodic_resume_scan.resume_scan",
]
...
def test_pending_successor_verify_auto_defer_verifier_self_extension():
    ...
    from bob.pending_successor_verify_auto_defer_verifier_self_extension import (
...
class TestFileExists:
    def test_module_file_exists(self):
        import bob.pending_successor_verify_auto_defer_verifier_self_extension as mod
        p = Path(mod.__file__)
        assert p.exists()
    ...
    def test_module_importable(self):
        importlib.import_module(
            "bob.pending_successor_verify_auto_defer_verifier_self_extension"
        )
...
class TestNoDefer:
    ...
    def test_no_defer_when_verifier_keyword_only_in_structural_ac(self):
        ...
        acs = [
            "File exists: src/bob/enhanced_verification.py",
            "Function defined: bob.enhanced_verification.new_fn",
        ]
        result = pending_successor_verify_auto_defer_verifier_self_extension(
