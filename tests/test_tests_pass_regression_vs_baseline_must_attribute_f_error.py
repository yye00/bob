"""Error-path tests for bob3.regression_attribution.attribute_test_failure_to_owner.
...
from bob3.regression_attribution import attribute_test_failure_to_owner
