"""Tests for bob3.successor_gen_verification_handoff_verifier_extension (88d90cdc).

Acceptance criteria:
- File exists: src/bob3/successor_gen_verification_handoff_verifier_extension.py
- Function defined: bob3.successor_gen_verification_handoff_verifier_extension.successor_gen_verification_handoff_verifier_extension
...
# ---------------------------------------------------------------------------
# AC 1: File exists — src/bob3/successor_gen_verification_handoff_verifier_extension.py
# ---------------------------------------------------------------------------


class TestFileExists:
    def test_module_file_exists(self):
        import bob3.successor_gen_verification_handoff_verifier_extension as m
    ...
    def test_module_importable(self):
        import bob3.successor_gen_verification_handoff_verifier_extension  # noqa: F401

    def test_expected_names_exported(self):
        from bob3.successor_gen_verification_handoff_verifier_extension import (
    ...
    def test_all_contains_expected_names(self):
        from bob3.successor_gen_verification_handoff_verifier_extension import __all__
...
class TestFunctionDefined:
    ...
    def test_function_returns_bool(self, tmp_path):
        ...
        with patch(
            "bob3.successor_gen_verification_handoff_verifier_extension.set_pending_successor_verify",
            return_value=False,
        ):
...
def test_successor_gen_verification_handoff_verifier_extension(tmp_path):
    ...
    (src_bob3 / "enhanced_verification.py").write_text("# patched verifier")
    ...
    def test_logs_info_on_deferral(self, tmp_path, caplog):
        ...
        with patch("bob3.pending_successor_verify.db"):
            with caplog.at_level(
                logging.INFO,
                logger="bob3.successor_gen_verification_handoff_verifier_extension",
            ):
                successor_gen_verification_handoff_verifier_extension(
