...
- BOB3_ABORT_ON_SPEC_CHANGE controls abort behavior
"""
...
class TestVersionSpec:
    ...
    def test_returns_64_char_hex_string(self):
        from bob3.spec_versioning import version_spec
...
class TestSpecDiff:
    ...
    def test_spec_diff_has_expected_fields(self):
        from bob3.spec_versioning import SpecDiff
...
class TestDiffSpecs:
    ...
    def test_no_change_returns_empty_diff(self):
        from bob3.spec_versioning import diff_specs
    ...
    def test_returns_spec_diff_instance(self):
        from bob3.spec_versioning import SpecDiff, diff_specs
...
class TestSpecVersionInTelemetry:
    ...
    def test_emit_telemetry_writes_spec_version(self, tmp_path, monkeypatch):
        ...
        from bob3.telemetry import emit_telemetry_line, get_run_jsonl_path
...
class TestWatchSpecFile:
    ...
    def test_no_event_when_file_unchanged(self, tmp_path):
        ...
        from bob3.spec_versioning import watch_spec_file
    ...
    def test_event_contains_correct_versions(self, tmp_path):
        from bob3.spec_versioning import version_spec, watch_spec_file
...
# ---------------------------------------------------------------------------
# BOB3_ABORT_ON_SPEC_CHANGE
# ---------------------------------------------------------------------------


class TestAbortOnSpecChange:
    """check_spec_change_abort raises SpecChangedAbort when BOB3_ABORT_ON_SPEC_CHANGE=True."""

    def test_raises_when_abort_enabled_and_spec_changed(self, tmp_path, monkeypatch):
        monkeypatch.setenv("BOB3_ABORT_ON_SPEC_CHANGE", "true")
        from bob3.spec_versioning import SpecChangedAbort, check_spec_change_abort
    ...
    def test_no_raise_when_abort_disabled(self, tmp_path, monkeypatch):
        monkeypatch.setenv("BOB3_ABORT_ON_SPEC_CHANGE", "false")
        from bob3.spec_versioning import check_spec_change_abort
    ...
    def test_default_is_abort_true(self, monkeypatch):
        """When BOB3_ABORT_ON_SPEC_CHANGE is unset, default is True (abort)."""
        monkeypatch.delenv("BOB3_ABORT_ON_SPEC_CHANGE", raising=False)
        from bob3.spec_versioning import SpecChangedAbort, check_spec_change_abort
    ...
    def test_spec_changed_abort_is_exception(self):
        from bob3.spec_versioning import SpecChangedAbort
