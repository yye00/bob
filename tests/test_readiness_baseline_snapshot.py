...
class TestSnapshotBaselineConfidence:
    ...
    def test_importable(self):
        from bob.db.readiness_recompute import snapshot_baseline_confidence
    ...
    def test_get_baseline_returns_none_when_not_snapshotted(self, db_path, project_id):
        from bob.db import create_feature
        from bob.db.readiness_recompute import get_baseline_confidence
    ...
    def test_restore_uses_snapshotted_values(self, db_path, project_id):
        from bob.db import create_feature, update_feature, get_feature
        from bob.db.readiness_recompute import (
            snapshot_baseline_confidence,
