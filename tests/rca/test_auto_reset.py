"""Tests for bob3.rca.auto_reset — F-R7-479.

Verifies that:
- ``should_grant_fresh_attempt`` is importable from ``bob3.rca.auto_reset``
...
from bob3.rca.auto_reset import (
...
# ---------------------------------------------------------------------------
# auto_reset_on_code_defect — callable from bob3.rca.auto_reset
# ---------------------------------------------------------------------------
