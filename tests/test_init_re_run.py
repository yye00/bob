"""Tests for bob3.init_re_run — startup check after spawn_next_generation.sh.
...
class TestVerifyProjectMetadata:
    ...
    def test_stale_name_is_corrected(self, tmp_path):
        ...
        from bob3.init_re_run import verify_project_metadata
...
class TestReinitAfterSpawn:
    ...
    def test_reinit_after_spawn_corrects_stale_name(self, tmp_path):
        ...
        from bob3.init_re_run import reinit_after_spawn
    ...
    def test_reinit_and_verify_return_same_result_shape(self, tmp_path):
        ...
        from bob3.init_re_run import reinit_after_spawn, verify_project_metadata
        from bob3.run_loop import ProjectMetadataCheckResult
...
class TestRunLoopIntegration:
    """init_re_run integrates with bob3.run_loop.verify_project_metadata."""
    ...
    def test_init_re_run_and_run_loop_produce_consistent_results(self, tmp_path):
        ...
        from bob3.init_re_run import verify_project_metadata as init_rerun_verify
        from bob3.run_loop import verify_project_metadata as run_loop_verify
