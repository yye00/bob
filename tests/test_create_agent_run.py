"""Tests for bob3.create_agent_run — the canonical db_path-threaded entry point.

Verifies that bob3.create_agent_run.create_agent_run:
...
from bob3.create_agent_run import create_agent_run
...
def test_importable():
    import bob3.create_agent_run as mod
