...
def _make_feature(
    ...
    """Return a minimal dict that looks like a bob Feature."""
    return {
        "id": feature_id,
        "name": name,
...
class TestAttributeFailures:
    ...
    def test_importable(self):
        from bob.orchestrator.regression_attribution import attribute_failures
...
class TestChargeOwners:
    ...
    def test_importable(self):
        from bob.orchestrator.regression_attribution import charge_owners
