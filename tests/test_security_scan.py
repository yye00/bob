"""Tests for bob.security_scan — whitelist_local_modules and slopsquatting_check.
...
class TestWhitelistLocalModules:
    def test_src_bob_py_files_whitelisted(self, tmp_path: Path) -> None:
        """Python files under src/bob/ are included in the whitelist."""
