"""Error-path tests for bob3.validators.ac_form.validate_acceptance_criteria.
...
class TestErrorPaths:
    ...
    def test_function_defined_with_parens_raises(self):
        ...
        with pytest.raises(ValueError):
            validate_acceptance_criteria(["Function defined: bob3.module.fn (some description)"])
