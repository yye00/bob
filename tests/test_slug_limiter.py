"""Tests for bob3.slug_limiter — length-capped module slug derivation.
...
from bob3.slug_limiter import build_fallback_criteria, derive_canonical_slug
...
def test_module_importable() -> None:
    """bob3.slug_limiter must be importable and expose the required symbols."""
    import bob3.slug_limiter as m
