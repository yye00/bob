"""Tests for the resilient scorer import in bob3.spec_synthesizer.
...
def _get_module():
    return importlib.import_module("bob3.spec_synthesizer")
...
def test_import_spec_quality_scorer_is_defined():
    ...
    assert hasattr(mod, "import_spec_quality_scorer"), (
        "import_spec_quality_scorer must be defined in bob3.spec_synthesizer"
    )
...
def test_resilient_import_scorer_is_defined():
    ...
    assert hasattr(mod, "resilient_import_scorer"), (
        "resilient_import_scorer must be defined in bob3.spec_synthesizer"
    )
...
def test_load_compute_is_defined():
    ...
    assert hasattr(mod, "_load_compute"), (
        "_load_compute must be defined in bob3.spec_synthesizer"
    )
...
def test_load_compute_succeeds_after_path_augmentation():
    ...
    gen_root = spec_synthesizer_path.parents[2]  # <gen>/src/bob3 → <gen>
