"""Tests for bob.deterministic_snapshot.enforce_maxfail_zero.

Acceptance criteria:
- File exists: src/bob/deterministic_snapshot.py
- Function defined: bob.deterministic_snapshot.enforce_maxfail_zero
...
import bob.deterministic_snapshot as mod
from bob.deterministic_snapshot import MAXFAIL_ZERO, enforce_maxfail_zero
...
def test_orchestrator_integration():
    """Verify that bob.orchestrator.run_loop can import and use deterministic_snapshot."""
    from bob.deterministic_snapshot import enforce_maxfail_zero as emz
