...
BUNDLES_ROOT = Path(__file__).parent.parent / "src" / "bob3" / "skill_bundles"
...
class TestImportability:
    def test_cfd_importable(self) -> None:
        import bob3.skill_bundles.cfd  # noqa: F401

    def test_geomech_importable(self) -> None:
        import bob3.skill_bundles.geomech  # noqa: F401

    def test_nr_importable(self) -> None:
        import bob3.skill_bundles.nr  # noqa: F401

    def test_plasma_importable(self) -> None:
        import bob3.skill_bundles.plasma  # noqa: F401

    def test_particle_importable(self) -> None:
        import bob3.skill_bundles.particle  # noqa: F401
...
class TestCFDBundleAPI:
    def test_is_cfd_spec_none_returns_false(self) -> None:
        from bob3.skill_bundles.cfd import is_cfd_spec
    ...
    def test_load_cfd_skills_returns_dict(self) -> None:
        from bob3.skill_bundles.cfd import load_cfd_skills
    ...
    def test_cfd_skill_files_constant(self) -> None:
        from bob3.skill_bundles.cfd import CFD_SKILL_FILES
...
class TestGeomechBundleAPI:
    def test_is_geomech_spec_none_returns_false(self) -> None:
        from bob3.skill_bundles.geomech import is_geomech_spec
    ...
    def test_load_geomech_skills_returns_dict(self) -> None:
        from bob3.skill_bundles.geomech import load_geomech_skills
    ...
    def test_geomech_skill_files_constant(self) -> None:
        from bob3.skill_bundles.geomech import GEOMECH_SKILL_FILES
...
class TestNRBundleAPI:
    def test_is_nr_spec_none_returns_false(self) -> None:
        from bob3.skill_bundles.nr import is_nr_spec
    ...
    def test_load_nr_skills_returns_dict(self) -> None:
        from bob3.skill_bundles.nr import load_nr_skills
    ...
    def test_nr_skill_files_constant(self) -> None:
        from bob3.skill_bundles.nr import NR_SKILL_FILES
...
class TestPlasmaBundleAPI:
    def test_is_plasma_spec_none_returns_false(self) -> None:
        from bob3.skill_bundles.plasma import is_plasma_spec
    ...
    def test_load_plasma_skills_returns_dict(self) -> None:
        from bob3.skill_bundles.plasma import load_plasma_skills
    ...
    def test_plasma_skill_files_constant(self) -> None:
        from bob3.skill_bundles.plasma import PLASMA_SKILL_FILES
...
class TestParticleBundleAPI:
    def test_is_particle_spec_none_returns_false(self) -> None:
        from bob3.skill_bundles.particle import is_particle_spec
    ...
    def test_load_particle_skills_returns_dict(self) -> None:
        from bob3.skill_bundles.particle import load_particle_skills
    ...
    def test_particle_skill_files_constant(self) -> None:
        from bob3.skill_bundles.particle import PARTICLE_SKILL_FILES
...
class TestIntegration:
    def test_new_domains_in_valid_domains(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import VALID_DOMAINS
    ...
    def test_get_skills_for_cfd(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import get_skills_for_domain
    ...
    def test_select_domain_from_spec_cfd(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import select_domain_from_spec
    ...
    def test_get_cfd_skill_content_returns_none_for_non_cfd(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import get_cfd_skill_content
    ...
    def test_get_geomech_skill_content_returns_none_for_other(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import get_geomech_skill_content
    ...
    def test_get_nr_skill_content_returns_none_for_non_nr(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import get_nr_skill_content
    ...
    def test_get_plasma_skill_content_returns_none_for_non_plasma(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import get_plasma_skill_content
    ...
    def test_get_particle_skill_content_returns_none_for_non_particle(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import get_particle_skill_content
    ...
    def test_get_bundle_for_spec_cfd(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import get_bundle_for_spec
    ...
    def test_all_new_domains_have_nonempty_bundles(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import DOMAIN_BUNDLES
        for domain in ("cfd", "geomech", "nr", "plasma", "particle"):
            assert len(DOMAIN_BUNDLES[domain]) > 0, f"{domain} bundle is empty"

    def test_get_skill_content_for_none_returns_none(self) -> None:
        from bob3.per_domain_skill_bundles_hpc_ml_pl import (
