"""Tests for bob.ac_repair — check_semantic_equivalence and auto_repair_ac."""
...
from bob.ac_repair import check_semantic_equivalence, auto_repair_ac
...
class TestCheckSemanticEquivalence:
    def test_equivalent_returns_true(self):
        ...
        with patch("bob.ac_repair._call_llm_judge", return_value=resp):
    ...
    def test_llm_failure_returns_false(self):
        with patch("bob.ac_repair._call_llm_judge", side_effect=Exception("network error")):
    ...
    def test_empty_strings_do_not_raise(self):
        with patch("bob.ac_repair._call_llm_judge", side_effect=Exception("empty")):
...
class TestAutoRepairAc:
    ...
    def test_linter_integration(self, tmp_path):
        """check_semantic_equivalence and auto_repair_ac work with bob.linter SmellFinding."""
