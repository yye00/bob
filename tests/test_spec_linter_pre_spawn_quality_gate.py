...
class TestLintFeatureSpec:
    def test_valid_spec_returns_lint_result(self):
        result = lint_feature_spec(
            ...
            acceptance_criteria=["File exists: src/bob/x.py", "pytest: tests/test_x.py"],
        )
    ...
    def test_json_string_criteria_parsed(self):
        ...
        criteria_json = json.dumps(["File exists: src/bob/x.py", "pytest: tests/test_x.py"])
        result = lint_feature_spec(
    ...
    def test_warnings_filed_to_registry(self):
        ...
        with patch("bob.spec_linter_pre_spawn_quality_gate.file_warnings_to_registry") as mock_file:
            lint_feature_spec(
