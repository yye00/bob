"""Tests for bob.gate_blocked_synthesizer (feature adb882e4).
...
def clear_resynthesis_state():
    ...
    import bob.gate_blocked_synthesizer as mod
...
def test_module_importable():
    mod = importlib.import_module("bob.gate_blocked_synthesizer")
