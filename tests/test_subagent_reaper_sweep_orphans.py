...
class TestSweepOrphanSubagents(unittest.TestCase):
    ...
    def test_returns_list_of_reaped_pairs(self):
        ...
        with patch("bob3.orchestrator.subagent_reaper._query_stale_terminal_features") as mock_query, \
             patch("bob3.orchestrator.subagent_reaper.reap_subagent_for_feature") as mock_reap:
    ...
    def test_query_uses_5min_threshold(self):
        ...
        from bob3.orchestrator.subagent_reaper import _query_stale_terminal_features
        ...
        with patch("bob3.orchestrator.subagent_reaper.db") as mock_db:
            mock_conn = MagicMock()
