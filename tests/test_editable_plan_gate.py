...
- bob.spec_synthesis.emit_plan_ready_event
- bob.implementer.check_plan_approval
- bob.plan_editor.handle_plan_edits
...
# ---------------------------------------------------------------------------
# AC: Function defined: bob.spec_synthesis.emit_plan_ready_event
# ---------------------------------------------------------------------------

def test_spec_synthesis_emit_plan_ready_event_importable():
    """bob.spec_synthesis.emit_plan_ready_event must be importable."""
    from bob.spec_synthesis import emit_plan_ready_event as fn  # noqa: PLC0415
...
def test_spec_synthesis_emit_plan_ready_event_writes_event(tmp_path):
    ...
    from bob.spec_synthesis import emit_plan_ready_event  # noqa: PLC0415
...
# ---------------------------------------------------------------------------
# AC: Function defined: bob.implementer.check_plan_approval
# ---------------------------------------------------------------------------

def test_implementer_check_plan_approval_importable():
    """bob.implementer.check_plan_approval must be importable."""
    from bob.implementer import check_plan_approval  # noqa: PLC0415
...
# ---------------------------------------------------------------------------
# AC: Function defined: bob.plan_editor.handle_plan_edits
# ---------------------------------------------------------------------------

def test_plan_editor_handle_plan_edits_importable():
    """bob.plan_editor.handle_plan_edits must be importable."""
    from bob.plan_editor import handle_plan_edits  # noqa: PLC0415
...
def test_plan_gate_integrated_with_orchestrator():
    """plan_gate functions are accessible via bob.orchestrator integration."""
    from bob.orchestrator.plan_gate import (  # noqa: PLC0415
        write_plan_artifact,
        is_approved,
        approve_plan,
        emit_plan_ready_event,
...
def test_validate_plan_approved_blocks_implementer(tmp_path):
    ...
    from bob.implementer import validate_plan_approved  # noqa: PLC0415
