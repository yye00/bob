"""Tests for bob3.synthesis.canonical_ac_emitter.
...
class TestValidateCanonicalForm:
    ...
    def test_file_exists_is_canonical(self):
        acs = ["File exists: src/bob3/synthesis/canonical_ac_emitter.py"]
        result = validate_canonical_form(acs)
        assert result == []

    def test_function_defined_is_canonical(self):
        acs = ["Function defined: bob3.synthesis.canonical_ac_emitter.validate_canonical_form"]
        result = validate_canonical_form(acs)
        assert result == []
    ...
    def test_integration_is_canonical(self):
        acs = ["integration: bob3.orchestrator.path_finding_retry.research_strategies"]
        result = validate_canonical_form(acs)
        assert result == []
    ...
    def test_class_defined_is_canonical(self):
        acs = ["Class defined: bob3.synthesis.canonical_ac_emitter.SynthesisResult"]
        result = validate_canonical_form(acs)
        assert result == []
    ...
    def test_case_insensitive_function_defined(self):
        acs = ["FUNCTION DEFINED: bob3.foo.bar"]
        result = validate_canonical_form(acs)
        assert result == []
...
class TestIntegrationCanonicalInputNoRegression:
    ...
    def test_all_ac_criteria_types_pass(self):
        all_canonical = [
            "File exists: src/bob3/synthesis/canonical_ac_emitter.py",
            "Function defined: bob3.synthesis.canonical_ac_emitter.validate_canonical_form",
            "Function defined: bob3.synthesis.canonical_ac_emitter.emit_negative_path_ac",
            "Function defined: bob3.synthesis.canonical_ac_emitter.synthesise_with_canonical_gate",
            ...
            "integration: bob3.orchestrator.path_finding_retry.research_strategies",
            "pytest: tests/test_canonical_ac_emitter.py",
        ]
