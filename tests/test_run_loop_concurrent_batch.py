"""Integration tests for concurrent batch building in bob.run_loop.

Verifies that:
- claim_first_feature and claim_first_feature_before_batch_building are importable
  from bob.run_loop (integration: bob.run_loop AC).
...
# ---------------------------------------------------------------------------
# Integration: importability from bob.run_loop
# ---------------------------------------------------------------------------


def test_claim_first_feature_importable_from_run_loop():
    """claim_first_feature is importable from bob.run_loop."""
    assert callable(claim_first_feature)


def test_claim_first_feature_before_batch_building_importable_from_run_loop():
    """claim_first_feature_before_batch_building is importable from bob.run_loop."""
