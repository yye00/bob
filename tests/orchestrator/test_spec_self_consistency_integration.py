...
package — both the bob3.spec_quality.self_consistency module and the
bob3.spec_self_consistency_n_sample_stability_check_pre_critic facade are
    ...
    def test_facade_returns_dict_with_required_keys(self):
        result = spec_self_consistency_n_sample_stability_check_pre_critic(
            ...
            acceptance_criteria=[
                ...
                "Function defined: bob3.spec_quality.self_consistency.run_n_samples",
            ],
            n=1,
        )
