...
class TestAutoResetIfInfraWritesBackToReady(unittest.TestCase):
    ...
    def test_infra_only_verdict_calls_db_update_with_ready(self):
        ...
        with (
            patch("bob3.orchestrator.rca_infra_recovery._AGENT_LOGS_DIR", self.agent_logs_dir),
            patch("bob3.orchestrator.rca_infra_recovery._RCA_RESETS_JSONL", self.rca_resets_path),
