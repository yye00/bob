"""Tests for bob.spec_extractor AC discipline rule for verifier-extension features.
...
from bob.spec_extractor import (
    ACFilterResult,
    DemotedAC,
...
def test_function_importable_from_spec_extractor():
    """reject_behavior_ac_for_verifier_extension is importable from bob.spec_extractor."""
...
def test_verifier_extension_modules_constant_accessible():
    """VERIFIER_EXTENSION_MODULES is accessible from bob.spec_extractor."""
...
def test_acfilterresult_and_demotedac_importable():
    """ACFilterResult and DemotedAC are importable from bob.spec_extractor."""
