...
3. bob.reaper.handle_exponential_backoff — the function that triggered the drain
"""
...
class TestReaperHandleExponentialBackoff:
    """handle_exponential_backoff exists in bob.reaper and is callable."""

    def test_function_is_defined(self):
        from bob.reaper import handle_exponential_backoff
        assert callable(handle_exponential_backoff)

    def test_function_returns_backoff_decision(self):
        from bob.reaper import handle_exponential_backoff, BackoffDecision
        import types
