"""Tests for bob3.assess_feature_confidence — spec-quality-score mapping.
...
def tmp_db(tmp_path, monkeypatch):
    """Set up a temporary bob3 SQLite database and monkeypatch bob3.db."""
...
class TestImport:
    def test_module_importable(self):
        import bob3.assess_feature_confidence  # noqa: F401

    def test_assess_with_spec_quality_mapping_callable(self):
        from bob3.assess_feature_confidence import assess_with_spec_quality_mapping

        assert callable(assess_with_spec_quality_mapping)

    def test_assess_feature_confidence_callable(self):
        from bob3.assess_feature_confidence import assess_feature_confidence

        assert callable(assess_feature_confidence)

    def test_all_exports(self):
        import bob3.assess_feature_confidence as mod
...
class TestAssessFeatureConfidenceDelegate:
    def test_delegates_to_assess_with_spec_quality_mapping(self, tmp_db):
        ...
        from bob3.assess_feature_confidence import (
