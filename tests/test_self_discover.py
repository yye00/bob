"""Tests for bob3.meta_agent.self_discover.
...
FEATURE_ACS = [
    "File exists: src/bob3/meta_agent/self_discover.py",
    "Function defined: bob3.meta_agent.self_discover.select_spec_sections",
    "Function defined: bob3.meta_agent.self_discover.run_focused_extractor",
...
class TestOrchestratorIntegration:
    """Verify that bob3.meta_agent.self_discover is importable from bob3.orchestrator context."""

    def test_orchestrator_can_import_select_spec_sections(self):
        from bob3.meta_agent.self_discover import select_spec_sections as fn
        assert callable(fn)

    def test_orchestrator_can_import_run_focused_extractor(self):
        from bob3.meta_agent.self_discover import run_focused_extractor as fn
        assert callable(fn)

    def test_meta_agent_package_exports_both_functions(self):
        import bob3.meta_agent as pkg
