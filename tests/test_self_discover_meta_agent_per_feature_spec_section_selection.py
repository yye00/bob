"""Tests for bob3.self_discover_meta_agent_per_feature_spec_section_selection."""

from __future__ import annotations

import pytest

from bob3.self_discover_meta_agent_per_feature_spec_section_selection import (
...
def test_self_discover_meta_agent_per_feature_spec_section_selection():
    ...
    result = self_discover_meta_agent_per_feature_spec_section_selection(
        ...
        acceptance_criteria=[
            "File exists: src/bob3/self_discover_meta_agent_per_feature_spec_section_selection.py",
            ...
            "Function defined: bob3.self_discover_meta_agent_per_feature_spec_section_selection.self_discover_meta_agent_per_feature_spec_section_selection",
        ],
    )
