"""Tests for bob3.policy_ac_demotion_cross_feature_reference_acs_f_rx_yyy_id.
...
def test_policy_ac_demotion_cross_feature_reference_acs_f_rx_yyy_id():
    ...
    from bob3.policy_ac_demotion_cross_feature_reference_acs_f_rx_yyy_id import (
...
class TestImportability:
    def test_module_importable(self):
        ...
        import bob3.policy_ac_demotion_cross_feature_reference_acs_f_rx_yyy_id  # noqa: F401
...
class TestCrossFeatureReferenceDetection:
    ...
    def test_no_cross_feature_ref_returns_none(self):
        ...
        result = self.fn("integration: module bob3.verifier must be imported")
        assert result is None

    def test_plain_criterion_returns_none(self):
        """A plain function-existence criterion must return None."""
        result = self.fn("function defined: bob3.some_module.some_function")
        assert result is None
