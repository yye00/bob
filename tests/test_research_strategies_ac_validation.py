...
class TestValidateAcAgainstSpecQualityGate:
    def test_canonical_function_defined_passes(self):
        result = validate_ac_against_spec_quality_gate(
            "Function defined: bob.research_strategies.validate_ac_against_spec_quality_gate"
        )
    ...
    def test_canonical_integration_passes(self):
        result = validate_ac_against_spec_quality_gate("integration: bob.synthesis")
        assert result["passed"] is True
    ...
    def test_result_has_required_keys(self):
        result = validate_ac_against_spec_quality_gate("Function defined: bob.foo")
