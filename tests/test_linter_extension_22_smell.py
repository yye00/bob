"""Tests for bob3.linter_extension_22_smell (feature 8a8802cf).

Covers: detect_smells, validate_severity, and integration with bob3.plan gating.
"""
...
from bob3.linter_extension_22_smell import (
    BLOCKING_SMELLS,
    SMELL_CATALOG,
    SmellFinding,
    SmellSeverity,
