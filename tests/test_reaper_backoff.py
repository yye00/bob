...
Covers:
  - bob3.reaper.stamp_reap_metadata
  - bob3.reaper.should_refuse_redispatch
  - bob3.dispatch.should_refuse_redispatch (integration AC)
"""
...
from bob3.dispatch import should_refuse_redispatch as dispatch_should_refuse
...
# ── should_refuse_redispatch (bob3.reaper) ────────────────────────────────────
...
# ── should_refuse_redispatch via bob3.dispatch (integration AC) ───────────────


class TestDispatchShouldRefuseRedispatch:
    def test_function_exists_in_dispatch_module(self):
        from bob3 import dispatch as _dispatch_mod
        assert hasattr(_dispatch_mod, "should_refuse_redispatch"), (
            "bob3.dispatch must export should_refuse_redispatch"
        )
