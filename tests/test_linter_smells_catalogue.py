"""Tests for bob.linter.smells_catalogue (F-R7-410 full 22-smell extension).
...
from bob.linter.smells_catalogue import (
    BLOCKING_SMELLS,
    SMELL_CATALOG,
    SmellFinding,
    blocks_plan_create,
...
class TestCatalogueMetadata:
    ...
    def test_blocking_smells_all_e_severity(self):
        from bob.linter.smells_catalogue import SMELL_BY_ID
