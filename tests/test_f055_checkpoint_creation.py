...
class TestCreateCheckpointExists:
    ...
    def test_function_is_importable(self, db_path):
        from bob3.db import create_checkpoint
...
class TestCaptureStateSnapshot:
    ...
    def test_state_snapshot_stored(self, feature):
        from bob3.db import create_checkpoint, get_checkpoint
...
class TestEndToEndCheckpointCreation:
    ...
    def test_create_checkpoint_during_execution_verify_stored(self, feature, task):
        ...
        from bob3.db import create_checkpoint, get_checkpoint, list_checkpoints
        ...
        files = [
            {"path": "src/bob3/db.py", "hash": hashlib.sha256(b"db content").hexdigest()},
            {"path": "src/bob3/models.py", "hash": hashlib.sha256(b"models content").hexdigest()},
        ...
        assert parsed_files[0]["path"] == "src/bob3/db.py"
    ...
    def test_list_checkpoints_for_feature(self, feature):
        ...
        from bob3.db import create_checkpoint, list_checkpoints
    ...
    def test_multiple_features_isolated(self, project):
        ...
        from bob3.db import create_checkpoint, create_feature, list_checkpoints
