"""Tests for bob3.audit_permanent_forward_carry module.
...
import bob3.audit_permanent_forward_carry as auditor_module
from bob3.audit_permanent_forward_carry import match_by_canonical_id, resolve_feature_reference
