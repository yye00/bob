"""Tests for prose-connector detection via bob3.demoter_utils (F-936068dc).
...
from bob3.demoter_utils import get_prose_connector_registry, is_structural_prefix_match
