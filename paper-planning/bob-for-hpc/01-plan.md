...
`src/bob3/skills/`, each 1–3 pages of dense content. See
...
**Goal:** bob3 can validate the code it generates on real
...
work; the bob3 verification layer doesn't trivially extend.
...
**Goal:** bob3 can submit Slurm/PBS/LSF jobs as part of a feature
...
3. **Baseline.** What does bob3 get compared to? Recommendation:
...
- Production-grade UI (current bob3 CLI is fine)
