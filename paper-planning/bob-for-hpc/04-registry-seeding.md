...
The `checking-review-registry` skill works in the existing bob3
...
Each finding the registry contains is a bug bob3's sub-agents
will *not* recreate when `checking-review-registry` is consulted.
A registry of 0 HPC findings means every CUDA kernel bob3
