# bob for HPC — paper planning

This directory holds working materials for taking bob in the
...
1. [`00-adversarial-analysis.md`](00-adversarial-analysis.md) —
   honest critique of the "bob generates HPC code" claim. What
   the swedish-circle build does and doesn't support; where bob's
...
4. **What's the baseline?** What gets compared against bob to
