"""EARS-style behavior acceptance criteria parser — public top-level API.
...
``BehaviorCriterion`` named tuple. The evaluator uses those discrete fields
to produce a targeted verification prompt rather than relying on freeform prose.
