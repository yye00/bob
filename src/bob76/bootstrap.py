"""Bootstrap readiness override — one bypass execute per feature (bob76).

Exposes apply_bootstrap_override, a predicate that determines whether a
...
Integrates with bob3.features: callers compose this check alongside
bob3.features utilities when deciding whether to allow a gated execution.
"""

from __future__ import annotations

import bob3.features as _features  # noqa: F401 — integration: bob3.features
...
def apply_bootstrap_override(feature: Feature) -> bool:
