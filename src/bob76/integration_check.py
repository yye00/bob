"""bob76.integration_check — Integration-target reachability check at spec-load time.
...
import bob76.spec_loader as _spec_loader  # noqa: F401 — integration: bob76.spec_loader
