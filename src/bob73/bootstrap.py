...
Integrates with bob3.feature_timeout: the timeout contract applies to any
...
from bob3.feature_timeout import resolve_feature_timeout_seconds  # noqa: F401 — integration
