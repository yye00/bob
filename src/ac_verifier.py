"""AC artifact-existence verifier — public top-level API.
...
Public API
----------
verify_artifacts(acs, workspace) -> list[ArtifactMiss]
...
from baseline_gate import CollectionResult, verify_collection  # noqa: F401
from baseline_verifier import ensure_collection_succeeds  # noqa: F401
...
def verify_artifacts(
    ...
    Returns:
        A (possibly empty) list of :class:`~bob.verification.ac_artifact_check.ArtifactMiss`
