...
:func:`bob.spec_quality.integration_reachability.check_spec` for the core
reachability logic and wires into :mod:`bob.rca` for RCA-layer integration.
...
import bob.rca as _rca  # noqa: F401 – integration wiring per AC "integration: bob.rca"
