...
from bob.score_gate_loop import re_synthesize_acceptance_criteria
from bob.spec_quality.quality_score import compute_score as _compute_score, gate_for_ready as _gate_for_ready
...
def handle_gate_blocked_feature(
    ...
    *,
    ...
    project_id:
        Bob project UUID, forwarded to the synthesizer.
    threshold:
