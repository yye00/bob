"""Structured-uncertainty clarification gate for bob3.
...
def compute_disagreement_score(
    ...
    *,
    ...
    """Compute disagreement scores across candidate stubs and return ambiguous slots.
...
def build_clarification_questions(
    ...
    *,
    ...
    """Build and (optionally) present clarification questions for ambiguous slots.

    In CI mode (no human present), raises :class:`~spec_synthesis.SpecNeedsHumanError`
    ...
    disagreement_slots:
        ...
        :func:`compute_disagreement_score`.
    max_per_round:
    ...
    # CI gate: raise rather than confabulate
