...
bob3.permanent_forward_carry_auditor_must_match_f_r7_nnn so that callers
referencing the AC-required short path get the same implementation.
"""

from bob3.permanent_forward_carry_auditor_must_match_f_r7_nnn_canonical_id_regex_sidecar_rename_shortname_drift_currently_silently_drops_carry_forward_features import (  # noqa: F401, E501
    BootstrapAuditError,
