"""bob3.ac_form_validator — AC-form validator at planning time.

Validates every acceptance criterion against the canonical grammar before a
feature is persisted to the database.  Run at ``bob3 plan --create`` time to
...
Usage::
    ...
    from bob3.ac_form_validator import validate_acceptance_criteria
...
This module re-exports the implementation from :mod:`bob3.validators.ac_form`
under the canonical ``bob3.ac_form_validator`` namespace required by the AC
``Function defined: bob3.ac_form_validator.validate_acceptance_criteria``.
"""

from __future__ import annotations

from bob3.validators.ac_form import MalformedACError, parse_criterion, validate_acceptance_criteria
