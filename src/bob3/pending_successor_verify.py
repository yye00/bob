...
When a feature's diff modifies src/bob3/enhanced_verification.py or any module listed in
...
def get_verifier_extension_modules() -> tuple[str, ...]:
    ...
    :mod:`bob3.spec_quality.spec_extractor`, which is the single source of
    truth for which modules, when modified by a feature, trigger the
    ``pending_successor_verify`` deferral path.

    Returns:
        Tuple of module path strings (relative paths under ``src/bob3/``).
    """
...
# AC-mandated alias: "Function defined: bob3.pending_successor_verify.scan_ac_for_verification_tokens"
scan_ac_for_verification_tokens = scan_ac_body_for_tokens

# AC-mandated alias: "Function defined: bob3.pending_successor_verify.scan_ac_body_for_verification_tokens"
scan_ac_body_for_verification_tokens = scan_ac_body_for_tokens

# AC-mandated alias: "Function defined: bob3.pending_successor_verify.defer_to_next_generation"
...
# AC-mandated alias: "Function defined: bob3.pending_successor_verify.promote_pending_successor"
...
def reset_deferred_features(project_id: str) -> int:
    ...
    On ``bob3 spawn``, the next generation's bootstrap merger calls this function to
