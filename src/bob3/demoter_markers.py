"""bob3.demoter_markers — Canonical marker registry for prose-AC and integration-AC demoters.
...
Root-cause context (F-R7-576 + F-R7-577):
  ...
  This module delegates to bob3.verification.structural_prefix_match
