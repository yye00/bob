...
bob3.reviews …" — which caused a hard-fail when the actual module reference
``bob3.reviews`` was never checked.
...
from bob3.spec_findings_yaml_writer_must_use_atomic_tmp_rename_partial import (  # noqa: F401
    atomic_write_yaml,
)
...
def enhanced_verification_pattern_8_integration_must_scan_all(
    ...
    from bob3.enhanced_verification import _integration_wired
