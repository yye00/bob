...
ALL_BLOCKED or BUDGET_EXCEEDED terminations.  Delegates to bob3.final_reaper
...
def sweep_orphans_on_exit(project_id: str) -> list[str]:
    ...
    Delegates to bob3.final_reaper.sweep_orphans_on_exit which performs the
    full two-step sweep:
    ...
    """
    from bob3.final_reaper import sweep_orphans_on_exit as _sweep
