...
Feature 5e3e0c6b: Public entry point that exposes classify_exit and
spawn_with_retry from bob3.orchestrator.spawn_retry, plus a named function
satisfying the AC function-defined requirement.
...
def infra_error_transient_classifier_unlimited_spawn_layer_recovery_no_budget_impact(
    exit_code: int | None,
    stderr: str | None,
...
__all__ = [
    ...
    "SpawnCallable",
    "classify_exit",
    "infra_error_transient_classifier_unlimited_spawn_layer_recovery_no_budget_impact",
    "load_patterns",
    "spawn_with_retry",
]
