...
Integration
-----------
This module is the top-level bob3 façade. It delegates to the lower-level
primitives in :mod:`bob3.orchestrator.cost_telemetry_guard`. The orchestrator
...
def enforce_minimum_cost_on_zero_report(
    ...
    per_feature_ceiling:
        ...
        is lost. Source: env ``BOB3_PER_FEATURE_COST_CEILING``.
    feature_id:
