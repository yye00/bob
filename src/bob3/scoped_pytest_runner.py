...
run_scoped_pytest(feature_id, acs, workspace, *, extra_args=None, timeout=300)
    ...
    :class:`~bob3.verifier.pytest_scoping.ScopedPytestResult`.
...
from bob3.verifier.pytest_scoping import (
...
def run_scoped_pytest(
    ...
    *,
    ...
    call. It delegates to :func:`bob3.verifier.pytest_scoping.scoped_pytest_runner`,
    ...
    Returns:
        :class:`~bob3.verifier.pytest_scoping.ScopedPytestResult` with
