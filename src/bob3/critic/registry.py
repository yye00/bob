"""bob3.critic.registry — Persistent spec-critic findings registry with regression detection.
...
Public API::
    ...
    from bob3.critic.registry import write_finding, detect_regression, compute_critic_repeat_rate
