"""bob3.verifier — feature-scoped pytest invocation for the verifier's tests_pass step.
...
from bob3.behavior_criteria import EARSBehaviorCriterion, parse_behavior_criteria
from bob3.property_based_ac import PropertyAC, emit_hypothesis_test, parse_property_ac
...
from bob3.mutation_testing import (  # noqa: F401 — mutation gate integration
...
from bob3.snapshot_determinism import enforce_maxfail_zero  # noqa: F401 — snapshot boundary integration
