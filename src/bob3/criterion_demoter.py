"""bob3.criterion_demoter — Public demoter API for bob3 AC classification.
...
bob3.verification.structural_prefix_match.
...
def demote_cross_feature_ac(
    ...
    Delegates to :func:`bob3.enhanced_verification.demote_cross_feature_ac`.
