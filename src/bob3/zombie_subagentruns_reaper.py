"""Zombie sub_agent_runs reaper — canonical module for feature 70a4877b.
...
criteria under the exact module path bob3.zombie_subagentruns_reaper.

Public API
----------
reap_zombie_subagentruns(project_id)
...
def reap_zombie_subagentruns(project_id: str) -> list[str]:
