"""bob3.spawn_with_retry — public entry point for transient-error spawn recovery.

Satisfies ACs:
  - File exists: src/bob3/spawn_with_retry.py
  - Function defined: bob3.spawn_with_retry.spawn_with_retry
  - Function defined: bob3.spawn_with_retry.classify_exit
