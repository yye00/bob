...
Problem (bob3 v.19 r1, 2026-05-31)
------------------------------------
...
the bob3 v.17 spec. The underlying logic lives in
``bob3.enhanced_verification.demote_cross_feature_criterion``.
"""
...
import bob3.enhanced_verification as _ev
