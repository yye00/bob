...
def seed_readiness_for_zero_features(project_id: str) -> int:
    ...
    Satisfies AC: 'Function defined: bob3.assess_feature_confidence.seed_readiness_for_zero_features'.
    ...
    """
    from bob3.db import get_features_by_project, update_feature  # noqa: PLC0415
...
def assess_with_spec_quality_mapping(feature_id: str) -> dict[str, float]:
    ...
    """
    from bob3.db import get_feature  # noqa: PLC0415
...
def assess_feature_confidence(feature_id: str) -> dict[str, float]:
    ...
    Re-exported for callers that import from this module rather than bob3.db.
    """
