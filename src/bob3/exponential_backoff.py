...
should_refuse_redispatch(feature, now)
    ...
    escalated to needs_human. Delegates to bob3.reaper.
...
from bob3.orchestrator.reap_backoff import compute_backoff_seconds as _compute_backoff_seconds
...
from bob3.reaper_backoff import calculate_backoff_delay as _calculate_backoff_delay
...
def calculate_backoff_delay(reap_count: int) -> int:
    ...
    Delegates to bob3.reaper_backoff.calculate_backoff_delay.
...
# AC-mandated alias: "Function defined: bob3.exponential_backoff.should_allow_redispatch"
