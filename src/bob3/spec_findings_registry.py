...
Public API::
    ...
    from bob3.spec_findings_registry import write_findings, detect_regression
...
def write_findings(
    ...
    *,
    ...
    ValueError
        ...
        when required string arguments are not strings.
    TypeError
...
def load_findings(
    ...
    """Load the spec findings registry from disk.
    ...
    -------
    dict
        The full registry dict (with 'findings' and 'run_history' keys),
...
def write_spec_findings(
    ...
    *,
    ...
    Alias for write_findings — required by AC
    (bob3.spec_findings_registry.write_spec_findings).

    Parameters match write_findings exactly.
    """
