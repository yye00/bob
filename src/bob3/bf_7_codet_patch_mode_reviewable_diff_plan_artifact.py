...
CodeR-style patch-mode for brownfield. Greenfield bob3 writes whole files;
...
Protocol enforced by this module:
  ...
  1. emit_diff_plan — write .bob3/features/<id>/diff_plan.yaml before edits.
...
def bf_7_codet_patch_mode_reviewable_diff_plan_artifact(
    *,
    ...
    protocol_steps = [
        "Implementer emits .bob3/features/<id>/diff_plan.yaml before any edits "
        "(emit_diff_plan); verifier and optionally human sanity-check scope.",
        "apply_diff_plan: backup originals to .bob3/features/<id>/orig/<path>, "
    ...
    return {
        ...
        "module_path": "bob3.brownfield.patch_planner",
    }
