...
The underlying logic lives in ``bob3.enhanced_verification.demote_cross_feature_criterion``.
"""
...
from bob3.enhanced_verification import demote_cross_feature_ac as _demote_cross_feature_ac
