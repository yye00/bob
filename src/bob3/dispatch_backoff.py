...
def check_reap_backoff(
    ...
    This is the AC-required entry point on bob3.dispatch_backoff satisfying
    the acceptance criterion "Function defined: bob3.dispatch_backoff.check_reap_backoff".
...
def record_reap_event(
    ...
    "Function defined: bob3.dispatch_backoff.record_reap_event".
