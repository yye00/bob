"""bob3.snapshot_enforcement — enforce --maxfail=0 at the pytest snapshot boundary.
...
__all__ = ["enforce_maxfail_for_snapshots", "MAXFAIL_ZERO"]


def enforce_maxfail_for_snapshots(argv: list[str]) -> list[str]:
