"""bob3.implementer — implementer-side gate check for the Devin-style plan.yaml gate.
...
Public API::
    ...
    from bob3.implementer import validate_plan_approved, check_plan_approved, check_plan_approval
