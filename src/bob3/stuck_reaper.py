"""Top-level stuck-executing reaper for bob3.

Exposes detect_and_reset_stuck_features as the canonical public entry point.
The heavy lifting lives in bob3.orchestrator.stuck_executing_reaper; this
...
def detect_stuck_executing(
    ...
    Delegates to bob3.orchestrator.stuck_executing_reaper.find_stuck_features.
...
def reset_stuck_feature(
    ...
    Delegates to bob3.orchestrator.stuck_executing_reaper.reap_stuck_feature.
...
# Alias satisfying AC: "Function defined: bob3.stuck_reaper.reap_stuck_executing"
