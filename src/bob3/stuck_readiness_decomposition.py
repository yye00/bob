...
Exposed API
-----------
should_decompose(feature, *, previous_readiness_score=None) -> bool
...
Integration: bob3.orchestrator calls ``should_decompose`` before re-queuing a
...
def should_trigger_decomposition(
    ...
    *,
    ...
    """Alias for should_decompose — AC-mandated name."""
