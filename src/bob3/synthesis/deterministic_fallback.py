"""bob3.synthesis.deterministic_fallback — boundary + error-path AC injection.
...
canonical public entry-point under ``bob3.synthesis``.  It delegates to
:func:`bob3.spec_synthesizer._ensure_boundary_and_error_coverage` which holds
...
def ensure_boundary_and_error_coverage(
    ...
    :func:`bob3.spec_synthesizer._ensure_boundary_and_error_coverage` so that
