"""Permanent-forward-carry auditor — bob3.auditors public entry point.
...
bob3.bootstrap.permanent_forward_carry_auditor so that the AC-required
import path (bob3.auditors.permanent_forward_carry) is satisfied without
duplicating logic.
"""
...
def audit_permanent_forward_carry(spec: dict[str, Any]) -> None:
    ...
    Primary bootstrap entry point at the bob3.auditors.permanent_forward_carry
