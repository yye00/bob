"""Carry-forward matcher — canonical F-R7-NNN regex matching for bob3.auditor.
...
This module is intentionally self-contained (no imports from bob3.*) to avoid
the circular-import chain triggered by bob3.__init__. The bootstrap auditor's
pattern and ID set are reproduced here so this module can be imported in test
environments without initialising the full bob3 runtime.
"""
...
# bootstrap auditor but kept here to avoid triggering bob3.__init__ on import.
