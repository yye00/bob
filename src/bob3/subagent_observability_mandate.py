...
Canonical module that locks the subagent observability rule into the bob3 spec
so future bootstraps re-apply it. All validation logic delegates to
``bob3.subagent_observability``.
...
from bob3.subagent_observability import validate_pytest_command  # noqa: F401
from bob3.subagent_observability import validate_pytest_output_streaming  # noqa: F401
