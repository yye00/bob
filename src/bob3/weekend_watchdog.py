"""weekend_watchdog — convergence detection for bob3.
...
rather than by UUID (minted fresh on every `bob3 init`).
...
sentinel without importing bob3.stall_escalation directly.
"""
...
from bob3.convergence_detector import check_convergence  # noqa: F401 — re-exported
from bob3.stall_escalation import (  # noqa: F401 — integration re-export
