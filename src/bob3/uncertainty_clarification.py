"""bob3.uncertainty_clarification — Structured-uncertainty clarification loop.
...
Public API::
    ...
    from bob3.uncertainty_clarification import (
...
Integration with bob3.spec_synthesizer::
    ...
    from bob3.uncertainty_clarification import trigger_clarification_loop
...
def trigger_clarification_loop(
    ...
    *,
    ...
    In CI mode (``BOB3_CI_MODE=1`` or ``ci_mode=True``) with any ambiguous
