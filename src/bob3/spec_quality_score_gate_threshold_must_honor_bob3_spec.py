"""Spec quality gate threshold must honor BOB3_SPEC_QUALITY_THRESHOLD env var.

The gate threshold is resolved lazily on every call via
:func:`bob3.spec_quality.threshold_resolver.resolve_spec_quality_threshold`,
...
def spec_quality_score_gate_threshold_must_honor_bob3_spec(
    name: str,
    ...
    The threshold is read lazily from ``BOB3_SPEC_QUALITY_THRESHOLD`` on every
