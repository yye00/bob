...
classification and integrates with :mod:`bob3.spec_quality.spec_extractor`
...
class SelfDiscoverMetaAgent:
    ...
    result integrates with :mod:`bob3.spec_quality.spec_extractor`.
    ...
    def run(self) -> dict[str, Any]:
        ...
        Integrates with :mod:`bob3.spec_quality.spec_extractor` for the
