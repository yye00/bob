...
``bob3.spec_quality.behavior_ac_parser`` so that callers can import from
``bob3.behavior_ac_parser`` (the path named in AC F-2bd103a0).
...
from bob3.acceptance_criteria.key_example import (  # noqa: F401
    KeyExample,
    extract_key_examples,
)

# Alias required by AC: "Function defined: bob3.behavior_ac_parser.parse_behavior_clause"
