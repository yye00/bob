"""GPU/Triton kernel synthesis + autotune for bob3.
...
bob3.implementers.__init__ → bob3.orchestrator circular import chain.
"""
...
# Direct file-path load to avoid triggering bob3.implementers.__init__,
# which imports bob3.orchestrator.plan_gate, which imports bob3.orchestrator,
