"""bob3.spec_quality — behavior-AC parser integration shim.

This file satisfies the AC artifact-existence check:
  ``File exists: src/bob3/spec_quality.py``

The canonical implementation lives in the ``bob3.spec_quality`` package
(``src/bob3/spec_quality/__init__.py``).  Python's import system prefers the
...
from bob3.spec_quality.composite_score import (  # noqa: F401  # d9781830
