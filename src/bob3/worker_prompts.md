...
every worker system prompt via `bob3.dispatch.apply_cheap_wins`.
...
**Implementation:** `bob3.dispatch.run_mutation_pass_check` /
...
All four directives are wired through `bob3.dispatch.apply_cheap_wins`:
