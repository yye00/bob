"""bob3.integration_target_validator — Integration-target reachability check at spec-load time.
...
Public API: :func:`validate_integration_target`
"""
...
from bob3.spec_quality.integration_reachability import ReachabilityResult, check_spec  # integration: bob3.spec_loader
...
def validate_integration_target(
    features: Any = _SENTINEL,
    workspace: Path | str | None = None,
    *,
    reject_on_failure: bool = False,
) -> ReachabilityResult:
    """Validate integration targets in a spec are reachable at spec-load time.
