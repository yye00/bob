...
:mod:`bob3.skill_bundles.hpc` which provides skill markdown files for
...
subpackages:
- :mod:`bob3.skill_bundles.cfd`     - FVM/FEM, SIMPLE/PISO, turbulence, BCs
- :mod:`bob3.skill_bundles.geomech` - poroelasticity, contact, fault slip, plasticity
- :mod:`bob3.skill_bundles.nr`      - BSSN, gauge, initial data, GW extraction, AMR
- :mod:`bob3.skill_bundles.plasma`  - PIC, Boris, gather/scatter, MHD, Vlasov-Poisson
- :mod:`bob3.skill_bundles.particle`- Geant4 user actions, custom physics lists
...
def get_hpc_skill_content(spec: dict[str, Any] | None) -> dict[str, str] | None:
    ...
    :mod:`bob3.skill_bundles.hpc` and returns them as a filename → text
    ...
    """
    from bob3.skill_bundles.hpc import is_hpc_spec, load_hpc_skills
...
def get_cfd_skill_content(spec: dict[str, Any] | None) -> dict[str, str] | None:
    ...
    """
    from bob3.skill_bundles.cfd import is_cfd_spec, load_cfd_skills
...
def get_geomech_skill_content(spec: dict[str, Any] | None) -> dict[str, str] | None:
    ...
    """
    from bob3.skill_bundles.geomech import is_geomech_spec, load_geomech_skills
...
def get_nr_skill_content(spec: dict[str, Any] | None) -> dict[str, str] | None:
    ...
    """
    from bob3.skill_bundles.nr import is_nr_spec, load_nr_skills
...
def get_plasma_skill_content(spec: dict[str, Any] | None) -> dict[str, str] | None:
    ...
    """
    from bob3.skill_bundles.plasma import is_plasma_spec, load_plasma_skills
...
def get_particle_skill_content(spec: dict[str, Any] | None) -> dict[str, str] | None:
    ...
    """
    from bob3.skill_bundles.particle import is_particle_spec, load_particle_skills
