"""bob3.mutation_testing.mutmut_verifier — mutmut 3.x post-impl quality gate.
...
check_mutation_score(score, threshold=None) -> bool
    Return True when score >= threshold (default MUTATION_SCORE_THRESHOLD).
"""
...
def check_mutation_score(score: float, threshold: float | None = None) -> bool:
    ...
    Args:
        ...
        threshold: Minimum acceptable score. Defaults to MUTATION_SCORE_THRESHOLD (0.75).
