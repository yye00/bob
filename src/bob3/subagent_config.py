"""bob3.subagent_config — subagent configuration utilities (BF-8 Part B integration).

Provides apply_extended_thinking, which wires the extended_thinking toggle
into subagent dispatch configuration.  Called by both bob3.dispatcher and
bob3.concurrent_dispatcher before spawning a Claude sub-agent.

Satisfies ACs:
  - Function defined: bob3.subagent_config.apply_extended_thinking
  - integration: bob3.dispatcher
  - integration: bob3.concurrent_dispatcher
"""
