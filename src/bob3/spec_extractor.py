"""Spec extractor public API — bob3.spec_extractor.
...
bob3.spec_quality.self_consistency._extract_variant to expose a stable public
API for the N-sample stability check pre-critic.

Public API::

    from bob3.spec_extractor import extract_with_temperature
"""
...
from bob3.spec_quality.self_consistency import _extract_variant
