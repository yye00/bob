...
Public API::
    ...
    from bob3.meta_agent_selector import (
...
classification. Integrates with :mod:`bob3.orchestrator` as
``bob3.orchestrator.select_spec_sections`` and
``bob3.orchestrator.run_focused_extraction``.
"""
...
#: Alias satisfying AC: ``Function defined: bob3.meta_agent_selector.focused_extract``.
