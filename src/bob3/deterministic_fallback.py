"""bob3.deterministic_fallback — top-level public module for boundary + error-path AC injection.
...
Public API::
    ...
    from bob3.deterministic_fallback import ensure_boundary_and_error_coverage
"""
