    ...
    *,
    ...
    Args:
        db_path: Explicit path to the SQLite database file. When supplied,
            ...
            BOB3_DATABASE_PATH. Callers that manage a specific project
    ...
    # BOB3_MAX_COST_USD or effectively-unlimited, NOT the old hardcoded 500.0
    ...
    *,
    ...
    Args:
        db_path: Explicit path to the SQLite database file. When supplied, the
            ...
            BOB3_DATABASE_PATH. Callers that already know the project's
