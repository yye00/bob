"""bob3.synthesize — retry-aware acceptance-criteria synthesizer.

Public entry-point for spec synthesis with aggressive retry on transient
upstream API 400/empty-response errors (see bob3.spec_synthesizer for
...
env-tunable BOB3_SYNTH_MAX_ATTEMPTS) with exponential backoff (2, 4, 8, 16, 32
