"""bob3.synthesizer — retry-aware acceptance-criteria synthesizer.
...
attempts, env-tunable BOB3_SYNTH_MAX_ATTEMPTS) with exponential backoff
...
Public API (mirrors bob3.spec_synthesizer via bob3.synthesize):
...
from bob3.spec_synthesizer import emit_file_exists_acs, synthesize_with_retry
...
# AC alias: "Function defined: bob3.synthesizer.inject_missing_coverage"
