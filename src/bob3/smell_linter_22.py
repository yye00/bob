...
E-severity findings from detect_all_smells block ``bob3 plan --create``.

Integration with bob3.patterns: this module is the authoritative import
target for smell detection across the bob3 pipeline.
...
Usage::
    ...
    from bob3.smell_linter_22 import detect_all_smells, filter_by_severity
