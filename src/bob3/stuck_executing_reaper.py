"""Top-level stuck-executing reaper for bob3 (feature 07770ff2).
...
required by the acceptance criteria:
  ...
  - Function defined: bob3.stuck_executing_reaper.reap_stuck_executing
...
from bob3.reaper import (  # noqa: F401 — AC aliases
    detect_stuck_executing,
    reset_stuck_feature as _reset_stuck_feature_impl,
)

# AC alias: "Function defined: bob3.stuck_executing_reaper.is_subagent_alive"
is_subagent_alive = subagent_alive

# AC alias: "Function defined: bob3.stuck_executing_reaper.reset_stuck_feature"
reset_stuck_feature = _reset_stuck_feature_impl

# AC alias: "Function defined: bob3.stuck_executing_reaper.detect_stuck_features"
...
def record_reap(
    ...
    from bob3.reaper import stamp_reap_metadata  # noqa: PLC0415
...
def stamp_reap_metadata(
    ...
    "Function defined: bob3.stuck_executing_reaper.stamp_reap_metadata"

    Delegates to bob3.reaper.stamp_reap_metadata for the DB write.
...
# AC alias: "Function defined: bob3.stuck_executing_reaper.detect_and_reap_stuck_features"
detect_and_reap_stuck_features = detect_and_reset_stuck_features

# AC alias: "Function defined: bob3.stuck_executing_reaper.reap_stuck_executing_features"
# Required by feature 6a879022-4dc2-48ef-9b3d-b0dc016b5aaa
reap_stuck_executing_features = reap_stuck_executing

# AC alias: "Function defined: bob3.stuck_executing_reaper.reset_feature_status"
# Required by feature f682e8d7-36e1-4624-8fc1-ffbe83e9ea39
reset_feature_status = reset_stuck_feature

# AC alias: "Function defined: bob3.stuck_executing_reaper.reset_executing_feature"
