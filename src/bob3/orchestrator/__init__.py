...
from bob3.orchestrator.stale_bytecode_guard import check_stale_sources  # noqa: F401 — integration 74f24177
...
from bob3.synthesizer import synthesize_for_feature as _synthesize_for_feature_retry, score_gate_loop as _score_gate_loop_retry  # noqa: F401 — integration cc0fb2ad
...
def _import_transient_classifier():  # noqa: F401 — integration e7c93a06
    """Lazy integration of bob3.transient_classifier to avoid circular import."""
    from bob3.transient_classifier import classify_exit as _tc_classify_exit, spawn_with_retry as _tc_spawn_with_retry  # noqa: PLC0415, F401
...
from bob3.gpu_kernel_synthesizer import synthesize_triton_kernel, autotune_kernel_config, validate_against_cpu_reference  # noqa: F401 — integration cd10833c
...
from bob3.bootstrap_readiness import check_bootstrap_override as check_bootstrap_override_readiness  # noqa: F401 — integration 95461cc9
...
from bob3.permanent_forward_carry_auditor import validate_permanent_features  # noqa: F401 — integration 24de85cc
...
from bob3.blame_cascade import charge_breaking_features  # noqa: F401 — integration 82c7f621
...
from bob3.sticky_completed_gate import is_completion_persisted, prevent_status_downgrade  # noqa: F401 — integration ad4b6dcf
...
from bob3.gate_resynthesis import (  # noqa: F401 — integration feature 12697e5d
...
from bob3.gate_blocked_feature_recovery import (  # noqa: F401 — feature 36b33b52
...
def validate_cost_and_work_events(
    ...
    """Proxy to bob3.cost_enforcement.validate_cost_and_work_events — AC 9f2acc5b.
    ...
    Raises ValueError when per_feature_ceiling <= 0.
    """
    from bob3.cost_enforcement import validate_cost_and_work_events as _fn  # noqa: PLC0415
    return _fn(
        reported_cost=reported_cost,
        work_events=work_events,
        per_feature_ceiling=per_feature_ceiling,
...
def should_apply_max_cost_ceiling(
    ...
    """Proxy to bob3.cost_enforcement.should_apply_max_cost_ceiling — AC 9f2acc5b.
    ...
    """
    from bob3.cost_enforcement import should_apply_max_cost_ceiling as _fn  # noqa: PLC0415
    return _fn(
        reported_cost=reported_cost,
        work_events=work_events,
    )
...
def enforce_cost_ceiling(
    ...
    AC1: Function defined: bob3.orchestrator.enforce_cost_ceiling
...
def get_source_mtime(module_name: str):
    ...
    Thin façade over
    ``bob3.orchestrator.prompt_source_reloader.get_prompt_mtime`` exposed
...
def check_and_reload_prompt_sources() -> list[str]:  # noqa: F401 — integration 56a8caa4
    ...
    Delegates to :func:`bob3.hot_reload.check_and_reload_prompt_sources`.

    Returns:
        List of module names that were reloaded.  Empty when all watched
        modules are already up-to-date.
    """
    from bob3.hot_reload import check_and_reload_prompt_sources as _fn  # noqa: PLC0415
    return _fn()
...
def defer_verifier_self_extension_features(
    ...
    ``bob3.orchestrator.defer_verifier_self_extension_features`` AC contract
...
def set_database_path(db_path: pathlib.Path | str) -> pathlib.Path:
    ...
    Writes the resolved absolute path into ``BOB3_DATABASE_PATH`` so every
    subsequent :func:`bob3.db.connect` call, and every spawned sub-agent that
...
from bob3.snapshot_runner import enforce_maxfail_zero as enforce_snapshot_runner_maxfail_zero  # noqa: F401 — integration 4dd5ef9f
from bob3.snapshot_determinism import enforce_maxfail_zero as enforce_deterministic_snapshot_maxfail_zero  # noqa: F401 — integration cd782bbc
from bob3.acceptance.characterization import (  # noqa: F401 — integration BF-6 60ecdbaf
