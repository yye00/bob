...
Public API::
    ...
    from bob3.orchestrator.plan_gate import write_plan_artifact, is_approved
...
def retrigger_critic_on_edit(
    ...
    bob3.spec_quality.spec_critic.critique_feature and returns the defect list.
    ...
    from bob3.spec_quality.spec_critic import critique_feature  # local import avoids circular dep
