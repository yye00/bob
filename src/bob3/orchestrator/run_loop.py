...
from bob3 import db
from bob3.mcp_lifecycle import stop_mcp_server, sweep_orphans
...
from bob3.orchestrator.zombie_run_reaper import (
    scan_and_reap as _scan_and_reap_zombies,
)
from bob3.orchestrator.periodic_resume_scan import (  # noqa: F401 — integration AC f9f35288
    periodic_resume_scan as _periodic_resume_scan,
)
from bob3.periodic_resume_scan import (  # noqa: F401 — integration AC 6abe05be
    promote_interrupted_rows as _promote_interrupted_rows,
)
from bob3.pending_successor_verify import (  # noqa: F401 — integration AC dc709e23
    set_pending_successor_verify as _set_pending_successor_verify,
)
from bob3.mutation_testing_post_impl_quality_gate_mutmut import (  # noqa: F401 — integration AC 89226d52
    mutation_testing_post_impl_quality_gate_mutmut,
)
from bob3.run_loop_must_reap_claude_subagent_process_feature_terminal import (  # noqa: F401 — integration AC 5957b0ad
    run_loop_must_reap_claude_subagent_process_feature_terminal,
)
from bob3.claude_code_worker_leverage_enable_prompt_cache_slim_per import (  # noqa: F401 — integration AC 5b6febb0
...
from bob3.swe_bench_cheap_wins_repo_tree_failing_test_first_adaptive import (  # noqa: F401 — integration AC b9dac9b9
...
from bob3.pattern_8_integration_ac_handler_must_fall_back_function import (  # noqa: F401 — integration AC 6797d411
    pattern_8_integration_ac_handler_must_fall_back_function as _pattern_8_integration_fallback,
)
from bob3.enhanced_verification_pattern_8_integration_must_scan_all import (  # noqa: F401 — integration AC e9c44614
    enhanced_verification_pattern_8_integration_must_scan_all as _pattern_8_scan_all,
)
from bob3.orchestrator.enhanced_verification import (  # noqa: F401 — integration AC 0a898414
    verify_structural_log_line as _verify_structural_log_line,
)
from bob3.bf_3_elicitation_classifier_clarification_budget_gate import (  # noqa: F401 — integration AC 47112d92
    bf_3_elicitation_classifier_clarification_budget_gate as _bf_3_elicit_classify,
)
from bob3.bootstrap_auditor import (  # noqa: F401 — integration AC 578c0c70
...
from bob3.orchestrator.cost_projection import allow_spawn as _cost_allow_spawn
from bob3.orchestrator.concurrent_executor import run_concurrent as _run_concurrent
from bob3.orchestrator.feature_claim import claim_next_ready_feature  # noqa: F401 — atomic claim for concurrent workers (1cb15253)
from bob3.orchestrator.cost_reservation import (  # noqa: F401 — wired for concurrent budget guard (7841fb76)
...
from bob3.orchestrator.cost_telemetry_guard import (
    ...
    apply_pessimistic_cost,  # public export — AC: bob3.orchestrator.run_loop.apply_pessimistic_cost
    emit_cost_telemetry_lost_event as _emit_cost_telemetry_lost_event,
    is_cost_telemetry_lost as _is_cost_telemetry_lost,
)
from bob3.orchestrator.per_feature_ceiling import compute_per_feature_ceiling as _compute_per_feature_ceiling  # noqa: F401 — integration AC bd38ecbd
from bob3.feature_timeout_executor import execute_with_timeout as _execute_with_timeout  # noqa: F401 — integration AC 9bdba8e1
from bob3.orchestrator.sticky_completed import may_demote as _may_demote
from bob3.orchestrator.bootstrap_override import may_bypass_readiness as _may_bypass_readiness
from bob3.orchestrator.prompt_source_reloader import maybe_reload_all as _maybe_reload_prompt_sources
from bob3.orientation import update_progress_notes, wrap_prompt_with_orientation
from bob3.spec_quality.quality_score import compute_score as _compute_spec_quality_score, gate_for_ready as _spec_quality_gate_for_ready
from bob3.spec_quality.spec_critic import critique_feature as _spec_critic_critique, persist_findings as _spec_critic_persist
from bob3.orchestrator.test_writer_agent import emit_failing_tests as _emit_failing_tests, verify_bijection as _verify_test_bijection
from bob3.orchestrator.codet_triangulation import spawn_k_tests as _codet_spawn_k_tests, spawn_k_impls as _codet_spawn_k_impls
from bob3.orchestrator.rca_infra_recovery import auto_reset_if_infra as _rca_auto_reset_if_infra
from bob3.orchestrator.blame_cascade import charge_refinement as _blame_charge_refinement
...
from bob3.spec_quality.clarification_loop import run_clarification_loop as _run_clarification_loop, SPEC_NEEDS_HUMAN as _SPEC_NEEDS_HUMAN
from bob3.model_escalation import resolve_model_for_tier as _resolve_escalated_model, try_escalate as _try_model_escalate  # F-R7-633
from bob3.spec_stability import run_parallel_extractions as _run_spec_stability_check, compute_stability_score as _compute_stability_score  # noqa: F401 — integration AC 2f4a2cd8
...
from bob3.orchestrator.stale_bytecode_guard import (  # noqa: F401 — integration AC 0a2f5688
    check_stale_bytecode as _check_stale_bytecode,
)
from bob3.stuck_readiness_decomposer import (  # noqa: F401 — integration AC 7c60cae5
    check_stuck_readiness as _check_stuck_readiness,
    mark_pending_decomposition as _mark_pending_decomposition,
)
from bob3.readiness_decomposition import (  # noqa: F401 — integration AC 86da3f00
...
from bob3.ac_repair_linter import (  # noqa: F401 — integration AC 6128e116
    semantic_equivalence_check as _semantic_equivalence_check,
    auto_apply_repair as _auto_apply_repair,
)
from bob3.spec_findings_writer import (  # noqa: F401 — integration AC 6d12b5f9
    write_findings_atomically as _write_findings_atomically,
    quarantine_corrupt_findings as _quarantine_corrupt_findings,
)
from bob3.orchestrator.feature_watchdog import (  # noqa: F401 — integration AC 7d197945
    ...
    *,
    ...
    try:
        while True:
            ...
            try:
                from bob3.orchestrator.subagent_reaper import get_tracked_pid as _get_tracked_pid
...
def sweep_orphan_subagents() -> list:
    ...
    ``bob3.orchestrator.subagent_reaper``) to clean up stale terminal-state
    subagent PIDs.  Exposed as a module-level symbol so the verifier can
    confirm ``bob3.orchestrator.run_loop.sweep_orphan_subagents`` exists.
...
def _classify_failure_for_retry(
    ...
    if workspace:
        progress_path = str(
            pathlib.Path(workspace) / ".bob3" / "progress.jsonl"
        )
...
def acquire_run_lock(
    ...
    #
    # Recursive bob-on-bob caveat: when bob3 invokes its own pytest as
    ...
    # parent bob3's workspace, currently holding the run-lock. The child
    ...
    if not workspace_path.is_dir():
        ...
        if under_pytest:
            import tempfile
            fallback_dir = pathlib.Path(tempfile.gettempdir()) / f"bob3-pytest-{os.getpid()}"
...
# via BOB3_SNAPSHOT_TIMEOUT for very large suites.
...
def capture_pytest_snapshot(
    ...
    *,
    ...
    try:
        from bob3.deterministic_pytest_snapshots import enforce_maxfail_zero_snapshot as _enforce_mf
        cmd = _enforce_mf(cmd)
    except ImportError:
        try:
            from bob3.pytest_snapshot_config import enforce_maxfail_zero as _enforce_mf
            cmd = _enforce_mf(cmd)
        except ImportError:
            try:
                from bob3.deterministic_snapshot import enforce_maxfail_zero as _enforce_mf
                cmd = _enforce_mf(cmd)
            except ImportError:
                try:
                    from bob3.pytest_snapshots import enforce_maxfail_zero as _enforce_mf
                    cmd = _enforce_mf(cmd)
                except ImportError:
                    try:
                        from bob3.snapshot_determinism import enforce_maxfail_zero as _enforce_mf
                        cmd = _enforce_mf(cmd)
                    except ImportError:
                        try:
                            from bob3.snapshot_enforcement import enforce_maxfail_for_snapshots as _enforce_mf
                            cmd = _enforce_mf(cmd)
                        except ImportError:
                            try:
                                from bob3.snapshot_pytest import enforce_maxfail_zero as _enforce_mf
                                cmd = _enforce_mf(cmd)
                            except ImportError:
                                try:
...
def decay_confidence_components(feature_id: str, decay: float | None = None) -> "Feature | None":
    ...
    bob3.readiness.derive_readiness_score from the current component values).
    ...
    Args:
        ...
        decay: Amount to subtract from each component (floored at 0.0).
               When None, reads BOB3_CONFIDENCE_DECAY_PER_FAILURE env var
               (default 0.15).
...
def _verify_project_name_matches_workspace(
    ...
    ``bob3 init``, the projects row retains the parent's name (e.g. 'bob9')
    ...
    from bob3.db import get_connection as _get_conn
...
class OrchestrationLoop:
    ...
    def _cost_projection_gate(self, feature: Feature) -> "SpawnResult | None":
        ...
        Set ``BOB3_COST_PROJECTION_GATE=0`` to bypass the gate (only
        ...
        if os.environ.get("BOB3_COST_PROJECTION_GATE", "1") == "0":
            return None
    ...
    def _maybe_resynthesize_blocked(self, feature_obj) -> "tuple[list[str] | None, float]":
        ...
        try:
            ...
            from bob3.synthesizer import score_gate_loop, synthesize_for_feature
    ...
    async def _run_evaluator(
        ...
        *,
        ...
        evaluator_timeout = float(
            os.environ.get("BOB3_EVALUATOR_TIMEOUT_SECONDS", "600")
        )
    ...
    def _file_evaluator_rejection_finding(
        ...
        *,
        ...
        """
        try:
            from bob3 import reviews as _reviews
    ...
    async def execute_feature(self, feature: Feature) -> SpawnResult:
        ...
        if cost_recorded == 0.0 and self.workspace:
            _progress_path = (
                pathlib.Path(self.workspace) / ".bob3" / "progress.jsonl"
            )
            _work_events, _ = _count_work_events(_progress_path)
            # F-R7-585 (bob3 version 17 r1): the project-level max_cost_usd
            ...
            # ceiling (env BOB3_PER_FEATURE_COST_CEILING, default $20 —
            # matches the empirical p95 of real per-feature costs observed
            # in bob3 v.16/17 runs).
        ...
        if result.is_error:
            if self.shutdown_requested:
                ...
                # ``.bob3/progress.jsonl`` for real evidence that the
                ...
                if crash_kind["kind"] == "spawn_failure":
                    ...
                    try:
                        ...
                        _ec_dir = pathlib.Path(self.workspace) / ".bob3_startup_exempt"
                        ...
                        # in this chain the bob3 src tree is the build target and
    ...
    async def execute_feature_with_timeout(
        ...
        *,
        ...
        Wraps ``execute_feature`` with :func:`bob3.timeout.enforce_wall_clock_timeout`
        so that a single hung feature cannot block the orchestration loop
        indefinitely.  The timeout is read from ``BOB3_FEATURE_TIMEOUT_SECONDS``
        (default 1800 s) unless *timeout_seconds* is given explicitly.

        When the timeout fires:
        - A TIMEOUT telemetry event (WARNING log) is emitted.
        - :class:`bob3.timeout.FeatureTimeoutError` is raised.
        ...
        Raises:
            bob3.timeout.FeatureTimeoutError: When execution exceeds the timeout.
        """
        from bob3.timeout import enforce_wall_clock_timeout
    ...
    def _recover_orphaned_pending_features(self) -> None:
        ...
        for fid in all_ids:
            ...
            # promotion. Gate it behind BOB3_PREPROMOTE_TESTPREP (default off);
            # the 0.85 spec-quality gate above is unchanged and still enforced.
            _testprep = os.environ.get("BOB3_PREPROMOTE_TESTPREP", "").strip().lower() in ("1", "true", "yes", "on")
            ...
            if ac_list:
                try:
                    _ci_mode = os.environ.get("BOB3_CI_MODE", "").strip().lower() in ("1", "true", "yes", "on")
    ...
    async def _run_locked(self) -> LoopTermination:
        ...
        # In Round 5 we accumulated 59 orphan bob3.memory_mcp processes
...
#
# Introduce BOB3_MAX_CONCURRENT_FEATURES (default 3) and three
...
def _resolve_max_concurrent_features() -> int:
    """Read ``BOB3_MAX_CONCURRENT_FEATURES`` from the environment.
...
def dispatch_up_to_concurrency(
    ...
    *,
    ...
    Returns:
        List of :class:`~bob3.models.Feature` objects that were
...
async def gather_completed_dispatches(
    ...
    :func:`~bob3.orchestrator.concurrent_executor.run_concurrent`.
...
def periodic_resume_scan(project_id: str) -> list[str]:
    ...
    Delegates to :func:`bob3.orchestrator.periodic_resume_scan.periodic_resume_scan`
    so that the function is accessible as ``bob3.orchestrator.run_loop.periodic_resume_scan``.
...
async def dispatch_concurrent_features(
    ...
    *,
    ...
    Returns:
        List of result dicts (see :func:`~bob3.orchestrator.concurrent_executor.run_concurrent`),
