...
3. The estimated budget defaults to the historical p75 cost per feature in
   ...
   :mod:`bob3.orchestrator.cost_projection` (the F-R6-307 estimator).
...
from bob3.orchestrator.cost_projection import project_feature_cost
...
def reserve_budget(
    ...
    *,
    ...
    Args:
        ...
        project_id: The bob3 project this feature belongs to.
    ...
    try:
        ...
        from bob3.orchestrator.cost_projection import DEFAULT_FALLBACK_ESTIMATE_USD
