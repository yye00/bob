...
Modules covered:
- bob3.superpowers  — VERIFICATION_PROMPT_SECTION / SKILLS_PROMPT_SECTION
- bob3.models       — Feature / Project field definitions (verifier cache issue)
"""
...
def reload_models_if_stale() -> bool:
    """Hot-reload bob3.models if the source file has changed.

    Extends the scope of the reloader to cover the bob3.models module,
    ...
    miss fields added in a recent patch (bob3 v.13 r10 cached-Feature-fields
    defect).

    Returns True if a reload was performed, False otherwise.
    """
    return reload_if_stale("bob3.models")
