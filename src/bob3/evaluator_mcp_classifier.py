...
implementation lives in :mod:`bob3.run_loop` as
:func:`~bob3.run_loop.classify_evaluator_mcp_transient`; this module
re-exports it under the canonical name expected by the AC.
"""

from __future__ import annotations

from bob3.run_loop import classify_evaluator_mcp_transient as classify_mcp_transient
