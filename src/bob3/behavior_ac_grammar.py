...
strings from a :class:`~bob3.spec_quality.contract_grammar.ContractSpec`.
...
def codegen_icontract_decorators(spec: ContractSpec) -> str:
    ...
    Delegates to :func:`~bob3.spec_quality.contract_grammar.emit_icontract_decorators`.
    ...
    Args:
        spec: A parsed :class:`~bob3.spec_quality.contract_grammar.ContractSpec`.
