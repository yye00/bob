...
def is_mcp_transient(stderr: str | None) -> bool:
    ...
    AC: "Function defined: bob3.retry_classifier.is_mcp_transient".
...
def classify_evaluator_mcp_transient(
    *,
    ...
    AC: "Function defined: bob3.retry_classifier.classify_evaluator_mcp_transient".
    Delegates to :func:`bob3.run_loop.classify_evaluator_mcp_transient`.
    ...
    """
    from bob3.run_loop import classify_evaluator_mcp_transient as _classify
    return _classify(
        verdict=verdict,
        confidence=confidence,
        is_error=is_error,
...
def is_mcp_transient_failure(stderr: str | None) -> bool:
    ...
    AC: "Function defined: bob3.retry_classifier.is_mcp_transient_failure".
