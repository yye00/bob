...
Integration with bob3.linter::
    ...
    from bob3.auto_repair import apply_auto_repair
...
def apply_auto_repair(
    ...
    Integrates with bob3.linter: pass SmellFinding objects (or their dict equivalents)
    produced by ``bob3.linter.detect_smells`` as the ``findings`` parameter.
    ...
    if auto_repair:
        for raw_finding in findings:
            # Accept both dicts and namedtuple/dataclass objects (bob3.linter SmellFinding)
