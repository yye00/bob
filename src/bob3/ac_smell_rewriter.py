...
Public API::
    ...
    from bob3.ac_smell_rewriter import apply_suggested_rewrite, verify_semantic_equivalence
...
def apply_suggested_rewrite(
    ...
    *,
    ...
    ----------
    finding:
        A :class:`~bob3.spec_quality.smell_detectors.SmellFinding` produced by
        the smell detector.
    auto_repair:
