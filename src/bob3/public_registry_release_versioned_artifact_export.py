...
def export_public_registry(
    ...
    *,
    ...
    Args:
        ...
        bob_version: Bob3 version string to embed. Defaults to bob3.__version__.
...
def _resolve_findings_path(findings_path: str | Path | None) -> Path:
    ...
    raise FileNotFoundError(
        "Could not locate reviews/findings.yaml by walking up from the bob3 package. "
