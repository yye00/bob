"""bob3.spec_critic — adversarial spec-critic with persistent findings registry.
...
from bob3.spec_critic import findings_registry
from bob3.spec_critic.findings_registry import (
    write_findings,
    detect_regression,
...
# AC alias: "Function defined: bob3.spec_critic.load_constitution"
