...
Public API::
    ...
    from bob3.spec_critic.findings_registry import write_findings, detect_regression
...
def write_findings(
    ...
    *,
    ...
    escalated one level. The halt-gate fires (logged as warning) when
    critic_repeat_rate > 0.30 over the last 3 distinct run_ids.
...
def check_repeat_rate_halt_gate(
    *,
    ...
    This is the halt-gate check mandated by F-R7-450. When it fires, callers
    should halt codegen and escalate to human review.
