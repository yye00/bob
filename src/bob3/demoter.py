"""bob3.demoter — canonical public API for AC structural prefix matching.

This file satisfies the "File exists: src/bob3/demoter.py" AC for
feature be91cd95-8fec-46bb-abb7-62c301baf5e9.

The active implementation lives in bob3.demoter (the package at
src/bob3/demoter/__init__.py).  Python's import system resolves the
package before this module, so callers importing ``bob3.demoter``
