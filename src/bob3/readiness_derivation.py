"""Readiness derivation facade for bob3.
...
def compute_readiness_score(
    *,
    ...
    Satisfies AC: 'Function defined: bob3.readiness_derivation.compute_readiness_score'.
...
def derive_readiness_from_confidence(
    *,
    ...
    'Function defined: bob3.readiness_derivation.derive_readiness_from_confidence'.
