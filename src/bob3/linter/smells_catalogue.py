"""22-smell catalogue module for bob3.linter (F-R7-410 full extension).
...
Public API::
    ...
    from bob3.linter.smells_catalogue import detect_all_smells, filter_by_severity
...
def detect_all_smells(
    ...
    Examples
    --------
    >>> from bob3.linter.smells_catalogue import detect_all_smells
    >>> findings = detect_all_smells("The system shall be fast and simple.")
