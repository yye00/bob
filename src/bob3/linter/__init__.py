"""Public linter API for Bob3 spec quality checks.
...
Public API::
    ...
    from bob3.linter import detect_smells, SmellFinding, blocks_plan_create
...
from bob3.coverage_detector import detect_boundary_error_coverage  # noqa: F401 — integration: bob3.linter
from bob3.coverage_detector import detect_boundary_and_error_coverage  # noqa: F401 — integration: bob3.linter
from bob3.linter.auto_repair import apply_semantic_equivalence_check, should_auto_repair
from bob3.linter_ac_repair import auto_repair_ac, semantic_equivalence_check  # noqa: F401 — integration: bob3.linter

# apply_auto_repair: canonical entry point for AC3 (bob3.linter.apply_auto_repair)
...
def lint_code(
    ...
    E-severity findings block ``bob3 plan --create``.
