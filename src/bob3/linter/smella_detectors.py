"""22-smell detector catalogue for bob3.linter (F-R7-410 extension).

Provides the ``detect_all_smells`` entry point that wraps the canonical
22-detector engine from ``bob3.spec_quality.smell_detectors``.
...
Public API::
    ...
    from bob3.linter.smella_detectors import detect_all_smells
