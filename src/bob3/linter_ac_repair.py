"""AC repair with semantic-equivalence verification, integrated with bob3.linter.
...
Public API::
    ...
    from bob3.linter_ac_repair import semantic_equivalence_check, auto_repair_ac
...
Integration with bob3.linter::
    ...
    from bob3.linter_ac_repair import auto_repair_ac
