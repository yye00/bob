"""Pre-plan quality gates for the `bob3 plan` command.
...
5. Full 22-smell linter (bob3.linter): Femmer/Smella + 2025 LLM-extension
...
from bob3.orchestrator.spawn_retry import classify_exit, spawn_with_retry  # noqa: F401 — integration wiring
...
from bob3.linter import detect_smells, blocks_plan_create as _blocks_plan_create
