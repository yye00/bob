...
Public facade over ``bob3.orchestrator.test_writer_agent``.  Provides
...
def emit_failing_test(
    ...
    *,
    ...
    Public facade over ``bob3.orchestrator.test_writer_agent.emit_failing_test``.
...
def generate_failing_tests(
    ...
    *,
    ...
    ``bob3.orchestrator.test_writer_agent``:
