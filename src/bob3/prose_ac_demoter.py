"""bob3.prose_ac_demoter — Prose-AC and integration-AC demoter (F-R7-578).
...
Root-cause fix for the defect documented in F-R7-578:
  ...
  - This module delegates to bob3.verification.structural_prefix_match which uses
...
adding tokens to bob3.prose_connector_registry, not here.
