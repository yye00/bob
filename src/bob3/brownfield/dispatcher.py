...
AC: integration: bob3.brownfield.dispatcher

This module wires the BF-3 elicitation classifier + clarification-budget gate
into the bob3 orchestrator dispatch loop. It provides the canonical entry point
    ...
    *,
    ...
    Args:
        ...
        is_headless:  True when running under ``claude -p`` (headless mode).
                      ...
                      for interactive ``bob3 init`` shell.
