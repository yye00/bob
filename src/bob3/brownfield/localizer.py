...
#: AC-required: bob3.brownfield.localizer.localize_intent
localize_intent = localize

#: AC-required: bob3.brownfield.localizer.localize_feature
localize_feature = localize

#: AC-required: bob3.brownfield.localizer.rank_files_by_relevance
rank_files_by_relevance = _shortlist_files

#: AC-required: bob3.brownfield.localizer.rank_symbols_by_relevance
...
#: AC-required: bob3.brownfield.localizer.check_disjoint_write_surfaces
...
# ---------------------------------------------------------------------------
# Localizer class (AC: bob3.brownfield.localizer.Localizer)
# ---------------------------------------------------------------------------
