...
under the bob3.brownfield.multi_candidate namespace, as required by
...
def spawn_worker_candidates(
    ...
    *,
    ...
    bob3.brownfield.multi_candidate.spawn_worker_candidates'.
...
def filter_regression_breaking(
    ...
    AC-required entry point: 'Function defined:
    bob3.brownfield.multi_candidate.filter_regression_breaking'.
...
def rank_by_judge_vote(
    ...
    *,
    ...
    AC-required entry point: 'Function defined:
    bob3.brownfield.multi_candidate.rank_by_judge_vote'.
