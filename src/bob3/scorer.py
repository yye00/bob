"""bob3.scorer — thin wrapper re-exporting scorer helpers from tools.spec_quality_score.

The AC ``Function defined: bob3.scorer.filter_code_shaped_surfaces`` requires
...
stable importable alias so other bob3 sub-modules do not depend on the
``tools`` package path.
"""
