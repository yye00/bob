...
description: Use when stuck on a feature due to a knowledge gap — unfamiliar library API, unknown domain concept, conflicting documentation, or numerical method whose details you don't fully remember. Bob3 sub-agents have Perplexity MCP tools for web-grounded research; use them instead of guessing.
---
...
Bob3 provides Perplexity MCP tools for web-grounded research that return live, cited results. Use them.
...
1. `memory_search("<domain term>", pool="facts")` — does bob3 already know this?
