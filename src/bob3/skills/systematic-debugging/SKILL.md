...
Bob3 runs a RCA (root cause analysis) sub-agent for persistent failures, and it costs real money. A disciplined first-pass debug by you saves both the RCA cost and a wrong "fix" that masks the real issue.
...
memory_add(
    content=(
        "Bug: bob3 run_loop was marking features completed before verification. "
