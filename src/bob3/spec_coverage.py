"""Bidirectional Requirements Traceability Matrix (RTM) — bob3.spec_coverage.
...
under the bob3.spec_coverage namespace required by the AC.
"""
...
def generate_rtm_json(
    ...
    *,
    ...
    AC-required entry point on bob3.spec_coverage namespace.
