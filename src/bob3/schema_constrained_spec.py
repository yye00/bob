...
:func:`bob3.spec_critic.critique_spec` to gate codegen on spec quality.

Public API::

    from bob3.schema_constrained_spec import (
...
import bob3.spec_critic  # noqa: F401 — integration: validated specs feed into spec_critic

logger = logging.getLogger(__name__)

# Default schema path — resolved relative to the workspace root.
# __file__ = src/bob3/schema_constrained_spec.py → 3 parents up = workspace root
