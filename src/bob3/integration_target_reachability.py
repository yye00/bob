"""bob3.integration_target_reachability — Integration-target reachability check at spec-load time.
...
from bob3.spec_quality.integration_reachability import ReachabilityResult, check_spec, resolve_target
