"""DB inheritance module for bob3 — public API for parent-gen provenance at seed time.
...
:mod:`bob3.parent_gen_db_inheritance` so the acceptance criteria
``bob3.db_inheritance.inherit_parent_metadata`` resolves correctly.
"""

from __future__ import annotations

from bob3.parent_gen_db_inheritance import (  # noqa: F401
    ParentFeatureRow,
    StampResult,
