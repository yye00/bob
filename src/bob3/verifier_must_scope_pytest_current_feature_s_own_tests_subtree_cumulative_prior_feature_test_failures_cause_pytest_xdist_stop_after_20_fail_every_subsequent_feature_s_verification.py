...
Public API
----------
verifier_must_scope_pytest_current_feature_s_own_tests_subtree_cumulative_prior_feature_test_failures_cause_pytest_xdist_stop_after_20_fail_every_subsequent_feature_s_verification(feature_id, acs, workspace)
    ...
    :mod:`bob3.verification.per_feature_test_scope`.
"""
...
__all__ = [
    ...
    "verifier_must_scope_pytest_current_feature_s_own_tests_subtree_cumulative_prior_feature_test_failures_cause_pytest_xdist_stop_after_20_fail_every_subsequent_feature_s_verification",
]


def verifier_must_scope_pytest_current_feature_s_own_tests_subtree_cumulative_prior_feature_test_failures_cause_pytest_xdist_stop_after_20_fail_every_subsequent_feature_s_verification(
    feature_id: str,
    acs: list[str],
    workspace: str | Path,
) -> list[str]:
