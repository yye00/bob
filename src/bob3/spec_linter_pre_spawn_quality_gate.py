...
from bob3.ears import EARSClauseKind, extract_ears_clauses
...
def file_warnings_to_registry(
    ...
    *,
    ...
    Uses :mod:`bob3.reviews` if available; falls back to a minimal YAML
    ...
    try:
        ...
        if registry_path is None:
            try:
                from bob3.reviews import _registry_path
