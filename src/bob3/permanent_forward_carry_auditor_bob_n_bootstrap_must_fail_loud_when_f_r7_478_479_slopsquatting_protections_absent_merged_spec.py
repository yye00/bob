"""Permanent-forward-carry auditor — bob_N bootstrap MUST fail-loud when
...
module, satisfying the AC:
  ...
  Function defined:
    bob3.permanent_forward_carry_auditor_bob_n_bootstrap_must_fail_loud_when_\
...
__all__ = [
    ...
    "extract_canonical_ids",
    "fail_loud_on_missing",
    "permanent_forward_carry_auditor_bob_n_bootstrap_must_fail_loud_when_f_r7_478_479_slopsquatting_protections_absent_merged_spec",
    "required_feature_ids",
]


def permanent_forward_carry_auditor_bob_n_bootstrap_must_fail_loud_when_f_r7_478_479_slopsquatting_protections_absent_merged_spec(
    spec: dict[str, Any],
) -> None:
