...
def decay_confidence_after_failure(feature_id: str) -> object:
    ...
    Public entry point satisfying AC 'Function defined: bob3.confidence.decay_confidence_after_failure'.
    ...
    """
    from bob3.orchestrator.run_loop import decay_confidence_components
