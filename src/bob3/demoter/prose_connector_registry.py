"""Prose connector registry for AC demotion — bob3 demoter package.
...
from bob3.verification.structural_prefix_match import prose_connector_registry as _registry
