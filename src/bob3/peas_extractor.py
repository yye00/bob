...
``bob3.peas_extractor.extract_from_peas``. Delegates to the full pipeline
in ``bob3.extract_from_peas``.

AC: "File exists: src/bob3/peas_extractor.py"
AC: "Function defined: bob3.peas_extractor.extract_from_peas"
"""
