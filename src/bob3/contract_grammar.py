...
Exposes the core lambda-binding functions from bob3.spec_quality.contract_grammar
and bob3.spec_quality.contract_grammar_lambda_binder at the bob3.contract_grammar
namespace, satisfying the AC requirement for:
    Function defined: bob3.contract_grammar.validate_lambda_binding
...
public API at the bob3 top level.
"""
