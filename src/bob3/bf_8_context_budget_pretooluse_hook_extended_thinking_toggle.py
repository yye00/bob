...
Part A — Context-budget hook:
  ...
  public API so bob3 internals can import it without path gymnastics and so
...
Integration:
  ...
  - bob3.claude_md_sanitizer: sanitize_for_claude_md is imported and
    re-exported here for use in hook output.
  - bob3.subagent_reaper: reap_subagent_for_feature is imported and
...
from bob3.claude_md_sanitizer import sanitize_for_claude_md  # noqa: E402

# ---------------------------------------------------------------------------
# Integration: subagent_reaper
# ---------------------------------------------------------------------------

from bob3.subagent_reaper import (  # noqa: E402
...
def bf_8_context_budget_pretooluse_hook_extended_thinking_toggle() -> str:
    """Entry-point sentinel satisfying the 'Function defined: bob3.bf_8_...' AC.
