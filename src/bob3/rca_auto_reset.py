...
``bob3.rca_auto_reset.should_grant_fresh_attempt_budget`` to decide whether a
...
# AC-required canonical name: bob3.rca_auto_reset.grant_fresh_attempt_on_code_defect
grant_fresh_attempt_on_code_defect = auto_reset_on_code_defect

# AC-required canonical name: bob3.rca_auto_reset.should_grant_fresh_budget
