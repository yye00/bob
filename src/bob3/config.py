"""bob3.config — Central configuration resolver for Bob3.
...
See ``bob3.cost_config.resolve_max_cost_usd`` for the low-level resolver.
"""
...
def get_max_cost_usd() -> float:
    ...
    Reads ``BOB3_MAX_COST_USD`` from the environment.  An absent, empty,
