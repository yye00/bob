...
Problem
-------
bob3 version 14 stored readiness_score as decaying state: every call to
...
2. Re-exports of :func:`~bob3.readiness.derive_readiness_score` and
   :func:`~bob3.run_loop.seed_readiness_at_iteration_start` for callers that
...
from bob3.readiness import derive_readiness_score, calculate_readiness_live
...
def readiness_score_must_rederived_current_confidence_components(
    *,
    ...
    :func:`bob3.readiness.derive_readiness_score`, which computes
