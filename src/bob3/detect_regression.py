"""Top-level bob3.detect_regression module.
...
- ``detect_regression_with_evidence``: evidence-gated regression detection —
  ...
  bob3.regression.ownership_detector).
- ``has_ownership_evidence``: check causal link for a candidate feature
  (re-exported from bob3.regression.ownership_detector).
...
from bob3.regression_attribution import (
    detect_regression as _detect_regression,
    get_feature_owned_tests,
)
from bob3.regression.ownership_detector import (  # noqa: F401 — integration a166a32e
    has_ownership_evidence,
    detect_regression_with_evidence,
)
from bob3.regression_ownership import (  # noqa: F401 — integration c68b3042
    validate_ownership_link,
    detect_regression_with_evidence as _detect_regression_with_evidence_ownership,
)
from bob3.ownership_evidenced_regression import (  # noqa: F401 — integration 50afa15a
