...
Integration: bob3.orchestrator calls ``should_trigger_decomposition`` before
re-queuing a feature and ``mark_pending_decomposition`` when the trigger fires.
"""
...
def should_trigger_decomposition(
    ...
    *,
    ...
    """Alias for should_decompose — retained for backward compatibility."""
    return should_decompose(feature, previous_readiness_score=previous_readiness_score)
