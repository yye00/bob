...
Usage:
    ...
    upgrade(db_path="/path/to/bob3.db")                          # column only
    upgrade(db_path="/path/to/bob3.db", spec_path="spec.yaml")   # + backfill
"""
...
def upgrade(
    *,
    ...
    Args:
        db_path: Path to the SQLite database. Defaults to the BOB3_DATABASE_PATH
                 env var or ./bob3.db.
