...
bob3.agents integration layer to decide whether extended thinking should
...
def classify_extended_thinking(
    *,
    ...
    This is the primary entry point for the bob3.agents integration layer.
...
# AC alias: "Function defined: bob3.extended_thinking_classifier.classify_thinking_mode"
