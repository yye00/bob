"""bob3.mutmut_gate_cli — CLI entry-point for the mutmut-gate command.

Usage
-----
    mutmut-gate --feature-id FEATURE_ID --src SRC_FILE [--src SRC_FILE ...] \\
...
@click.command(name="mutmut-gate")
