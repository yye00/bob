...
but can be overridden via the BOB3_SKILL_LIBRARY_EMBED_MODEL env var.
"""
...
_ENV_VAR = "BOB3_SKILL_LIBRARY_EMBED_MODEL"
...
def load_from_env() -> str:
    """Return the embedding backend name, honouring BOB3_SKILL_LIBRARY_EMBED_MODEL.

    Returns:
        Value of env var BOB3_SKILL_LIBRARY_EMBED_MODEL if set, else default_backend().
    """
