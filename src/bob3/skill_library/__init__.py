...
def write_shim(
    ...
    AC-required function: bob3.skill_library.write_shim.
...
def write_to_library(
    ...
    """AC-required function: bob3.skill_library.write_to_library.
...
def search_skill_library(
    ...
    AC-required function: bob3.skill_library.search_skill_library.
...
def persist_skill_to_library(
    ...
    AC-required function: bob3.skill_library.persist_skill_to_library.
