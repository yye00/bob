...
VERIFIER_EXTENSION_MODULES: tuple[str, ...] = (
    ...
    "src/bob3/verification/prose_ac_demotion.py",
    "src/bob3/verification/integration_ac_resolver.py",
    "src/bob3/verification/ac_artifact_check.py",
    "src/bob3/verification/class_defined_ac_check.py",
    "src/bob3/verification/mutation_gate.py",
    "src/bob3/verification/per_feature_test_scope.py",
    "src/bob3/verification/regression_attribution.py",
)
