...
Reads BOB3_SPEC_QUALITY_THRESHOLD from the environment on every call so that
...
Escape hatch: set BOB3_SPEC_QUALITY_THRESHOLD_FROZEN=<value> to pin the
...
def resolve_spec_quality_threshold() -> float:
    ...
    (unless BOB3_SPEC_QUALITY_THRESHOLD_FROZEN is set, in which case the
    ...
    Unparseable or absent BOB3_SPEC_QUALITY_THRESHOLD fall back to 0.85.
    ...
    frozen_raw = os.environ.get("BOB3_SPEC_QUALITY_THRESHOLD_FROZEN")
