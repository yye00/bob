...
def exempt_counter(feature_id: str, *, db_path: str | os.PathLike[str] | None = None) -> int:
    ...
    db_path:
        ...
        defaults to a ``.bob3_startup_exempt`` directory in the current
        working directory.
    ...
    sidecar_dir = Path(db_path) if db_path is not None else Path(".bob3_startup_exempt")
...
def classify_startup_crash(
    *,
    ...
    AC: ``Function defined: bob3.startup_crash_exempt.classify_startup_crash``
...
def check_startup_crash_exemption(
    *,
    ...
    AC: ``Function defined: bob3.startup_crash_exempt.check_startup_crash_exemption``
...
# Alias required by AC: "Function defined: bob3.startup_crash_exempt.exempt_from_retry_budget"
exempt_from_retry_budget = should_exempt_from_retry

# Alias required by AC: "Function defined: bob3.startup_crash_exempt.get_exempt_count"
get_exempt_count = exempt_counter

# Alias required by AC: "Function defined: bob3.startup_crash_exempt.calculate_backoff"
