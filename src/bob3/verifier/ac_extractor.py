...
Enforces the AC discipline rule (companion to F-R7-592): features whose primary
diff target includes a VERIFIER_EXTENSION_MODULES path MUST NOT express behavior
ACs at spec-extraction time. The running verifier cannot check patterns it does
not yet know.
...
Public entry point: reject_behavior_ac_for_verifier_extensions()
"""
...
def reject_behavior_ac_for_verifier_extensions(
