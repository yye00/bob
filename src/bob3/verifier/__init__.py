"""Bob3 verifier sub-package."""

from bob3.behavior_criteria import (  # noqa: F401
    EARSBehaviorCriterion,
    parse_behavior_criteria,
)
from bob3.mutation_testing import (  # noqa: F401
    MUTATION_SCORE_THRESHOLD,
    run_mutation_tests,
)
from bob3.mutation_gate import (  # noqa: F401 — mutation_gate verifier integration
    check_mutation_score,
    run_mutation_testing,
)
from bob3.enhanced_verification import extract_and_verify_literals  # noqa: F401
from bob3.enhanced_verification import extract_and_verify_literal_strings  # noqa: F401
from bob3.enhanced_verification import extract_and_verify_substring_ac  # noqa: F401
from bob3.enhanced_verification import extract_behavior_ac_literals  # noqa: F401
from bob3.enhanced_verification import verify_behavior_ac_with_substring_grep  # noqa: F401
from bob3.enhanced_verification import verify_quoted_substring  # noqa: F401
from bob3.enhanced_verification import verify_quoted_substring_ac  # noqa: F401
from bob3.behavior_ac_verifier import verify_quoted_substring_ac as _bav_verify_quoted_substring_ac  # noqa: F401
from bob3.verifier.feature_test_scoper import (  # noqa: F401
...
from bob3.verifier.pytest_scoping import (  # noqa: F401
    ScopedPytestResult,
    ScopedPytestSkipped,
    build_scoped_argv,
...
from bob3.patterns.pattern_9_shell_handler import demote_shell_script_ac  # noqa: F401
from bob3.verifier.pattern9_shell_integration import (  # noqa: F401 — F-R7-594 Pattern 9
    is_shell_script_integration,
    demote_to_pass_with_warning,
)
from bob3.verifier.shell_script_ac import handle_shell_script_ac as check_shell_script_integration  # noqa: F401
from bob3.verifier.shell_script_ac import handle_shell_script_ac as demote_shell_script_integration_ac  # noqa: F401
from bob3.verifier.shell_script_ac import handle_shell_script_ac as pattern9_shell_script_handler  # noqa: F401 — F-R7-594 Pattern 9 canonical name
from bob.baseline_gate import CollectionResult, validate_collection  # noqa: F401
from bob3.verifier.baseline_gate import (  # noqa: F401
    BaselineUnstableError,
    abort_on_collection_failure,
    should_abort_on_collection_failure,
)
from bob3.baseline_gate import check_baseline_collection  # noqa: F401
from bob3.baseline_gate import validate_baseline_collection  # noqa: F401
from bob3.stable_baseline_gate import enforce_stable_baseline_gate  # noqa: F401
from bob3.snapshot_determinism import enforce_maxfail_zero  # noqa: F401


def walk_ac_table(*args, **kwargs):  # noqa: F401 — regression cascade integration (lazy to avoid circular import)
    """Lazy proxy to bob3.regression_cascade.walk_ac_table."""
    from bob3.regression_cascade import walk_ac_table as _fn  # noqa: PLC0415
    return _fn(*args, **kwargs)


def charge_feature_by_test_ownership(*args, **kwargs):  # noqa: F401 — regression cascade integration (lazy)
    """Lazy proxy to bob3.regression_cascade.charge_feature_by_test_ownership."""
    from bob3.regression_cascade import charge_feature_by_test_ownership as _fn  # noqa: PLC0415
    return _fn(*args, **kwargs)


def RegressionCascadeOrphanTestError(*args, **kwargs):  # noqa: F401 — regression cascade OrphanTestError (lazy)
    """Lazy proxy to bob3.regression_cascade.OrphanTestError."""
    from bob3.regression_cascade import OrphanTestError  # noqa: PLC0415
...
def generate_kxk_matrix(*args, **kwargs):  # noqa: F401 — codet_triangulation integration (lazy to avoid circular import)
    """Lazy proxy to bob3.codet_triangulation.generate_kxk_matrix."""
...
def mutual_agreement_scorer(*args, **kwargs):  # noqa: F401 — codet_triangulation integration (lazy)
    """Lazy proxy to bob3.codet_triangulation.mutual_agreement_scorer."""
...
def score_kxk_matrix(*args, **kwargs):  # noqa: F401 — codet_triangulation integration (lazy)
    """Lazy proxy to bob3.codet_triangulation.score_kxk_matrix."""
...
def spawn_candidate_implementations(*args, **kwargs):  # noqa: F401 — codet_triangulation integration (lazy)
    """Lazy proxy to bob3.codet_triangulation.spawn_candidate_implementations."""
    from bob3.codet_triangulation import spawn_candidate_implementations as _fn  # noqa: PLC0415
    return _fn(*args, **kwargs)


def spawn_candidate_tests(*args, **kwargs):  # noqa: F401 — codet_triangulation integration (lazy)
    """Lazy proxy to bob3.codet_triangulation.spawn_candidate_tests."""
    from bob3.codet_triangulation import spawn_candidate_tests as _fn  # noqa: PLC0415
    return _fn(*args, **kwargs)
...
def run_property_test(prop: "PropertyAC", *, seed: int = 0) -> tuple[bool, str]:
    ...
    Args:
        prop: A :class:`~bob3.spec_quality.example_grammar.PropertyAC` parsed
    ...
    with tempfile.NamedTemporaryFile(
        mode="w", suffix=".py", prefix="bob3_prop_test_", delete=False
    ) as f:
        f.write(full_source)
        tmp_path = f.name
...
def run_key_example_test(
    ...
    *,
    ...
    Args:
        examples: List of :class:`~bob3.spec_quality.example_grammar.KeyExample`
    ...
    with tempfile.NamedTemporaryFile(
        mode="w", suffix=".py", prefix="bob3_key_test_", delete=False
    ) as f:
        f.write(full_source)
        tmp_path = f.name
...
def verify_behavior_ac(ac: str) -> EARSBehaviorCriterion | None:
    ...
    Uses :func:`bob3.behavior_criteria.parse_behavior_criteria` to parse
    *ac* into an :class:`EARSBehaviorCriterion`. Returns ``None`` for
    non-behavior ACs. Raises :exc:`ValueError` for malformed behavior ACs.

    This is the canonical integration point in ``bob3.verifier`` for the
