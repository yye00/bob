"""Bob3 verifier snapshot — deterministic before/after test snapshots.

Wraps :func:`bob3.orchestrator.run_loop.capture_pytest_snapshot` and
...
def capture(
    ...
    *,
    ...
    Delegates to :func:`bob3.orchestrator.run_loop.capture_pytest_snapshot`,
