"""Per-feature wall-clock timeout manager for bob3 (feature 82111543).

Provides :class:`TimeoutManager` — a thin façade over :mod:`bob3.timeout`
...
--------------------
``BOB3_FEATURE_TIMEOUT_SECONDS`` (float, seconds) — hard deadline per feature
