"""bob3.decomposition — stuck-readiness decomposition trigger.
...
def create_sub_features(
    ...
    *,
    ...
    Uses ``bob3.db.create_child_feature`` to persist each child. Raises
    ...
    from bob3.db import create_child_feature  # deferred to avoid circular import
...
def spawn_sub_features(
    ...
    *,
    ...
    Satisfies AC: 'Function defined: bob3.decomposition.spawn_sub_features'
