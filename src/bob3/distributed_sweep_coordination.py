...
from bob3.sweep_orchestrator import SweepPlan, SweepResult, SweepRun
...
class RedisWorkQueue:
    ...
    def __init__(self, client: Any, queue_name: str = "bob3_sweep") -> None:
        self._client = client
