...
def check_pending_decomposition(
    ...
    *,
    ...
    Satisfies AC: 'Function defined: bob3.readiness.check_pending_decomposition'

    Delegates to bob3.stuck_readiness_decomposer.check_stuck_readiness which
    ...
    """
    from bob3.stuck_readiness_decomposer import check_stuck_readiness
...
def seed_readiness_for_ready_features(project_id: str) -> int:
    ...
    'Function defined: bob3.readiness.seed_readiness_for_ready_features'.
