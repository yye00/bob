"""bob3.transient_classifier — canonical transient-error classification module.

Satisfies ACs:
  - File exists: src/bob3/transient_classifier.py
  - Function defined: bob3.transient_classifier.classify_exit
  - Function defined: bob3.transient_classifier.spawn_with_retry
