"""bob.baseline_gate — stable baseline gate for the verifier.

Re-exports :func:`validate_collection` and :class:`CollectionResult` from
:mod:`bob.baseline_gate` so callers can import from the canonical bob
...
import bob.patterns  # noqa: F401 — integration: bob.patterns
