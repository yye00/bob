"""Readiness scoring facade for bob (feature c13e7eb9).
...
This module is the canonical entry point for:
  AC: 'File exists: src/bob/readiness_scoring.py'
  AC: 'Function defined: bob.readiness_scoring.derive_readiness_from_components'
  AC: 'Function defined: bob.readiness_scoring.seed_zero_readiness_features'
...
def derive_readiness_from_components(
    *,
    ...
    Satisfies AC: 'Function defined: bob.readiness_scoring.derive_readiness_from_components'.
...
def seed_zero_readiness_features(project_id: str) -> int:
    ...
    Satisfies AC: 'Function defined: bob.readiness_scoring.seed_zero_readiness_features'.
