...
Protocol enforced by this module:
  ...
  1. The 'researcher' role in src/bob/agents/roles.py has hide_intent=True.
  ...
  3. Output is written to .bob/features/<id>/research_notes.md.
...
def bf_2_research_documentarian_sub_agent_hide_ticket_pattern(
    *,
    ...
    protocol_steps = [
        ...
        "Researcher writes findings to .bob/features/<id>/research_notes.md.",
