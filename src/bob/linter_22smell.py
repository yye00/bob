...
Re-exports the complete public API from bob.linter_22_smells under the
canonical module name ``bob.linter_22smell`` (no trailing 's').

Severities: E (Error), W (Warning), I (Informational).
E-severity smells block ``bob plan --create``.
...
Public API::
    ...
    from bob.linter_22smell import detect_smells, SmellFinding, blocks_plan_create
