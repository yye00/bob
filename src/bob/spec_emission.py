...
Integration: validated specs feed directly into ``bob.critic`` (SpecCritic)
to gate codegen on spec quality.

Public API::

    from bob.spec_emission import emit_constrained_spec, validate_spec_against_schema
...
import bob.spec_critic  # noqa: F401 — integration: bob.critic
