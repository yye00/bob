...
```python
memory_add(
    content="For bob slope stability, chose Bishop grid-search over hybrid local-opt because F017 acceptance criterion requires FoS contour output. If F017 is ever relaxed, revisit — hybrid is ~3x faster for deep critical surfaces.",
    pool="lessons",
