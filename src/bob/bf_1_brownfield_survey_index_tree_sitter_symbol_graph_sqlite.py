...
Brownfield prerequisite: before bob can edit an existing repo it needs a
...
The heavy lifting is implemented in bob.brownfield.survey (build_survey /
    ...
    *,
    ...
    Args:
        ...
        db_path:    Explicit path for survey.db.  When omitted the survey
                    is written to <workspace>/.bob/survey.db.
    ...
    if resolved_db is None:
        resolved_db = root / ".bob" / "survey.db"
