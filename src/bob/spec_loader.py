"""bob.spec_loader — Integration-target reachability check at spec-load time.
...
from bob.spec_quality_score import compute_composite_quality_score, ScoreResult  # noqa: F401 — integration: bob.spec_quality_score

import bob.spawn  # noqa: F401 — integration: bob.spawn
import bob.meta_agent_selector  # noqa: F401 — integration: bob.meta_agent_selector
import bob.environment_preflight  # noqa: F401 — integration: bob.environment_preflight
import bob.environment_capability  # noqa: F401 — integration: bob.environment_capability
import bob.self_discover_selector  # noqa: F401 — integration: bob.self_discover_selector
import bob.schema_constraint  # noqa: F401 — integration: bob.schema_constraint
import bob.research_strategies  # noqa: F401 — integration: bob.research_strategies
import bob.spec_findings_writer  # noqa: F401 — integration: bob.spec_findings_writer
import bob.verifier_extension_validator  # noqa: F401 — integration: bob.verifier_extension_validator
from bob.spec_quality import ensure_boundary_and_error_coverage  # noqa: F401 — integration: bob.spec_loader (b6c53aa9)
