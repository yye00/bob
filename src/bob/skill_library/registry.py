...
_LIBRARY_DIR_ENV = "BOB_SKILL_LIBRARY_DIR"
...
def add_skill(
    ...
    from bob.skill_library.embeddings import embed_texts  # noqa: PLC0415
...
def search_skills(
    ...
    from bob.skill_library.embeddings import (  # noqa: PLC0415
