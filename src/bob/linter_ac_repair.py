"""AC repair with semantic-equivalence verification, integrated with bob.linter.
...
Public API::
    ...
    from bob.linter_ac_repair import semantic_equivalence_check, auto_repair_ac
...
Integration with bob.linter::
    ...
    from bob.linter_ac_repair import auto_repair_ac
