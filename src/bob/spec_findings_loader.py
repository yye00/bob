...
from bob.spec_findings_writer import load_with_corruption_recovery
...
def load_with_corruption_handling(path: Path | str) -> dict[str, Any]:
    ...
    file is quarantined to <path>.corrupt.<unix_ts> and {} is returned so bob
