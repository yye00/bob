...
given a :class:`~bob.spec_quality.contract_grammar.ContractSpec`, it produces
...
generate_icontract_decorators = emit_icontract_decorators

codegen_icontract_decorators = emit_icontract_decorators

codegen_icontract_decorator = emit_icontract_decorators
