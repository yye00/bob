"""Permanent forward-carry allowlist for the spec_quality_gate.
...
F-R7-481 slopsquatting local-module exclusion) whose ACs are intentionally
terse and score in the 0.6-0.75 range.

A prior generation blocked feature 0ab56ae2 (F-R7-478-equivalent) at
score=0.6375 despite being a MUST-CARRY-FORWARD feature per user directive.
This module exposes the two AC-required entry-points:
...
Usage::
    ...
    from bob.spec_quality_gate_allowlist import bypass_quality_gate

    if bypass_quality_gate(feature):
