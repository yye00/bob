...
Public API for `bob bundle --run-id <id>`.

This module re-exports the core bundle functionality from bob.bundle and
...
from bob.bundle import create_bundle, _get_env_lockfile, _get_telemetry_lines
...
def export_bundle(run_id: str, output_dir=None, run_jsonl_path=None):
    ...
    Thin wrapper around :func:`bob.bundle.create_bundle` so callers can
