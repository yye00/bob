"""bob.demoter_gates — Public gate API for prose-AC and integration-AC demotion.
...
from bob.demoter.structural_prefix_matcher import (
    is_structural_prefix_match,
    is_substring_marker_match,
)
from bob.demoter.prose_connector_registry import get_prose_connectors
