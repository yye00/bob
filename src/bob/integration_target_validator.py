"""bob.integration_target_validator — Integration-target reachability check at spec-load time.
...
from bob.spec_quality.integration_reachability import ReachabilityResult, check_spec  # integration: bob.spec_loader
