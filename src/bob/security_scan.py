...
from bob.security_checks import _read_first_party_packages, _run_slopsquatting, _pypi_package_exists
from bob.models import SecurityFinding
from bob.security_scan_slopsquatting import is_local_module as _is_local_module_impl
...
def is_local_module(import_name: str, workspace: Path) -> bool:
    ...
    """
    return _is_local_module_impl(import_name, workspace)
