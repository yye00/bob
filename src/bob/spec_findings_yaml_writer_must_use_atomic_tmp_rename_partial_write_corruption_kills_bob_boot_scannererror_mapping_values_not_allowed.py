...
Public API
----------
spec_findings_yaml_writer_must_use_atomic_tmp_rename_partial_write_corruption_kills_bob_boot_scannererror_mapping_values_not_allowed(data, path, quarantine_if_corrupt=False)
...
__all__ = [
    "spec_findings_yaml_writer_must_use_atomic_tmp_rename_partial_write_corruption_kills_bob_boot_scannererror_mapping_values_not_allowed",
    "atomic_write_yaml",
...
def spec_findings_yaml_writer_must_use_atomic_tmp_rename_partial_write_corruption_kills_bob_boot_scannererror_mapping_values_not_allowed(
