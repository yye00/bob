...
:mod:`bob.verifier.baseline_capture` and returns a plain dict result so
...
from bob.verifier.baseline_capture import collect_and_capture
...
def stable_baseline_gate_abort_verifier_if_collection_fails(
    ...
    *,
    ...
    Delegates to :func:`bob.verifier.baseline_capture.collect_and_capture`.
