...
Public API::
    ...
    from bob.uncertainty_clarifier import (
...
import bob.spec_loader as _spec_loader  # noqa: F401 — integration: bob.spec_loader
...
def detect_disagreement(
    ...
    *,
    ...
    bob.uncertainty_clarifier.detect_disagreement``.
...
def ask_clarification_batch(
    ...
    *,
    ...
    the provenance of the ambiguity.  In CI mode (or when ``BOB_CI_MODE``
    ...
    if ci_mode is None:
        ci_mode = bool(os.environ.get("BOB_CI_MODE", ""))
