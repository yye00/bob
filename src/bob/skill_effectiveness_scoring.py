"""Skill-effectiveness scoring for bob.
...
a YAML-based skills registry and surfaced via ``bob skill-report``.
...
def load_skill_activation_events(progress_path: Path) -> list[FeaturePairRecord]:
    ...
    Args:
        progress_path: Path to .bob/progress.jsonl.
...
def compute_skill_scores(
    *,
    ...
    Args:
        progress_file: Path to .bob/progress.jsonl.
        db_path: Path to bob.db.
