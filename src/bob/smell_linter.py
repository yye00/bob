...
CLI call to gate ``bob plan --create``.
...
Usage::
    ...
    from bob.smell_linter import lint_spec_for_smells
...
def lint_spec_for_smells(
    ...
    and returns a structured result dict suitable for gating ``bob plan --create``.
