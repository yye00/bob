...
Usage:
    python -m bob.a_b_comparison_cli --run-a <id> --run-b <id>
...
def compare_runs(
    ...
    Args:
        ...
        db_path: Path to the bob.db SQLite database.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Side-by-side A/B telemetry comparison for two bob runs."
    )
    ...
    parser.add_argument("--db", default=_DEFAULT_DB_PATH, metavar="PATH", help="Path to bob.db")
