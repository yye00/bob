"""Disk-state reconciler for Bob (feature a7d1be1c).
...
Integration: called from ``bob.orchestrator`` to promote features before
...
from bob.orchestrator.disk_reconciler import reconcile_from_disk as _reconcile_from_disk
