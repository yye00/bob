"""bob.spawn_retry — public entry point for transient-error spawn recovery.

Satisfies ACs:
  - File exists: src/bob/spawn_retry.py
  - Function defined: bob.spawn_retry.spawn_with_retry
  - Function defined: bob.spawn_retry.classify_exit
