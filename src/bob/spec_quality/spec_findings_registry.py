...
Public API::
    ...
    from bob.spec_quality.spec_findings_registry import record, detect_regression
...
def _load_yaml(p: Path) -> dict[str, Any]:
    ...
    with open(p, encoding="utf-8") as fh:
        try:
            ...
            from bob.spec_findings_writer import quarantine_corrupt_findings
...
def _save_yaml(data: dict[str, Any], p: Path) -> None:
    from bob.spec_findings_writer import write_atomic_yaml
