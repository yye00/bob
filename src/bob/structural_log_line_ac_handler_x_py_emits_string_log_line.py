...
Problem (bob v.20 r1, 2026-06-01)
------------------------------------
...
Fix (F-R7-590, bob version 20)
---------------------------------
``handle_structural_log_line`` in ``bob.enhanced_verification`` implements the
three-tier search:
...
the bob spec. The underlying logic lives in
``bob.enhanced_verification.handle_structural_log_line``.
"""
