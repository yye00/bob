...
``bob.orchestrator.regression_attribution.demote_with_evidence`` to enforce
...
def detect_regression(
    *,
    ...
    if affected_feature_id != causing_feature_id:
        from bob.orchestrator.regression_attribution import demote_with_evidence  # lazy to avoid circular import
