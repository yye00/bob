"""GPU/Triton kernel synthesis module for bob (feature 6cc31a74).
...
# bob.triton_kernel_synthesis → bob.implementers.__init__
# → bob.orchestrator.plan_gate → bob.orchestrator.__init__
# → bob.triton_kernel_synthesis (partially initialised → ImportError).
...
def verify_numerical_correctness(
    ...
    *,
    ...
    :class:`~bob.implementers.triton_kernel.NumericalGateError` when
