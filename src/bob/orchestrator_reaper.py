...
bob.orchestrator.run_loop._final_exit_sweep which performs the full two-step
...
looks recoverable. See bob.orchestrator.stale_bytecode_guard.check_stale_bytecode.
"""
...
def _get_check_stale_bytecode():
    from bob.orchestrator.stale_bytecode_guard import check_stale_bytecode  # noqa: PLC0415
...
def finalize_orphans_on_exit(project_id: str) -> None:
    ...
    Invokes the final exit sweep from bob.orchestrator.run_loop which:
    ...
    """
    from bob.orchestrator.run_loop import _final_exit_sweep  # noqa: PLC0415
...
def check_stale_bytecode_before_reap(
    ...
    Wrapper around bob.orchestrator.stale_bytecode_guard.check_stale_bytecode
