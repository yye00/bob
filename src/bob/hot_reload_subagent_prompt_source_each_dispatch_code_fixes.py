...
OLD prompt for 4+ hours — the patch only takes effect on the next bob version
...
:func:`bob.orchestrator.prompt_source_reloader.maybe_reload_all`, which stats
