...
- File exists: src/bob/infra_error_classifier.py
- Function defined: bob.infra_error_classifier.classify_exit
- Function defined: bob.infra_error_classifier.spawn_with_retry
...
bob.orchestrator.spawn_retry and provides bob.infra_error_classifier as the
