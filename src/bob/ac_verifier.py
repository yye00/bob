"""bob.ac_verifier — AC artifact-existence verifier (F-R7-7422b3bb).
...
def handle_shell_script_integration(
    ...
    ``Function defined: bob.ac_verifier.handle_shell_script_integration``.
...
def verify_artifact_exists(
    ...
    """Alias for verify_artifact_existence — satisfies AC 'Function defined: bob.ac_verifier.verify_artifact_exists'."""
