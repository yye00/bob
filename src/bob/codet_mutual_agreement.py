...
def spawn_candidate_impls(
    ...
    AC alias: bob.codet_mutual_agreement.spawn_candidate_impls.
...
def spawn_candidate_tests(
    ...
    AC alias: bob.codet_mutual_agreement.spawn_candidate_tests.
...
def build_kxk_matrix(
    ...
    bob.codet_mutual_agreement.build_kxk_matrix.
...
def score_mutual_agreement(
    ...
    Satisfies AC: Function defined: bob.codet_mutual_agreement.score_mutual_agreement.
    Delegates to bob.codet_triangulation.score_mutual_agreement.
    ...
    """
    from bob.codet_triangulation import score_mutual_agreement as _score  # noqa: PLC0415
