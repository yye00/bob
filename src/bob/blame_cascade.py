...
Integration
-----------
``bob.orchestrator`` re-exports ``charge_failing_features`` as its
integration AC.  To avoid a circular import (bob.blame_cascade →
bob.orchestrator.blame_cascade → bob.orchestrator.__init__ →
bob.blame_cascade), this module implements the logic directly rather than
...
def charge_breaking_features(
    *,
    ...
    Feature 82c7f621-0858-41a2-a6c0-19b6d31303ad
