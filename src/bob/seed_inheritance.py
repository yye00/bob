"""Seed-time parent-generation DB inheritance for bob (F-R7-400).
...
Delegates to :mod:`bob.parent_gen_db_inheritance` for the low-level read/stamp
...
from bob.parent_gen_db_inheritance import read_parent_features, stamp_child_row
...
def stamp_parent_generation(
    *,
    ...
    completed/needs_human/regression feature row from bob_N's bob.db, match by
    ...
    Args:
        ...
        child_db_path:  Path to bob_(N+1)'s ``bob.db``. Defaults to
