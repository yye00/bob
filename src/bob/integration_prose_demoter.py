"""bob.integration_prose_demoter — Integration-AC prose demoter (F-R7-577 / 1a58a41c).
...
Design
------
The prose connector registry (bob.prose_connector_registry.get_connectors) is
...
is_executable_or_structural_criterion(criterion) -> bool
    ...
    Delegates to bob.verification.structural_prefix_match for prefix matching.

is_integration_prose_body(body) -> bool
    True iff the body after 'integration:' looks like human-written prose.
    Exposes the internal heuristic from bob.verification.integration_ac_resolver.
"""
...
from bob.verification.integration_ac_resolver import _is_prose_body
...
def is_integration_prose_body(body: str) -> bool:
    ...
    Delegates to bob.verification.integration_ac_resolver._is_prose_body,
