...
def compute_readiness_from_components(
    *,
    ...
    Satisfies AC: 'Function defined: bob.readiness_score.compute_readiness_from_components'.
...
def seed_zero_readiness_features(project_id: str) -> int:
    ...
    Satisfies AC: 'Function defined: bob.readiness_score.seed_zero_readiness_features'.
    ...
    """
    from bob.readiness_derivation import seed_zero_readiness_features as _seed
...
def derive_readiness_from_confidence(
    *,
    ...
    Satisfies AC: 'Function defined: bob.readiness_score.derive_readiness_from_confidence'.
