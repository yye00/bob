...
the AC verifier can find it at:
    ...
    bob.peas_pipeline_bob_extract_peas_prose_only_spec_features
...
from bob.extract_from_peas import run_pipeline


def peas_pipeline_bob_extract_peas_prose_only_spec_features(
    peas_path: Path,
    *,
