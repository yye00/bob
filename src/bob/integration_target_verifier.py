"""bob.integration_target_verifier — Integration-target reachability check at spec-load time.
...
verify_reachable_targets = verify_integration_targets
...
def is_target_reachable(
    ...
    ----------
    module:
        Dotted Python module path to check (e.g. ``"bob.spec_loader"``).
