...
per-feature spec_quality_score in [0, 1]. Features with score < 0.85 stay
pending with a structured remediation report.
"""
...
def spec_quality_score_gate_features_below_threshold_cannot(
    name: str,
