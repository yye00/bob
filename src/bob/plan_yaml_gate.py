"""bob.plan_yaml_gate — public facade for plan.yaml loading and approval checks.
...
(F-259ea328).  The heavy lifting lives in bob.orchestrator.plan_gate; this
module re-exports the right primitives under clean names so callers do not
need to know the internal package layout.

Usage::

    from bob.plan_yaml_gate import load_plan_yaml, validate_plan_approved
