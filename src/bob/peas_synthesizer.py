...
``extract_from_peas`` as the AC-required functions at:
  bob.peas_synthesizer.parse_peas_markdown
  bob.peas_synthesizer.synthesize_features
  bob.peas_synthesizer.extract_from_peas

Delegates to the full implementation in ``bob.extract_from_peas``.
"""
