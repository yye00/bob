...
from bob.dispatch import generate_worker_settings as _generate_worker_settings
...
def generate_worker_settings(
    ...
    *,
    ...
    """
    return _generate_worker_settings(feature, bob_dir=bob_dir, extra_allow=extra_allow)
