...
``bob init``, causing the cross-generation diff to always be 100%.
...
Integration: bob.weekend_watchdog re-exports check_convergence from here.
"""
...
from bob.convergence import check_convergence  # noqa: F401 — primary export
from bob.convergence import check_convergence_by_spec_slot  # noqa: F401
