...
around `bob.orchestrator.periodic_resume_scan.periodic_resume_scan` and exists at
`bob.resume_scanner` so that the ACs "File exists: src/bob/resume_scanner.py" and
"Function defined: bob.resume_scanner.scan_interrupted_rows" are satisfied.
