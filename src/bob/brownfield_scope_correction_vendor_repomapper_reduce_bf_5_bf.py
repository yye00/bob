...
Post-research scope reductions for BF-1, BF-5, and BF-6:
  ...
  (D) src/bob/CLAUDE.md contains only meta-loop guidance; operator memory
...
def brownfield_scope_correction_vendor_repomapper_reduce_bf_5_bf() -> dict[str, Any]:
    ...
    scope_reductions: list[dict[str, Any]] = [
        {
            ...
            "original": (
                ...
                "in src/bob/brownfield/survey.py"
            ),
            "reduction": (
            ...
            "rationale": (
                ...
                "Bob is a thin MCP client; no need to reimplement the computation."
            ),
            "enforcement_file": "src/bob/brownfield/survey.py",
        ...
        },
        {
            ...
            "rationale": (
                ...
                "Only the GitHub-graveyard signal is unique to bob."
            ),
            "enforcement_file": "src/bob/brownfield/resurrection.py",
        ...
        },
        {
            ...
            "reduction": (
                ...
                "this is the only bob-specific logic."
            ),
            "rationale": (
                "Claude Code's AskUserQuestion + Plan Mode already covers interactive elicitation. "
                "Only the headless path (claude -p, no human) needs bob-specific branching."
            ),
            "enforcement_file": "src/bob/brownfield/elicit.py",
    ...
    return {
        ...
        "claude_md_status": (
            "src/bob/CLAUDE.md contains meta-loop guidance only; "
