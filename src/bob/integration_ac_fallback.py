...
Root cause addressed (bob v.17 r1 ~09:43Z): feature 85790dc6 (orphan-subagent
reaper) NH'd with AC:
...
def _integration_wired(workspace: pathlib.Path, dotted: str) -> bool:
    ...
    Delegates to bob.enhanced_verification._integration_wired when available,
    otherwise implements equivalent logic directly.
    """
    try:
        from bob.enhanced_verification import _integration_wired as _ev_wired
