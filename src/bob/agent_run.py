"""bob.agent_run — thin facade for creating agent run records.
...
resolves to a different file (stale repo-root bob.db or different cwd).
"""
...
from bob.db import create_agent_run as _create_agent_run
