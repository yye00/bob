...
Public API::
    ...
    from bob.spec_findings_registry import write_findings, detect_regression
...
def write_spec_findings(
    ...
    *,
    ...
    (bob.spec_findings_registry.write_spec_findings).
...
def record_findings(
    ...
    *,
    ...
    (``bob.spec_findings_registry.record_findings``). Delegates to
