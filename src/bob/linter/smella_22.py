"""22-smell linter for bob.linter (F-R7-410 full extension).
...
Public API::
    ...
    from bob.linter.smella_22 import detect_all_smells, filter_by_severity
...
def detect_all_smells(
    ...
    Examples
    --------
    >>> from bob.linter.smella_22 import detect_all_smells
    >>> findings = detect_all_smells("The system shall be fast and simple.")
