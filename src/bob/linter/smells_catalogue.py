"""22-smell catalogue module for bob.linter (F-R7-410 full extension).
...
Public API::
    ...
    from bob.linter.smells_catalogue import detect_all_smells, filter_by_severity
...
def detect_all_smells(
    ...
    Examples
    --------
    >>> from bob.linter.smells_catalogue import detect_all_smells
    >>> findings = detect_all_smells("The system shall be fast and simple.")
