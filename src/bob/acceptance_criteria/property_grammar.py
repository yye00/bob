...
The parsed :class:`~bob.spec_quality.example_grammar.PropertyAC` is used by:
...
def parse_property_ac(ac: str | None) -> PropertyAC | None:
    ...
    Delegates to :func:`bob.spec_quality.example_grammar.parse_property_ac`.
    ...
    - Raises :class:`~bob.spec_quality.example_grammar.PropertyParseError`
