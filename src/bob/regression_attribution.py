"""Top-level regression attribution facade for bob.
...
via ``bob.verification.regression_attribution.filter_attributable_failures``.
...
from bob.test_ownership_map import load_test_ownership_map
from bob.test_ownership_map import get_test_owners
from bob.test_ownership_map import validate_test_ownership
...
def build_test_ownership_map(features: list[Any]) -> dict[str, str]:
    ...
    required by the feature AC: ``bob.regression_attribution.build_test_ownership_map``.
