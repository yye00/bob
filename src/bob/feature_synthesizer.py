"""bob.feature_synthesizer — public AC synthesis helpers for feature specs.
...
Public API::
    ...
    from bob.feature_synthesizer import ensure_boundary_and_error_coverage
"""
...
def ensure_boundary_and_error_coverage(
    ...
    Delegates to :func:`bob.spec_synthesizer._ensure_boundary_and_error_coverage`
