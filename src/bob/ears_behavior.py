...
from bob.ears_criteria import BehaviorCriterion, parse_behavior_criterion as _parse_behavior_criterion

#: Public name for the parsed behavior criterion tuple (lowercase 's' in Ears).
EarsBehaviorCriterion = BehaviorCriterion

#: Alias matching the AC requirement: bob.ears_behavior.EARSBehavior
...
__all__ = ["EARSBehavior", "EarsBehaviorCriterion", "parse_behavior_criterion"]
