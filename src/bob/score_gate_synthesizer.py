...
``bob.spec_synthesizer``.  This module is the stable import point referenced
by the AC: "File exists: src/bob/score_gate_synthesizer.py".
...
__all__ = [
    ...
    "re_synthesize_gate_blocked_feature",
]
...
def re_synthesize_blocked_feature(
    ...
    Delegates to ``bob.gate_synthesizer.re_synthesize_gate_blocked_feature``
    ...
    """
    from bob.gate_synthesizer import re_synthesize_gate_blocked_feature  # noqa: PLC0415
...
# Alias for AC: "Function defined: bob.score_gate_synthesizer.re_synthesize_gate_blocked_feature"
re_synthesize_gate_blocked_feature = re_synthesize_blocked_feature
