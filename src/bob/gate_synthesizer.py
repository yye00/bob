...
from bob.feature_synthesizer import ensure_boundary_and_error_coverage  # noqa: F401 — integration: bob.gate_synthesizer (bfa7789d)
from bob.research_strategies import validate_against_spec_quality_gate
