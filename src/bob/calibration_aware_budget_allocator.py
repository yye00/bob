"""Calibration-aware budget allocator for Bob.
...
ECE source: compute_ece_by_bucket() from bob.calibration, fed by the
...
def allocate_budget_from_db(
    ...
    :func:`~bob.calibration.compute_ece_by_bucket`, and returns the
    ...
    Returns:
        Dict mapping each of :data:`~bob.calibration.TASK_CLASSES` to an
        attempt count.
    """
