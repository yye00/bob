...
This module satisfies AC: ``Function defined: bob.orchestrator.exponential_backoff``.

Provides the dispatch-loop facing entry point for the reaper-backoff system.
Delegates computation to bob.orchestrator.reap_backoff (the canonical
implementation) and bob.reaper (the top-level API).
...
def exponential_backoff(
    ...
    This is the canonical entry point satisfying:
      AC: ``Function defined: bob.orchestrator.exponential_backoff``
    ...
    """
    from bob.reaper import BackoffDecision, handle_exponential_backoff  # noqa: PLC0415
