...
_ENV_VAR: str = "BOB_PER_FEATURE_COST_CEILING"
...
def compute_per_feature_ceiling() -> float:
    ...
    ``BOB_PER_FEATURE_COST_CEILING``.  If the variable is unset or
    ...
    float
        ...
        :func:`bob.orchestrator.cost_telemetry_guard.apply_pessimistic_cost`
