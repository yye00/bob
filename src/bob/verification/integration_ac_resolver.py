"""bob.verification.integration_ac_resolver — Pattern 8 integration AC resolver.
...
from bob.verification.policy_verb_registry import (
...
logger = logging.getLogger("bob.verification.integration_demotion")
...
def resolve_integration_ac(
    ...
    """
    from bob.enhanced_verification import _integration_wired  # avoid circular at module level
...
def log_integration_ac_prose_demoted(
    ...
    Logger name: 'bob.verification.integration_demotion'.
    """
    record = {
