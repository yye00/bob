"""bob.verification.verifier — integration shim exposing ac_artifact_check and
mutation_gate APIs.

This module makes verify_ac_artifacts and related symbols available under the
bob.verification.verifier namespace so the orchestrator can import from a
...
from bob.verification.ac_artifact_check import (  # noqa: F401
    ArtifactMiss,
...
from bob.verification.per_feature_test_scope import (  # noqa: F401
...
from bob.verification.mutation_gate import (  # noqa: F401
    MutationReport,
    MutmutMissingError,
    default_threshold,
    enforce_time_limit,
...
def _import_charge_feature_from_test():  # noqa: F401 — lazy to break circular import
    from bob.verification.blame_feature_charger import charge_feature_from_test
