"""Reproducibility bundle exporter for Bob.
...
from bob.db import get_connection, get_database_path
...
def create_bundle(
    ...
    Args:
        ...
        run_jsonl_path: Path to run.jsonl for telemetry extraction.
            Defaults to .bob/run.jsonl in the current working directory.
    ...
    if run_jsonl_path is None:
        run_jsonl_path = pathlib.Path(".bob") / "run.jsonl"
