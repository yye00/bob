"""Gate-blocked feature re-synthesis (feature 12697e5d).
...
depends on the ACCEPTANCE CRITERIA, not the code — rebuilding code can never raise
the score. This module provides the correct recovery: attempt one AC re-synthesis
via score_gate_loop + synthesize_for_feature, then re-score.
