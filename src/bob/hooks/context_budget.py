...
importable as bob.hooks.context_budget.

Satisfies ACs:
  - File exists: src/bob/hooks/context_budget.py
  - Function defined: bob.hooks.context_budget.enforce_context_budget
"""
...
# AC alias: "Function defined: bob.hooks.context_budget.check_context_budget"
check_context_budget = _hook.check_context_usage
...
def enforce_context_budget(
    ...
    Args:
        ...
        feature_id:      Feature UUID for telemetry; defaults to BOB_FEATURE_ID env var.
    ...
    """
    fid = feature_id or os.environ.get("BOB_FEATURE_ID", "unknown")
