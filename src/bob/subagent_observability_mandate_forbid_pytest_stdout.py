...
Root cause (bob v.13 r10): subagent d8483d98 (PID 2135582) invoked
...
This module is the canonical entry point that locks this rule into the bob v.17
spec so future bootstraps re-apply it. The underlying validation logic lives in
``bob.subagent_observability.validate_pytest_command``.
"""
