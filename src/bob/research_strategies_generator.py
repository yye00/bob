"""bob.research_strategies_generator — canonical AC emitter for the spec_quality gate.
...
This module exposes the canonical public API referenced in bob.orchestrator:

    from bob.research_strategies_generator import (
        emit_canonical_acs,
...
# Delegate to the canonical implementation in bob.research_strategies so that
...
def validate_ac_against_gate(ac: Any) -> dict[str, Any]:
    ...
    Thin wrapper over :func:`bob.research_strategies.validate_ac_against_spec_quality_gate`
