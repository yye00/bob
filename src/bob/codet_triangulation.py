...
def score_kxk_matrix(
    ...
    bob.codet_triangulation.score_kxk_matrix.
...
def spawn_candidate_tests(
    ...
    bob.codet_triangulation.spawn_candidate_tests.
...
def spawn_candidate_impls(
    ...
    bob.codet_triangulation.spawn_candidate_impls.
...
def spawn_candidate_implementations(
    ...
    bob.codet_triangulation.spawn_candidate_implementations.
...
def score_mutual_agreement(
    ...
    defined: bob.codet_triangulation.score_mutual_agreement.
...
def score_agreement_matrix(
    ...
    AC-required alias for generate_kxk_matrix — satisfies AC: Function defined:
    bob.codet_triangulation.score_agreement_matrix.
