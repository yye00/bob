"""bob.create_agent_run — canonical entry point for creating agent run records.

This module satisfies the AC: "File exists: src/bob/create_agent_run.py" and
"Function defined: bob.create_agent_run.create_agent_run".
...
explicit db_path the function falls back to BOB_DATABASE_PATH (or cwd/bob.db),
...
from bob.db import create_agent_run as _db_create_agent_run
    ...
    *,
    ...
    Args:
        ...
        db_path: Absolute path to the project's SQLite database. When supplied,
            the INSERT targets this file regardless of cwd or BOB_DATABASE_PATH.
