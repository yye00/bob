"""bob.prose_connector_registry — Public registry of prose-connector tokens.
...
implementation lives in bob.verification.policy_verb_registry and is re-exported
...
def prose_connector_registry() -> frozenset[str]:
    ...
    Delegates to bob.verification.structural_prefix_match.prose_connector_registry
...
def get_policy_verb_connectors() -> frozenset[str]:
    ...
    bob.verification.structural_prefix_match.prose_connector_registry().
...
def is_feature_hash_reference(token: str) -> bool:
    ...
    Examples:
      ...
      is_feature_hash_reference('bob.module.func')   -> False
