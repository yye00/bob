"""bob.dispatcher — dispatch-layer integration for exponential backoff after reaper-reset.

Satisfies AC: Function defined: bob.dispatcher.check_reap_backoff
Satisfies AC: Function defined: subagent_dispatch.apply_thinking_config
Satisfies AC: integration: bob.dispatcher

This module is the canonical integration point between the bob dispatch loop
and the exponential backoff enforcement logic in bob.reaper.  Before
...
from bob.pending_successor_verifier import (  # noqa: F401 — integration AC (F-R7-596)
    detect_pending_successor_verify,
    mark_pending_successor_verify,
)
from bob.reaper import should_refuse_redispatch, update_reap_tracking
