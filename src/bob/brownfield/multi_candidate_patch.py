...
Implements the Anthropic high-compute pattern:
  ...
  6. Commit the winner; archive losers to .bob/features/<id>/losers/.
...
def _create_worktree(workspace: Path, branch_name: str) -> Path:
    ...
    """
    worktree_path = workspace / ".bob" / "worktrees" / branch_name
...
def _archive_losers(
    ...
    *,
    ...
    """Archive losing patches to .bob/features/<id>/losers/.
    ...
    """
    losers_dir = workspace / ".bob" / "features" / feature_id / "losers"
...
def spawn_worker_candidates(
    ...
    *,
    ...
    bob.brownfield.multi_candidate_patch.spawn_worker_candidates'.
...
class LLMJudge:
    ...
    bob.brownfield.multi_candidate_patch.LLMJudge'.
...
def judge_patch_quality(
    ...
    *,
    ...
    Exposed per the AC: 'Function defined:
    bob.brownfield.multi_candidate_patch.judge_patch_quality'.
...
def rank_candidates_with_judge(
    ...
    *,
    ...
    bob.brownfield.multi_candidate_patch.rank_candidates_with_judge'.
...
def llm_judge_rank(
    ...
    *,
    ...
    This is the AC-required entry point: 'Function defined:
    bob.brownfield.multi_candidate_patch.llm_judge_rank'.
...
def spawn_patch_candidates(
    ...
    *,
    ...
    bob.brownfield.multi_candidate_patch.spawn_patch_candidates'.
...
def llm_judge_patches(
    ...
    *,
    ...
    AC-required entry point: 'Function defined:
    bob.brownfield.multi_candidate_patch.llm_judge_patches'.
