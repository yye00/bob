"""bob.mutation_gate — high-level mutation testing quality gate for the verifier stage.
...
def run_mutation_tests(
    ...
    *,
    ...
    """Alias for run_mutation_testing — AC: Function defined: bob.mutation_gate.run_mutation_tests."""
...
def compute_mutation_score(killed: int, total: int) -> float:
    ...
    AC: Function defined: bob.mutation_gate.compute_mutation_score.
