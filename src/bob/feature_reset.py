...
from bob.brownfield.elicit import clarification_gate  # noqa: F401 — integration 4b0b1a60
from bob.carry_forward_auditor import audit_carry_forward_by_canonical_id  # noqa: F401 — integration aa0f532b
from bob.pending_successor_verifier import detect_pending_successor_verify  # noqa: F401 — integration 229e5f52
from bob.spec_quality_gate import should_bypass_quality_threshold  # noqa: F401 — integration e8fb54fe
