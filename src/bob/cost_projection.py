"""Top-level re-export shim for bob.orchestrator.cost_projection.

Exposes the cost-projection gate functions at the shorter ``bob.cost_projection``
...
from bob.orchestrator.cost_projection import (  # noqa: F401
    allow_spawn,
