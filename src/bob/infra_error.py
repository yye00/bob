"""bob.infra_error — canonical entry point for infra-error classification.
...
AC requirements satisfied:
  - Function defined: bob.infra_error.classify_exit
  - Function defined: bob.infra_error.spawn_with_retry
  - File exists: src/bob/infra_error.py
"""
