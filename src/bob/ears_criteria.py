"""EARS-style behavior acceptance criteria for bob.
...
#: Alias for :class:`BehaviorCriterion` — exposed under the EARS-centric name
#: required by AC "Function defined: bob.ears_criteria.EARSBehaviorCriterion".
EARSBehaviorCriterion = BehaviorCriterion

__all__ = ["BehaviorCriterion", "EARSBehaviorCriterion", "parse_behavior_criterion"]
