"""Feature 4338fc09: orchestrator-liveness probe MUST match bob[0-9]+ regex AND honor .bob.lock holder PID.

Operational defect fix: pgrep bob run missed gen-N binary aliases (e.g. bob14).
Three-signal gate — ALL signals must agree no orchestrator is alive before the
.bob.lock file may be safely removed:
...
from bob.orchestrator.liveness_probe import safe_to_remove_lock
