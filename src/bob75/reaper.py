...
The heavy logic lives in bob3.reaper and bob3.orchestrator.reap_backoff;
...
from bob3.reaper import (  # noqa: F401 — re-exported
    BackoffDecision,
...
def calculate_backoff_delay(reap_count: int) -> int:
    ...
    Delegates to bob3.orchestrator.reap_backoff.compute_backoff_seconds.
