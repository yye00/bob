...
Wraps the canonical bob3.orchestrator.plan_gate to provide a bob75-scoped
...
from bob3.orchestrator.plan_gate import emit_plan_ready_event, write_plan_artifact
