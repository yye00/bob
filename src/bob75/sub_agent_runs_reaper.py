...
Satisfies ACs:
  ...
  - integration: bob3.sub_agent_runs_reaper

The heavy logic lives in bob3.orchestrator.zombie_run_reaper and
bob3.sub_agent_runs_reaper; this module exposes the canonical
...
from bob3.sub_agent_runs_reaper import reap_zombie_runs  # noqa: F401 — re-exported
...
def close_zombie_runs(project_id: str) -> list[str]:
    ...
    bob3.sub_agent_runs_reaper.reap_zombie_runs for the actual work.
