"""Sticky-completed gate for dark_factory — re-evaluation cannot un-complete persisted work.
...
Public API:
    :func:`evaluate_completion_status` — gate check integrating with dark_factory.evaluator
"""
...
def evaluate_completion_status(
    ...
    Integrates with dark_factory.evaluator to prevent evaluator FAIL or
