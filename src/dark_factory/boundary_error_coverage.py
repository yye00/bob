...
def ensure_boundary_and_error_coverage(
    ...
    This is the public API that corresponds to bob3.coverage_detector's
    detect_boundary_error_coverage, but lives in dark_factory for use by
    modules outside the bob3 package (including bob3.reward_hacking_detector).
