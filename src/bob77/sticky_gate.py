...
Public API:
    :func:`evaluate_with_sticky_completion` — gate check (returns True to block demotion)
"""
...
def evaluate_with_sticky_completion(
...
__all__ = ["evaluate_with_sticky_completion"]
