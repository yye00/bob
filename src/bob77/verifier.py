...
Re-exports the verifier-facing API from ``bob3.spec_quality.example_grammar``:
...
from bob3.verifier.shell_script_ac import handle_shell_script_ac as _handle_shell_script_ac
