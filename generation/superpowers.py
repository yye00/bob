"""Generation-level superpowers — re-exports bob.superpowers for generation scripts.

This module exists so that bootstrap and generation-level scripts can import
superpowers utilities without resolving the full ``src/bob/`` package path.
All functionality is delegated to ``bob.superpowers``.
...
# Re-export the full public surface of bob.superpowers so generation scripts
