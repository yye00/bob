...
``bob3.orchestrator.liveness_probe``.  The ``generation/src`` tree is the
authoritative spec-over-code source; this file satisfies the AC
"File exists: generation/src/bob3/orchestrator/liveness_probe.py" and ensures
...
``bob3.orchestrator.probe_ancestry`` (is_self_or_ancestor, is_shell_wrapper),
